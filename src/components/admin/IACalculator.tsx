      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="space-y-2">
            <Label
              htmlFor="users"
              className="text-[10px] uppercase tracking-wider text-muted-foreground flex items-center gap-1"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-amber-500/10">
          ...
          <div>
            ...
            <p className="font-mono text-lg font-bold">
              {(result.monthlyTokens / 1_000_000).toFixed(2)}M
            </p>
          </div>
          <div className="bg-amber-500/10 p-2 rounded border border-amber-500/20">
            <p className="text-[10px] uppercase tracking-wider text-amber-800 font-bold">
              Custo Estimado / Mês
            </p>
            <p className="font-serif text-2xl font-bold text-amber-900">
              $
              {result.monthlyCost.toLocaleString("en-US", {
