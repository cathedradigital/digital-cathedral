...
const moduleCosts = [
  { name: "Leitor V2", desktop: 12.5, mobile: 18.2, total: 30.7 },
  { name: "Logos IA", desktop: 45.3, mobile: 32.1, total: 77.4 },
  { name: "Busca Nexus", desktop: 8.4, mobile: 12.6, total: 21.0 },
  { name: "Certificação", desktop: 15.0, mobile: 5.0, total: 20.0 },
];
...
const dailyUsage = [
  ...
  { day: "04/08", tokens: 200000, cost: 0.1 },
      ...
      <Card className="border-l-4 border-l-primary">
        ...
        <CardContent>
          ...
          <Progress
            ...
            className={`h-2 ${budgetProgress > 90 ? "bg-red-100" : ""}`}
          />
          ...
          <CardContent>
            ...
            <div className="mt-4 flex justify-center gap-4 text-[10px] uppercase tracking-wider">
              <div className="flex items-center gap-1">
                <Monitor className="h-3 w-3 text-primary" /> Desktop
              </div>
              <div className="flex items-center gap-1">
                <Smartphone className="h-3 w-3 text-secondary" /> Mobile
              </div>
            </div>
          </CardContent>
        </Card>
