  ...
  const capture = useCallback(async () => {
    ...
    try {
      const { error } = await supabase.rpc(
        "admin_capture_pg_stat_snapshot" as never,
        {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 items-end">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="baseline antes do batching"
              />
            </div>
                    ...
                    <TableBody>
                      {diff.map((d, i) => (
                        <TableRow key={i}>
                          ...
                          <TableCell
                            className={`text-right font-medium ${d.delta > 0 ? "text-destructive" : "text-primary"}`}
                          >
                            {d.delta > 0 ? "+" : ""}
                            {fmtMs(d.delta)}
                          </TableCell>
