...
const SEOHead = ({
  ...
  const displayDescription =
    ...
    "Aprofunde sua fé católica com Bíblia Sagrada, Catecismo da Igreja, vidas dos santos, liturgia diária e IA teológica.";
  ...
  const organizationSchema = {
    ...
    sameAs: [SEO_CONFIG.ORGANIZATION.instagram, SEO_CONFIG.ORGANIZATION.twitter],
  };
  ...
  const localBusinessLD = seoSettings?.business_name
    ? {
        ...
        geo:
          seoSettings.latitude && seoSettings.longitude
            ? {
                "@type": "GeoCoordinates",
