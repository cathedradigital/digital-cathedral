...
const PAGE_COMMANDS: CommandItem[] = [
  {
    label: "Hoje",
    description: "Liturgia e jornada diária",
    path: AppRoute.HOJE,
    icon: <Icons.Home className="w-spacing-md h-spacing-md" />,
    keywords: ["início", "home", "painel", "hoje"],
    type: "page",
  },
  {
    ...
    keywords: ["biblia", "escritura", "evangelho", "genesis", "salmos"],
    type: "page",
  },
  {
    label: "Catecismo (CIC)",
    description: "Catecismo da Igreja Católica",
    path: AppRoute.CATECHISM,
    icon: <Icons.Cross className="w-spacing-md h-spacing-md" />,
    keywords: ["catecismo", "cic", "doutrina", "fé"],
    type: "page",
  },
  {
    label: "Explorar Catecismo",
    description: "Busca e temas do Catecismo",
    path: AppRoute.CATECHISM_EXPLORER,
    icon: <Icons.Search className="w-spacing-md h-spacing-md" />,
    keywords: ["catecismo", "explorar", "tags", "temas"],
    type: "page",
  },
  {
    label: "Santos",
    description: "Hagiografia",
    path: AppRoute.SAINTS,
    icon: <Icons.SaintHalo className="w-spacing-md h-spacing-md" />,
    keywords: ["santos", "santo", "santa", "hagiografia", "mártir"],
    type: "page",
  },
  {
    label: "Magistério",
    description: "Encíclicas e documentos",
    path: AppRoute.MAGISTERIUM,
    icon: <Icons.ScrollText className="w-spacing-md h-spacing-md" />,
    keywords: ["magistério", "encíclica", "concílio", "papa", "vaticano"],
    type: "page",
  },
  {
    label: "Dogmas",
    description: "Dogmas da fé católica",
    path: AppRoute.DOGMAS,
    icon: <Icons.Star className="w-spacing-md h-spacing-md" />,
    keywords: ["dogma", "doutrina", "verdade", "fé"],
    type: "page",
  },
  {
    label: "Enciclopédia",
    description: "Glossário completo da fé",
    path: AppRoute.ENCYCLOPEDIA,
    icon: <Icons.Library className="w-spacing-md h-spacing-md" />,
    keywords: ["enciclopédia", "glossário", "termos", "fé"],
    type: "page",
  },
  {
    label: "Aparições",
    description: "Manifestações de Nossa Senhora",
    path: AppRoute.APARICOES,
    icon: <Icons.Heart className="w-spacing-md h-spacing-md" />,
    keywords: ["aparição", "nossa senhora", "maria", "milagre"],
    type: "page",
  },
  {
    label: "Liturgia Diária",
    description: "Leituras do dia",
    path: `${AppRoute.LITURGIA}?tab=liturgia`,
    icon: <Icons.Star className="w-spacing-md h-spacing-md" />,
    keywords: ["liturgia", "leitura", "missa", "evangelho do dia"],
    type: "page",
  },
  {
    label: "Santo Rosário",
    description: "Oração do terço",
    path: AppRoute.ROSARY,
    icon: <Icons.Heart className="w-spacing-md h-spacing-md" />,
    keywords: ["rosário", "terço", "ave maria", "mistérios"],
    type: "page",
  },
  {
    label: "Via Crucis",
    description: "Caminho da Cruz",
    path: AppRoute.VIA_CRUCIS,
    icon: <Icons.Cross className="w-spacing-md h-spacing-md" />,
    keywords: ["via crucis", "cruz", "estações", "paixão"],
    type: "page",
  },
  {
    label: "Oração e Devoção",
    description: "Orações tradicionais",
    path: AppRoute.ORACAO,
    icon: <Icons.Heart className="w-spacing-md h-spacing-md" />,
    keywords: ["oração", "rezar", "devoção", "pai nosso"],
    type: "page",
  },
  {
    label: "Confissão",
    description: "Guia e exame de consciência",
    path: AppRoute.POENITENTIA,
    icon: <Icons.Cross className="w-spacing-md h-spacing-md" />,
    keywords: ["confissão", "pecado", "exame", "consciência", "penitência"],
    type: "page",
  },
  {
    label: "Suma Teológica",
    description: "Opera Omnia de São Tomás",
    path: AppRoute.AQUINAS_OPERA,
    icon: <Icons.Aquinas className="w-spacing-md h-spacing-md" />,
    keywords: ["aquinas", "tomás", "suma", "teológica", "escolástica"],
    type: "page",
  },
  {
    label: "Certamen (Quiz)",
    description: "Teste seus conhecimentos",
    path: AppRoute.CERTAMEN,
    icon: <Icons.Certamen className="w-spacing-md h-spacing-md" />,
    keywords: ["quiz", "certamen", "teste", "perguntas"],
    type: "page",
  },
  {
    label: "Missal",
    description: "Ordo Missae",
    path: `${AppRoute.LITURGIA}?tab=missal`,
    icon: <Icons.Book className="w-spacing-md h-spacing-md" />,
    keywords: ["missal", "missa", "ordo", "eucaristia"],
    type: "page",
  },
  {
    label: "Lectio Divina",
    description: "Leitura orante",
    path: AppRoute.LECTIO_DIVINA,
    icon: <Icons.Feather className="w-spacing-md h-spacing-md" />,
    keywords: ["lectio", "divina", "meditação", "contemplação"],
    type: "page",
  },
  {
    label: "Breviário",
    description: "Liturgia das Horas",
    path: AppRoute.BREVIARY,
    icon: <Icons.History className="w-spacing-md h-spacing-md" />,
    keywords: ["breviário", "horas", "laudes", "vésperas", "ofício"],
    type: "page",
  },
  {
    label: "Trilhas de Estudo",
    description: "Formação estruturada",
    path: AppRoute.TRILHAS,
    icon: <Icons.Layout className="w-spacing-md h-spacing-md" />,
    keywords: ["trilha", "estudo", "formação", "curso"],
    type: "page",
  },
  {
    label: "Logos IA",
    description: "Sua dúvida iluminada pela fé",
    path: AppRoute.STUDY_MODE,
    icon: <Icons.Search className="w-spacing-md h-spacing-md" />,
    keywords: ["ia", "logos", "perguntar", "ajuda", "estudo"],
    type: "page",
  },
  {
    label: "Favoritos",
    ...
    icon: <Icons.Heart className="w-spacing-md h-spacing-md" />,
    keywords: ["favoritos", "salvos", "bookmark"],
    type: "page",
  },
  {
    label: "Jornadas",
    description: "Jornadas espirituais guiadas",
    path: AppRoute.JORNADAS,
    icon: <Icons.Compass className="w-spacing-md h-spacing-md" />,
    keywords: ["jornadas", "jornada", "espiritual", "caminhada"],
    type: "page",
  },
  {
    label: "Sobre",
    description: "Sobre o Cathedra",
    path: AppRoute.ABOUT,
    icon: <Icons.Globe className="w-spacing-md h-spacing-md" />,
    keywords: ["sobre", "manifesto", "about"],
    type: "page",
  },
  {
    label: "Login",
    ...
    keywords: ["login", "conta", "entrar", "cadastro"],
    type: "page",
  },
  {
    label: "Litanias",
    description: "Orações de invocação",
    path: AppRoute.LITANIES,
    icon: <Icons.Heart className="w-spacing-md h-spacing-md" />,
    keywords: ["litania", "invocação", "sagrado coração", "nossa senhora"],
    type: "page",
  },
  {
    label: "Calendário Litúrgico",
    description: "Festas e cores litúrgicas",
    path: `${AppRoute.LITURGIA}?tab=calendario`,
    icon: <Icons.History className="w-spacing-md h-spacing-md" />,
    keywords: ["calendário", "litúrgico", "festas", "solenidade", "cores"],
    type: "page",
  },
  {
    label: "Comunidade",
    description: "Discussões teológicas",
    path: AppRoute.COMMUNITY,
    icon: <Icons.Message className="w-spacing-md h-spacing-md" />,
    keywords: ["comunidade", "discussão", "pergunta", "fórum", "teologia"],
    type: "page",
  },
  {
    label: "Busca Global",
    description: "Pesquisar em todos os módulos",
    path: AppRoute.BUSCAR,
    icon: <Icons.Search className="w-spacing-md h-spacing-md" />,
    keywords: ["buscar", "pesquisar", "procurar", "busca", "global", "search"],
    type: "page",
  },
];
...
const CommandCenter: React.FC = () => {
    ...
    const results: UnifiedResult[] = dbSaintsResults.slice(0, 8).map((s) => ({
      ...
      icon: s.image ? (
        <img
          src={s.image}
          alt={s.name}
          className="w-spacing-md h-spacing-md rounded-premium-full object-cover"
        />
      ) : (
  ...
  const runGlobalSearch = useCallback(async (q: string) => {
    ...
    const promises: Promise<void>[] = [
      // Bible search
      supabase.functions
        .invoke("bible-search", { body: { query: q } })
        .then(({ data }) => {
          if (data?.results) {
      ...
      (async () => {
        ...
        if (results.filter((r) => r.type === "catechism").length < 4) {
          ...
          data?.forEach((p: any) => {
            // Avoid duplicates
            if (
              !results.some((r) => r.type === "catechism" && r.label.includes(`§${p.paragraph}`))
            ) {
              results.push({
                type: "catechism",
                label: `§${p.paragraph}`,
  ...
  const allItems = useMemo(() => {
    ...
    return [...filteredPages.slice(0, 5), ...filteredSaints, ...globalResults];
  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
    if (e.key === "ArrowDown") {
      ...
      go(allItems[selectedIndex].path);
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        {/* Search input */}
        <div
          className="flex items-center gap-spacing-sm px-spacing-md py-spacing-md border-b border-border"
          role="combobox"
        ...
        >
          <Icons.Search
            className="w-spacing-md h-spacing-md text-primary shrink-0"
            aria-hidden="true"
          />
          <input
            ref={inputRef}
          ...
          <kbd className="hidden sm:inline-flex items-center px-spacing-xs py-spacing-3xs rounded bg-muted text-muted-foreground text-premium-xs font-mono font-bold">
            ESC
          </kbd>
        </div>
        ...
        {globalLoading && (
          <div className="h-spacing-3xs w-full bg-muted overflow-hidden">
            <div
              className="h-full w-spacing-2xs/3 bg-primary animate-[shimmer_1s_ease-in-out_infinite] rounded-premium"
        ...
        <div
          ...
          id="command-list"
          role="listbox"
          className="max-h-[40vh] sm:max-h-[55vh] overflow-y-auto py-spacing-2xs"
        >
          {query.length >= 2 && !globalLoading && resultCount > 0 && (
            <div
              className="px-spacing-md py-spacing-xs text-premium-xs font-black uppercase tracking-widest text-muted-foreground"
              aria-live="polite"
            >
          ...
          {allItems.map((item, i) => {
            ...
            return (
              <React.Fragment key={`${item.type}-${item.label}-${i}`}>
                {showGroupHeader && (
                  <div
                    className="px-spacing-md pt-spacing-sm pb-spacing-2xs text-premium-xs font-black uppercase tracking-widest text-muted-foreground/60 flex items-center gap-spacing-xs"
                    role="presentation"
                  >
                ...
                >
                  <span
                    className={`p-spacing-2xs rounded-premium-full ${i === selectedIndex ? "bg-primary/20" : "bg-muted"}`}
                  >
                    {item.icon}
                  </span>
                  ...
                  <span
                    className={`text-premium-xs font-black uppercase tracking-widest px-spacing-xs py-spacing-3xs rounded-premium-full ${
