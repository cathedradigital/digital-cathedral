...
const SpiritualGoals: React.FC = () => {
  ...
  return (
    <CathedraCard
      padding="md"
      className="premium-card bg-primary/[0.02] border-primary/5 rounded-[2.5rem] overflow-hidden shadow-premium-none space-y-spacing-xl"
    >
          ...
          >
            <div className="space-y-spacing-xs">
              ...
              <div className="flex gap-spacing-xs">
                ...
                />
                <Button onClick={handleUpdateGoal} className="rounded-premium px-spacing-lg">
                  Salvar
                </Button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-spacing-md pt-spacing-md border-t border-primary/5">
              ...
              >
                <Icons.Bell className="w-spacing-sm h-spacing-sm" /> Push{" "}
                {reminderSettings?.push_enabled ? "ON" : "OFF"}
              </Button>
              <Button
                ...
                className="rounded-premium gap-spacing-xs text-[10px] font-black uppercase tracking-widest h-spacing-2xl"
              >
                <Icons.Calendar className="w-spacing-sm h-spacing-sm" /> E-mail{" "}
                {reminderSettings?.email_enabled ? "ON" : "OFF"}
              </Button>
            </div>
          </motion.div>
        ) : (
          ...
          >
            <div className="flex justify-between items-end mb-spacing-xs">
              <div className="space-y-spacing-2xs">
                <span className="text-premium-4xl font-display font-bold text-primary">
                  {goal.achieved_count}
                </span>
                <span className="text-premium-xl text-muted-foreground/40 font-serif italic mx-spacing-xs">
                  /
                </span>
                <span className="text-premium-xl font-bold text-muted-foreground">
                  {goal.goal_count} passos
                </span>
              </div>
              {progress === 100 && (
                <Badge className="bg-primary/20 text-primary border-primary/10 animate-bounce">
                  <Icons.CheckCircle2 className="w-spacing-sm h-spacing-sm mr-spacing-2xs" /> Meta
                  Alcançada
                </Badge>
              )}
            </div>
