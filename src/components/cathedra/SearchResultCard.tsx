  ...
  (
    ...
    return (
      <CathedraCard
        ...
        className={cn("border border-border/20 group", className)}
        onClick={onClick}
      ...
      >
        <div className="p-spacing-sm flex items-center gap-spacing-sm">
          ...
          <div className="flex-1 min-w-spacing-0">
            <p className="editorial-display text-lg text-foreground truncate leading-snug">
              {title}
            </p>
            {(subtitleNode ?? subtitle) && (
              <p className="font-serif italic text-premium-xs text-muted-foreground line-clamp-spacing-2xs mt-spacing-2xs">
                {subtitleNode ?? subtitle}
              </p>
            )}
          </div>
        ...
        {actions && (
          <div className="px-spacing-sm pb-spacing-sm pt-0 -mt-1 border-t border-border/10">
            <div className="pt-spacing-sm">{actions}</div>
          </div>
        )}
      </CathedraCard>
    );
