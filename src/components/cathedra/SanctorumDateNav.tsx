...
export type SanctorumDateChangeMethod =
  "prev-day" | "next-day" | "prev-week" | "next-week" | "today" | "calendar" | "strip";
...
export const SanctorumDateNav: React.FC<SanctorumDateNavProps> = ({
  ...
  const strip = Array.from({ length: stripDays }).map((_, i) => addDays(subDays(value, half), i));
      ...
      <div className="flex flex-wrap items-center justify-center gap-spacing-xs">
        ...
        <Popover open={calendarOpen} onOpenChange={setCalendarOpen}>
          <PopoverTrigger asChild>
            ...
            >
              <Icons.Calendar
                className="w-spacing-sm h-spacing-sm mr-spacing-2xs"
                aria-hidden="true"
              />
              Calendário
            </Button>
