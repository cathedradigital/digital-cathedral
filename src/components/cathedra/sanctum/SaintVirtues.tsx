 ...
 */
const SaintVirtues: React.FC<{ saint: Saint; headingId?: string }> = ({
  saint,
  headingId = "virt-heading",
}) => {
  ...
  return (
    <section aria-labelledby={headingId} className="space-y-spacing-md">
      <div className="flex items-center gap-spacing-xs text-primary">
        ...
        <h3 id={headingId} className="text-premium-small font-black uppercase tracking-[0.2em]">
          Virtudes
        </h3>
      </div>
