...
const AdminChartsRecharts: React.FC<Props> = ({ userGrowth, revenueData }) => (
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-spacing-md">
    <Card
      data-test="grafico-1"
      className="border-border/40 shadow-premium-none overflow-hidden bg-card "
    >
      <CardHeader className="pb-spacing-xs pt-spacing-md px-spacing-md">
        <CardTitle className="text-premium-sm font-black uppercase tracking-tight text-primary">
          Crescimento de Usuários
        </CardTitle>
        <CardDescription className="text-premium-xs uppercase tracking-widest opacity-60">
