...
const AdminDashboard: React.FC = () => {
  ...
  const handleManualPremium = async (grant: boolean) => {
    ...
    queryClient.invalidateQueries({ queryKey: ["admin-dashboard-stats"] });
    toast.success(
      grant ? `Premium ativado para ${manualEmail}` : `Premium removido de ${manualEmail}`,
    );
    setManualEmail("");
  };
  ...
  const SortIcon = ({ field }: { field: typeof sortField }) => {
    ...
    return sortAsc ? (
      <Icons.ChevronUp className="w-spacing-sm h-spacing-sm inline ml-spacing-2xs" />
    ) : (
      <Icons.ChevronDown className="w-spacing-sm h-spacing-sm inline ml-spacing-2xs" />
    );
  };
    ...
    return (
      <div className="space-y-spacing-lg animate-pulse p-spacing-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-spacing-md">
          {[1, 2, 3, 4].map((i) => (
            <Skeleton key={i} className="h-spacing-4xl w-full rounded-premium-lg" />
          ))}
        </div>
    ...
    <div className="space-y-spacing-lg sm:space-y-spacing-xl pb-spacing-3xl sm:pb-spacing-xl px-spacing-0 sm:px-spacing-0">
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-spacing-lg">
        <div className="px-spacing-md sm:px-spacing-0 -mx-spacing-md sm:mx-spacing-0">
          <TabsList
            ref={tabsListRef}
            className="flex w-full overflow-x-auto justify-start h-auto p-spacing-2xs bg-muted/30 border border-border/10 rounded-premium-full no-scrollbar scroll-smooth snap-x"
          >
            <TabsTrigger
              value="knowledge"
              data-test="tab-knowledge"
              className="gap-spacing-xs text-premium-xs font-black uppercase tracking-widest min-w-fit px-spacing-md py-spacing-xs snap-start text-primary"
            >
            ...
            <TabsTrigger
              value="production"
              data-test="tab-production"
              className="gap-spacing-xs text-premium-xs font-black uppercase tracking-widest min-w-fit px-spacing-md py-spacing-xs snap-start text-emerald-600"
            >
            ...
            <TabsTrigger
              ...
              className="gap-spacing-xs text-premium-xs font-black uppercase tracking-widest min-w-fit px-spacing-md py-spacing-xs snap-start"
            >
        ...
        <TabsContent
          value="knowledge"
          className="mt-spacing-lg focus-visible:outline-none focus-visible:ring-0"
        >
        ...
        <TabsContent value="overview" className="space-y-spacing-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-spacing-lg px-spacing-md sm:px-spacing-0">
            ...
            <Card className="rounded-premium-lg border-primary/5">
              <CardHeader>
                <CardTitle className="text-premium-lg font-black uppercase">
                  Ações Rápidas
                </CardTitle>
        ...
        <TabsContent value="design" className="space-y-spacing-lg">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-spacing-md px-spacing-md sm:px-spacing-0">
            ...
            >
              ...
              <p className="text-premium-xs opacity-50 mt-spacing-xs">
                Inspeciona erros de UI e TypeErrors.
              </p>
            </CathedraCard>
            ...
            >
              ...
              <p className="text-premium-xs opacity-50 mt-spacing-xs">
                Gerencie a allowlist e auditoria.
              </p>
            </CathedraCard>
            ...
            >
              ...
              <p className="text-premium-xs opacity-50 mt-spacing-xs">
                Monitore vulnerabilidades detectadas.
              </p>
            </CathedraCard>
            ...
            >
              ...
              <p className="text-premium-xs opacity-50 mt-spacing-xs">
                Crie, edite e publique termos teológicos.
              </p>
            </CathedraCard>
          </div>
