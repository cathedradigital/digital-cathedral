        ...
        <div className="absolute right-0 top-full mt-spacing-xs w-spacing-4xl max-h-spacing-4xl overflow-y-auto bg-card border border-border rounded-premium shadow-premium-hover z-50 p-spacing-md space-y-spacing-sm">
          ...
          {notes.map((note) => {
            ...
            return (
              <div
                key={note.id}
                className={`rounded-premium-full p-spacing-sm ${cfg.bg} border ${cfg.border} space-y-spacing-2xs`}
              >
                {editingId === note.id ? (
                  <div className="space-y-spacing-xs">
                    <textarea
                    ...
                    <div className="flex gap-spacing-xs">
                      <Button
                        ...
                        className="text-premium-xs font-bold text-primary"
                      >
                        Salvar
                      </Button>
                      <Button
                  ...
                  <>
                    <p className="text-premium-sm text-foreground leading-relaxed">
                      {note.note_text}
                    </p>
                    <div className="flex items-center justify-between">
          ...
          {!loading && notes.length === 0 && (
            <p className="text-premium-xs text-muted-foreground italic text-center py-spacing-xs">
