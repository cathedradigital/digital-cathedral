...
export type Step =
  "intro" | "lectio" | "meditatio" | "oratio" | "contemplatio" | "actio" | "conclusio";
...
export const STEPS = [
  {
    ...
    latin: "Lectio",
    instruction:
      "Leia o texto sagrado com atenção, lentamente, como quem escuta a voz de Deus. Repita a leitura quantas vezes precisar.",
  ...
  },
  {
    ...
    latin: "Meditatio",
    instruction:
      "Reflita sobre o que leu. Mastigue a Palavra como um alimento espiritual. Deixe-a penetrar no coração e na mente.",
  ...
  },
  {
    ...
    latin: "Oratio",
    instruction:
      "Responda a Deus com a oração que brota do coração. Fale com Ele sobre o que a meditação suscitou em você.",
  ...
  },
  {
    ...
    latin: "Contemplatio",
    instruction:
      "Faça silêncio interior. Repouse na presença de Deus sem palavras, sem pensamentos, apenas acolhendo Seu amor.",
  ...
  },
  {
    ...
    latin: "Actio",
    instruction:
      "Leve a Palavra para a vida concreta. Que resolução prática você faz a partir deste encontro com Deus?",
