    ...
    <div className="w-full space-y-spacing-2xl pb-spacing-2xl">
      ...
      >
        ...
        <p className="text-premium-lg text-muted-foreground font-serif italic leading-relaxed">
          Que bom ter você aqui. Reserve este momento só para Deus e para você.
          <br />
      ...
      >
        <div
          className={`w-spacing-2xl h-spacing-2xl rounded-premium-full flex items-center justify-center shrink-0 ${
            selectedPassage === dailyPassage.ref ? "bg-white/20" : "bg-primary/10"
          }`}
        >
          <Icons.Heart
            className={`w-spacing-lg h-spacing-lg ${selectedPassage === dailyPassage.ref ? "text-white" : "text-primary"}`}
          />
        </div>
        <div className="text-left flex-1">
          <p
            className={`text-premium-xs font-black uppercase tracking-[0.2em] ${
          ...
          <p
            className={`font-serif font-bold text-premium-lg ${
          ...
          <div className="flex items-center gap-spacing-xs mt-spacing-2xs">
            <Icons.Clock
              className={`w-spacing-sm h-spacing-sm ${selectedPassage === dailyPassage.ref ? "text-white/60" : "text-muted-foreground"}`}
            />
            <span
              className={`text-premium-xs ${selectedPassage === dailyPassage.ref ? "text-white/60" : "text-muted-foreground"}`}
            >
              ~15 min · {dailyPassage.ref}
            </span>
          </div>
        </div>
        <Icons.ArrowRight
          className={`w-spacing-md h-spacing-md group-hover:translate-x-1 transition-transform ${
      ...
      >
        {STEPS.map((step, i) => (
          <div
            key={step.id}
            className="group p-spacing-md rounded-premium bg-card border border-border text-center space-y-spacing-sm hover:border-primary/30 hover:shadow-premium-hover hover:-translate-y-1 transition-all"
          >
            <div
              className={`w-spacing-2xl h-spacing-2xl rounded-premium-full mx-auto flex items-center justify-center transition-transform group-hover:scale-110 ${step.color}`}
            >
              <step.icon className="w-spacing-lg h-spacing-lg" />
            </div>
            <div>
              <p className="text-premium-xs font-black uppercase tracking-widest text-primary/85">
                {step.latin}
              </p>
      ...
      >
        <div className="space-y-spacing-lg w-full mx-auto">
          <div className="text-center space-y-spacing-xs">
            <h3 className="text-premium-sm font-black uppercase tracking-widest text-primary/85">
              Ou escolha outra passagem
            </h3>
            <p className="text-premium-xs text-muted-foreground font-serif italic">
              Digite uma referência bíblica ou escolha uma sugestão.
            </p>
          </div>
