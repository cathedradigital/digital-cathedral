    ...
    <div className="fixed inset-0 z-[100] bg-[#FAF9F6] flex flex-col">
      <header className="px-6 h-16 flex items-center justify-between border-b border-primary/5">
        <button
          ...
          className="p-2 -ml-2 min-h-11 min-w-11 flex items-center justify-center text-primary/40 active:text-secondary"
        >
                ...
                <div className="space-y-4">
                  {group.notes.map((note: UserNote) => (
                    ...
                    >
                      <button
                        onClick={() =>
                          onSelectReference(note.book_abbr!, note.chapter!, note.verse || 1)
                        }
