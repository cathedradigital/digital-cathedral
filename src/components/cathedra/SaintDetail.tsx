...
const SaintDetail: React.FC<{
  ...
  autoReflect?: boolean;
  legacy?: boolean;
}> = ({ saint, onClose, autoReflect = false, legacy = false }) => {
  ...
  const seoDescription = (
    saint.bio ||
    saint.fullBio ||
    `Vida, virtudes e testemunho de ${saint.name}.`
  )
    .replace(/\s+/g, " ")
    .trim()
    .slice(0, 160);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content={`${saint.name}${saint.title ? " — " + saint.title : ""}`}
        />
        ...
        {typeof saint.image === "string" && (
          <>
            ...
            <meta
              ...
              content={`Sanctorum · ${saint.name}${saint.feastDay ? " · " + saint.feastDay : ""}`}
            />
          </>
        )}
              ...
              onClick={() => {
                ...
                try {
                  localStorage.setItem(
                    "cathedra:saints:reader-variant",
                    nextLegacy ? "legacy" : "new",
                  );
                } catch {
                  /* ignore */
                }
          ...
          <div className="flex-1 overflow-y-auto flex flex-col">
              ...
              <ReaderToolbar
                ...
                shareUrl={
                  typeof window !== "undefined"
                    ? `${window.location.origin}/santos/${saint.id}`
                    : undefined
                }
              />
            )}
            ...
            <div className="p-spacing-lg md:p-spacing-2xl space-y-spacing-2xl">
              ...
              <EditorialReaderHeader
                ...
                subtitle={saint.title}
                meta={[
                  saint.feastDay && `${t("feast_day")} · ${saint.feastDay}`,
                  saint.born,
                  saint.died,
                ]
                  .filter(Boolean)
              ...
              <section className="space-y-spacing-lg">
                ...
                <div className="flex flex-wrap items-center gap-spacing-lg py-spacing-md border-y border-border/10">
                  <div className="flex items-center gap-spacing-sm">
                    ...
                    <div>
                      <span className="text-premium-xs font-black uppercase tracking-widest text-muted-foreground block">
                        {t("feast_day")}
                      </span>
              ...
              <section className="space-y-spacing-xl">
                <div className="flex items-center gap-spacing-xs text-primary">
                  ...
                  <h3 className="text-premium-small font-black uppercase tracking-[0.2em]">
                    Trajetória de Santidade
                  </h3>
                </div>

                <Suspense
                  fallback={<div className="h-40 animate-pulse bg-muted/20 rounded-premium" />}
                >
                  <SaintDetailTabs
                    saint={saint}
                ...
                <div className="space-y-spacing-md">
                  ...
                  <div className="bg-primary/5 p-spacing-xl rounded-[2rem] border border-primary/10 relative group hover:bg-primary/10 transition-all min-h-[160px]">
                    <p className="text-premium-sm font-medium text-foreground relative z-10 leading-relaxed italic">
                      {saint.aplicacaoPratica ||
                        "Procure imitar a humildade deste santo em suas tarefas ordinárias."}
                    </p>
                  </div>
                </div>
              </div>
              ...
              {(() => {
                ...
                return (
                  <div className="space-y-spacing-xl">
                    ...
                    <NexusPanel
                      output={nexus}
                      kicker={`Por que isso está conectado? · ${saint.name}`}
                    />
              ...
              <section className="bg-primary/5 rounded-[2.5rem] p-spacing-xl md:p-spacing-2xl border border-primary/10">
                <div className="max-w-2xl mx-auto text-center space-y-spacing-lg">
                  ...
                  <p className="text-premium-md font-serif leading-relaxed text-foreground/80 italic">
                    {saint.spiritualPractice?.prayer ||
                      "Senhor, pela intercessão de Vosso santo, concedei-nos a graça de seguir Vossos caminhos com fidelidade."}
                  </p>
                </div>
              </section>
              ...
              >
                <div className="flex items-center gap-spacing-md">
                  ...
                  <div>
                    <p className="text-premium-xs font-black uppercase tracking-widest text-primary/60 mb-spacing-2xs">
                      Continuar Caminhada
                    </p>
                    <h4 className="text-premium-lg font-bold text-foreground font-serif">
                      Jornada {suggestedJourney.name}
                    </h4>
                  </div>
                </div>
                <Button
              ...
              <SourceAttribution
                ...
                sourceUrl={
                  (saint as any).source_url || (saint as any).sourceUrl || (saint as any).url
                }
              />
            </div>
          </div>
