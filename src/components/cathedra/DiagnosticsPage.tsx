    ...
    <div className="max-w-spacing-4xl mx-auto space-y-spacing-xl py-spacing-xl">
      <div className="text-center space-y-spacing-sm">
        ...
        <p className="text-muted-foreground font-serif italic max-w-spacing-lg mx-auto">
          Monitoramento em tempo real dos serviços da Cathedra Digital.
        </p>
      </div>
        ...
        <Card className="border-border/50 bg-card rounded-[2rem] overflow-hidden">
          ...
          <CardContent className="space-y-spacing-md">
            <div className="flex items-center gap-spacing-sm">
              <div
                className={`w-spacing-sm h-spacing-sm rounded-premium-full animate-pulse ${
                  supabaseStatus === "ok"
                    ? "bg-primary"
        ...
        <Card className="border-border/50 bg-card rounded-[2rem] overflow-hidden">
          ...
          <CardContent className="space-y-spacing-md">
            <div className="flex items-center gap-spacing-sm">
              ...
              <span className="text-premium-lg font-bold text-foreground">
                {dbStats?.post_count || 0} Discussões
              </span>
            </div>
            <p className="text-premium-xs text-muted-foreground italic">
              Atividade: Alta (Últimas 24h)
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="bg-card border border-border rounded-premium p-spacing-xl space-y-spacing-lg">
        ...
        <div className="grid gap-spacing-md">
          {[
            ...
            <div
              key={i}
              className="flex items-center justify-between py-spacing-sm border-b border-border/50 last:border-0"
            >
              <span className="text-premium-sm font-bold text-foreground/80">{service.label}</span>
              <span
                className={`text-premium-xs font-black uppercase tracking-widest px-spacing-sm py-spacing-2xs rounded-premium-full ${
        ...
        <div className="pt-spacing-md flex flex-col sm:flex-row justify-center gap-spacing-sm">
          <Button
            ...
            disabled={loading}
            variant="outline"
            className="rounded-premium-full font-black uppercase tracking-widest text-premium-xs"
          >
          ...
          <Button
            asChild
            variant="ghost"
            className="rounded-premium-full font-black uppercase tracking-widest text-premium-xs hover:bg-red-500/5 hover:text-red-600"
          >
