  ...
  <div className="w-full space-y-spacing-3xl py-spacing-md animate-in fade-in slide-in-from-bottom-spacing-md duration-1000">
    ...
    <div className="text-center space-y-spacing-md">
      ...
      <h1 className="text-premium-4xl md:text-premium-6xl font-serif font-bold text-foreground tracking-tight">
        Sobre a Cathedra Digital
      </h1>
      <p className="text-muted-foreground text-premium-lg">
        Unindo a tradição milenar da Igreja à vanguarda tecnológica para a glória de Deus.
      </p>
    </div>
      ...
      {[
        {
          label: "Missão",
          href: "#missao",
          icon: <Icons.Target className="w-spacing-md h-spacing-md" />,
        },
        {
          label: "História",
          href: "#historia",
        ...
        },
        {
          label: "Redes Sociais",
          href: "#redes-sociais",
          icon: <Icons.Instagram className="w-spacing-md h-spacing-md" />,
        },
      ].map((link) => (
        <a
          key={link.href}
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-spacing-2xl items-start">
      ...
      <div id="missao" className="scroll-mt-spacing-4xl space-y-spacing-lg">
        ...
        <div className="space-y-spacing-md text-muted-foreground leading-relaxed text-premium-lg">
          <p>
            A Cathedra Digital nasceu de uma convicção profunda: a riqueza incomensurável da
            tradição católica — sua teologia, liturgia, moral e espiritualidade — deve ser acessível
            a todo fiel, sem diluição e sem complicação.
          </p>
          <p>
            Nosso objetivo primordial é fornecer uma plataforma de formação contínua, onde cada
            recurso é meticulosamente desenhado para conduzir o usuário da simples leitura à
            profunda compreensão, e da compreensão à vivência cristã autêntica.
          </p>
        </div>
      </div>
      ...
      <div id="historia" className="scroll-mt-spacing-4xl space-y-spacing-lg">
        ...
        <div className="space-y-spacing-md text-muted-foreground leading-relaxed text-premium-lg">
          <p>
            O projeto Cathedra começou como uma busca pessoal por consolidar os tesouros da Igreja
            em uma interface digna da beleza de seu conteúdo. O que era um repositório de estudos
            transformou-se em um ecossistema digital completo.
          </p>
          <p>
            Desde a primeira linha de código, o foco foi a fidelidade ao Magistério. Passamos de uma
            simples ferramenta de busca para uma inteligência a serviço da Tradição, ajudando
            milhares de pessoas a redescobrirem a profundidade de sua fé no cotidiano digital.
          </p>
        </div>
      </div>
    </div>
    ...
    <div
      id="redes-sociais"
      className="scroll-mt-spacing-4xl bg-primary/[0.01] rounded-[2.5rem] p-spacing-xl md:p-spacing-2xl border border-primary/5 shadow-premium"
    >
      <div className="text-center space-y-spacing-xl">
        <div className="space-y-spacing-xs">
          ...
          <p className="text-muted-foreground">
            Acompanhe reflexões diárias e atualizações da plataforma.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-spacing-lg">
          {[
            {
              icon: <Icons.Instagram className="w-spacing-lg h-spacing-lg" />,
              label: "Instagram",
              url: SOCIAL_LINKS.INSTAGRAM,
              color: "hover:text-pink-600",
            },
            {
              icon: <Icons.Youtube className="w-spacing-lg h-spacing-lg" />,
              label: "YouTube",
              url: SOCIAL_LINKS.YOUTUBE,
              color: "hover:text-red-600",
            },
            {
              icon: <Icons.Twitter className="w-spacing-lg h-spacing-lg" />,
              label: "X (Twitter)",
              url: SOCIAL_LINKS.TWITTER,
              color: "hover:text-sky-500",
            },
            {
              icon: <Icons.Facebook className="w-spacing-lg h-spacing-lg" />,
              label: "Facebook",
              url: SOCIAL_LINKS.FACEBOOK,
              color: "hover:text-blue-600",
            },
            {
              icon: <Icons.Whatsapp className="w-spacing-lg h-spacing-lg" />,
              label: "WhatsApp",
            ...
            <a
              ...
              onClick={() =>
                trackEvent("social_link_click", { platform: social.label, url: social.url })
              }
    ...
    <div className="space-y-spacing-2xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-spacing-lg">
        {[
          {
            icon: <Icons.Book className="w-spacing-xl h-spacing-xl" />,
            title: "Escritura",
            desc: "Os 73 livros da Bíblia Católica, com referências cruzadas e contexto teológico profundo.",
          },
          {
            icon: <Icons.Cross className="w-spacing-xl h-spacing-xl" />,
            title: "Tradição",
            desc: "Acesso integral ao Catecismo, Magistério, Concílios e toda a Doutrina da Igreja.",
          },
          {
            icon: <Icons.Heart className="w-spacing-xl h-spacing-xl" />,
            title: "Oração",
            desc: "Rosário, Via Sacra, Missal Romano e um devocionário completo para sua vida espiritual.",
          },
          {
            icon: <Icons.Star className="w-spacing-xl h-spacing-xl" />,
            title: "Formação",
            desc: "Trilhas de estudo progressivas, quizzes de conhecimento e a Suma Teológica de São Tomás.",
          },
        ].map((pillar) => (
          <div
            key={pillar.title}
            className="bg-card border border-primary/5 rounded-premium p-spacing-lg space-y-spacing-md hover:border-primary/20 transition-all group shadow-premium"
          >
      ...
      <div className="flex flex-col md:flex-row items-center gap-spacing-xl md:gap-spacing-3xl bg-primary/[0.01] rounded-[2.5rem] p-spacing-xl md:p-spacing-2xl border border-primary/5 shadow-premium">
        ...
        <div className="space-y-spacing-lg flex-1 text-center md:text-left">
          ...
          <div className="space-y-spacing-md text-muted-foreground text-premium-lg leading-relaxed font-serif">
            <p>
              A Cathedra Digital foi concebida por{" "}
              <span className="text-foreground font-bold">Evaldo.os</span> como uma resposta ao
              chamado de evangelização na era digital. Unindo a paixão pela tecnologia de ponta com
              a veneração pela Tradição Católica de dois mil anos.
            </p>
            <p>
              "Nossa missão é fornecer as ferramentas mais avançadas para que cada católico possa
              aprofundar sua fé, estudar as escrituras e viver a liturgia com clareza, beleza e
              profundidade."
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-spacing-sm pt-spacing-xs">
            {["Espiritualidade", "Reflexão", "Tecnologia", "Tradição"].map((tag) => (
              <span
                key={tag}
                className="px-spacing-md py-spacing-2xs bg-background border border-border rounded-premium-full text-premium-xs font-black uppercase tracking-widest text-muted-foreground"
              >
                {tag}
              </span>
            ))}
    ...
    <div className="py-spacing-3xl text-center space-y-spacing-md">
      <p className="text-premium-2xl font-serif font-bold text-foreground tracking-tight uppercase">
