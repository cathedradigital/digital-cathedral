    ...
    mysteries: [
      {
        ...
        meditation: "O Anjo Gabriel anuncia a Maria que ela será Mãe do Salvador.",
      },
      {
        title: "A Visitação de Maria a Isabel",
        scripture: "Lc 1,39-56",
        meditation: "Maria vai às pressas visitar Isabel. João Batista exulta no ventre.",
      },
      {
        title: "O Nascimento de Jesus",
        scripture: "Lc 2,1-20",
        meditation: "O Verbo se faz carne em Belém, na pobreza de uma manjedoura.",
      },
      {
        title: "A Apresentação de Jesus no Templo",
        scripture: "Lc 2,22-38",
        meditation: 'Jesus é oferecido ao Pai. Simeão profetiza: "Luz para iluminar as nações."',
      },
      {
        title: "A Perda e o Encontro de Jesus no Templo",
        scripture: "Lc 2,41-52",
        meditation: "Após três dias, Jesus é encontrado entre os doutores.",
      },
    ],
  },
  dolorosos: {
    ...
    mysteries: [
      {
        ...
        meditation: 'Jesus sua sangue no Getsêmani. "Não a minha vontade, mas a Tua."',
      },
      {
        title: "A Flagelação de Jesus",
        scripture: "Jo 19,1",
        meditation: '"Por suas chagas fomos curados." Cada golpe é um pecado nosso.',
      },
      {
        title: "A Coroação de Espinhos",
        scripture: "Mt 27,27-31",
        meditation: 'Os soldados tecem uma coroa de espinhos e zombam: "Salve, Rei dos Judeus!"',
      },
      {
        title: "Jesus Carrega a Cruz",
        scripture: "Jo 19,17",
        meditation: "Jesus toma sobre Si a Cruz — o peso de todos os pecados.",
      },
      {
        title: "A Crucificação e Morte de Jesus",
        scripture: "Lc 23,33-46",
        meditation: '"Pai, perdoai-os." "Está consumado." O sacrifício perfeito.',
      },
    ],
  },
  gloriosos: {
    ...
    mysteries: [
      {
        ...
        scripture: "Mc 16,1-7",
        meditation: '"Ele ressuscitou!" A morte foi vencida para sempre.',
      },
      {
        title: "A Ascensão de Jesus ao Céu",
        scripture: "At 1,9-11",
        meditation: 'Jesus sobe aos céus. "Ide e fazei discípulos de todas as nações."',
      },
      {
        title: "A Vinda do Espírito Santo",
        scripture: "At 2,1-4",
        meditation: "Línguas de fogo descem sobre os apóstolos em Pentecostes.",
      },
      {
        title: "A Assunção de Maria ao Céu",
        scripture: "Ap 12,1",
        meditation: "Maria é elevada ao Céu em corpo e alma, sinal de nossa esperança.",
      },
      {
        title: "A Coroação de Maria como Rainha",
        scripture: "Ap 12,1",
        meditation: "Maria é coroada Rainha do Céu e da Terra.",
      },
    ],
  },
  luminosos: {
    ...
    mysteries: [
      {
        ...
        meditation: '"Este é o meu Filho amado." Jesus santifica o Batismo.',
      },
      {
        title: "As Bodas de Caná",
        scripture: "Jo 2,1-11",
        meditation: '"Fazei tudo o que Ele vos disser." O primeiro sinal de Jesus.',
      },
      {
        title: "O Anúncio do Reino de Deus",
        scripture: "Mc 1,14-15",
        meditation: '"Convertei-vos e crede no Evangelho."',
      },
      {
        title: "A Transfiguração de Jesus",
        scripture: "Mt 17,1-8",
        meditation: "No Tabor, o rosto de Jesus brilha como o sol.",
      },
      {
        title: "A Instituição da Eucaristia",
        scripture: "Lc 22,19-20",
        meditation: '"Isto é o meu Corpo… Isto é o meu Sangue."',
      },
    ],
  },
};
...
const PRAYER_DETAILS = {
  paiNosso: {
    ...
    explicacao:
      "A oração que o próprio Jesus nos ensinou. É o modelo perfeito de oração, onde primeiro louvamos ao Pai e depois pedimos o que necessitamos para o corpo e para a alma.",
    interpretacaoProfunda:
      'Dizemos "Pai Nosso", não "meu Pai", porque somos uma família em Cristo. Ao dizer "Seja feita a vossa vontade", entregamos nossa liberdade a Deus, confiando que Seu plano é melhor que o nosso.',
    aplicacaoPratica:
      'Ao rezar hoje, tente pausar em "seja feita a vossa vontade" e pense em uma situação difícil que você está vivendo, entregando-a totalmente a Ele.',
    reflexaoFinal:
      "Eu realmente quero que a vontade de Deus seja feita, ou estou apenas tentando convencer Deus a fazer a minha?",
    exercicio:
      "Reze o Pai Nosso uma única vez, mas demore pelo menos 1 minuto, saboreando cada palavra.",
  },
  aveMaria: {
    textoBase: PRAYERS.aveMaria,
    explicacao:
      "A saudação angélica unida à oração da Igreja. Reconhecemos a cheia de graça e pedimos sua intercessão agora e no momento final de nossa vida.",
    interpretacaoProfunda:
      "A primeira parte da oração é bíblica (Lucas 1). A segunda parte é a súplica da Igreja. Maria é o canal pelo qual Jesus veio ao mundo e continua sendo o caminho mais curto para chegar a Ele.",
    aplicacaoPratica:
      'Quando estiver em uma situação de pecado ou tentação, diga: "rogai por nós pecadores, agora". Sinta o socorro imediato de Maria.',
    reflexaoFinal: "Como Maria pode me ajudar a ser mais fiel a Jesus hoje?",
    exercicio:
      "Reze uma Ave Maria em latim (Ave Maria, gratia plena...) para conectar-se com a tradição milenar da Igreja.",
  },
};
...
// ---------- Prayer Mode ----------
const PrayerMode: React.FC<{
  mysteryKey: MysteryKey;
  intention: string;
  onClose: () => void;
  prayer?: any;
}> = ({ mysteryKey, intention, onClose, prayer }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between p-spacing-md sticky top-spacing-0 z-10 bg-inherit/80 ">
        <Button
          onClick={onClose}
          className="p-spacing-xs rounded-premium-full bg-card/50 border border-white/10 hover:bg-white/10 transition-all"
        >
          <Icons.ArrowLeft className="w-spacing-md h-spacing-md text-secondary/70" />
        </Button>
        <span className="text-premium-xs font-black uppercase tracking-widest text-secondary/40">
          {data.title}
        </span>
      ...
      {(phase === "mystery" || phase === "decade") && (
        <div className="flex gap-spacing-2xs px-spacing-lg pt-spacing-xs max-w-spacing-xl mx-auto w-full">
          {[0, 1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className={`flex-1 h-spacing-2xs rounded-premium-full transition-all duration-500 ${i <= currentMystery ? "bg-secondary shadow-[0_0_8px_rgba(200,169,106,0.5)]" : "bg-white/10"}`}
            />
          ))}
        </div>
      )}
      ...
      {intention && phase === "intro" && (
        <div className="mx-spacing-lg mt-spacing-md p-spacing-md bg-secondary/5 border border-secondary/10 rounded-premium text-center max-w-spacing-xl md:mx-auto">
          <p className="text-premium-xs font-black uppercase tracking-widest text-secondary/50 mb-spacing-2xs">
            Intenção
          </p>
          <p className="text-premium-base font-serif text-secondary/70 italic leading-relaxed">
            "{intention}"
          </p>
        </div>
      )}
        ...
        <div className="w-full max-w-spacing-xl bg-white/[0.03] border border-white/[0.06] rounded-[2.5rem] p-spacing-xl md:p-spacing-2xl space-y-spacing-xl  shadow-premium-hover shadow-black/50">
          ...
          {phase === "intro" && (
            <div className="space-y-spacing-lg">
              <div className="text-center space-y-spacing-xs">
                <h3 className="text-premium-2xl font-serif font-bold text-secondary">
                  Orações Iniciais
                </h3>
                <p className="text-premium-xs text-secondary/40 font-serif italic">
                  Sinal da Cruz + Credo + 3 Ave-Marias + Glória
                </p>
              </div>
              <div className="space-y-spacing-sm">
                {[
                  ...
                  <div
                    key={p.key}
                    className="group bg-white/[0.04] rounded-premium p-spacing-md cursor-pointer border border-white/[0.06] hover:bg-white/[0.07] transition-all"
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <Icons.ChevronRight
                        className={`w-spacing-md h-spacing-md text-secondary/30 transition-transform ${expandedPrayer === p.key ? "rotate-90" : ""}`}
                      />
                    </div>
                    {expandedPrayer === p.key && (
                      <p className="text-premium-lg md:text-premium-xl text-secondary/60 mt-spacing-sm font-serif leading-relaxed animate-in fade-in slide-in-from-top-spacing-xs duration-300">
                ...
                {expandedPrayer && (PRAYER_DETAILS as any)[expandedPrayer] && (
                  <div className="mt-spacing-xl pt-spacing-xl border-t border-white/10">
                    <DeepContentSection
                      content={(PRAYER_DETAILS as any)[expandedPrayer]}
                      title="Profundidade da Oração"
                    />
                  </div>
                )}
              </div>
          ...
          {phase === "mystery" && (
            <div className="space-y-spacing-xl animate-in fade-in zoom-in-95 duration-500">
              <div className="text-center space-y-spacing-sm">
                <span className="text-premium-xs font-black uppercase tracking-widest text-secondary/50">
                  {currentMystery + 1}º Mistério
                </span>
                <h3 className="text-premium-3xl font-serif font-bold text-secondary leading-tight">
                  {mystery.title}
                </h3>
                <p className="text-premium-sm text-secondary/60 font-bold tracking-wide">
                  {mystery.scripture}
                </p>
              </div>
              <div className="bg-white/[0.04] rounded-[2rem] p-spacing-xl border border-white/[0.06] relative">
                ...
                <p className="text-premium-xl text-secondary/70 font-serif leading-relaxed text-center italic">
                  "{mystery.meditation}"
                </p>
              </div>
              <Button
                onClick={() => setPhase("decade")}
                className="w-full py-spacing-md bg-secondary/20 text-secondary border border-secondary/20 rounded-premium-full font-black uppercase text-premium-xs tracking-widest hover:bg-secondary/30 transition-all shadow-premium shadow-primary/20"
              >
                Rezar a Dezena
              </Button>
          ...
          {phase === "decade" && (
            <div className="space-y-spacing-xl animate-in fade-in duration-500">
              <div className="text-center">
                <p className="text-premium-xs font-black uppercase tracking-widest text-secondary/30 mb-spacing-md">
                  {currentMystery + 1}º Mistério — Dezena
                </p>
                ...
                <div className="flex flex-col items-center gap-spacing-md py-spacing-md">
                  ...
                  <p className="text-secondary/40 text-premium-xs font-black uppercase tracking-[0.2em]">
                    {aveCount}/10 Ave-Marias
                  </p>
                </div>
              </div>
          ...
          {phase === "closing" && (
            <div className="space-y-spacing-xl animate-in fade-in zoom-in-95 duration-700">
              <h3 className="text-premium-2xl font-serif font-bold text-secondary text-center">
                Oração Final
              </h3>

              <div
                className="bg-white/[0.04] rounded-premium p-spacing-lg cursor-pointer border border-white/[0.06] hover:bg-white/[0.07] transition-all"
                onClick={() => setExpandedPrayer(expandedPrayer === "salve" ? null : "salve")}
              >
                <div className="flex items-center justify-between">
                  <p className="font-bold text-premium-sm text-secondary/90">Salve Rainha</p>
                  <Icons.ChevronRight
                    className={`w-spacing-md h-spacing-md text-secondary/30 transition-transform ${expandedPrayer === "salve" ? "rotate-90" : ""}`}
                  />
                </div>
                {expandedPrayer === "salve" && (
                  <p className="text-premium-lg text-secondary/60 mt-spacing-md font-serif leading-relaxed italic animate-in fade-in slide-in-from-top-spacing-xs duration-300">
                    {PRAYERS.salveRainha}
                  </p>
                )}
              </div>
              ...
              <div className="text-center space-y-spacing-md py-spacing-xl">
                ...
                <div className="space-y-spacing-xs">
                  <p className="text-secondary font-serif font-bold text-premium-2xl">
                    Rosário Completo!
                  </p>
                  <p className="text-premium-base text-secondary/40 font-serif italic max-w-[280px] mx-auto leading-relaxed">
                    Que Nossa Senhora interceda por vós e por todas as vossas intenções.
                  </p>
                </div>
              </div>
              ...
              >
                <Icons.Cross className="w-spacing-md h-spacing-md inline mr-spacing-xs" /> Amém —
                Finalizar
              </Button>
            </div>
          )}
    ...
    >
      ...
      >
        ...
        <p className="text-premium-lg text-muted-foreground font-serif italic max-w-spacing-2xl mx-auto">
          "A oração é a respiração da alma. Sem ela, a vida interior desfalece."
        </p>
      </motion.div>
      ...
      >
        ...
        <div className="lg:col-span-2 space-y-spacing-xl">
            ...
            <div className="relative space-y-spacing-xl">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-spacing-md">
                <div className="space-y-spacing-2xs">
                  ...
                  <h2 className="text-premium-3xl md:text-premium-4xl font-serif font-bold text-foreground">
                    Terço de Hoje
                  </h2>
                </div>
                <div
                  className={`inline-flex items-center gap-spacing-sm px-spacing-md py-spacing-xs rounded-premium-full ${todayData.color} border border-current/10`}
                >
                  <todayData.icon className="w-spacing-md h-spacing-md" />
                  <span className="text-premium-sm font-serif font-bold tracking-tight">
                    {todayData.title}
                  </span>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-spacing-xl items-center">
                <div className="space-y-spacing-lg">
                  ...
                  >
                    <Icons.Play className="w-spacing-md h-spacing-md fill-current" /> Começar
                    Rosário
                  </Button>
                </div>
          ...
          <div className="space-y-spacing-lg">
            <div className="flex items-center justify-between px-spacing-xs">
              ...
              >
                Ver Rosário Completo{" "}
                <Icons.ChevronRight className="w-spacing-sm h-spacing-sm inline ml-spacing-2xs" />
              </Button>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-spacing-md">
              {(
                Object.entries(MYSTERY_DATA) as [MysteryKey, (typeof MYSTERY_DATA)[MysteryKey]][]
              ).map(([key, val]) => (
                <Button
                  key={key}
                ...
                >
                  <div
                    className={`w-spacing-2xl h-spacing-2xl rounded-premium-full flex items-center justify-center transition-transform group-hover:scale-110 ${val.color}`}
                  >
                    <val.icon className="w-spacing-lg h-spacing-lg" />
                  </div>
                  <div className="text-left flex-1">
                    <div className="flex items-center gap-spacing-xs">
                      <p className="font-serif font-bold text-foreground group-hover:text-primary transition-colors">
                        {val.title}
                      </p>
                      {key === todayKey && (
                        <span className="text-premium-xs font-black uppercase tracking-widest text-primary bg-primary/10 px-spacing-xs py-spacing-3xs rounded-premium-full">
                          Hoje
                        </span>
                      )}
                    </div>
                    <p className="text-premium-xs text-muted-foreground mt-spacing-2xs uppercase tracking-widest font-black opacity-60">
                      {val.days}
                    </p>
                  </div>
        ...
        >
            ...
            <div className="space-y-spacing-sm">
              {[
                ...
                return (
                  <div
                    key={p.key}
                    className="p-spacing-md rounded-premium bg-muted/30 border border-border/50 space-y-spacing-sm hover:bg-muted/50 transition-colors group"
                  >
                    <div className="flex items-center gap-spacing-sm">
                      ...
                      <button
                        ...
                        aria-label={
                          fav
                            ? `Remover ${p.title} dos favoritos`
                            : `Adicionar ${p.title} aos favoritos`
                        }
                        aria-pressed={fav}
          ...
          <div className="bg-primary text-primary-foreground rounded-[2rem] p-spacing-xl space-y-spacing-md shadow-premium-hover shadow-primary/20">
            ...
            <Button
              onClick={() => navigate("/viacrucis")}
              className="w-full py-spacing-sm bg-white/10 hover:bg-white/20 border border-white/20 rounded-premium-full font-bold text-premium-xs uppercase tracking-widest transition-all"
            >
              Explorar Via-Sacra
            </Button>
          </div>
