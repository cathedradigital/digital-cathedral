  ...
  <Card data-test="listagem-2">
    ...
    <CardContent>
      {transactions.length === 0 ? (
        <p data-test="estado-vazio-2" className="text-center text-muted-foreground py-spacing-xl">
        ...
        <div className="space-y-spacing-sm">
          {transactions.map((t: any) => (
            <div
              key={t.id}
              className="flex items-center justify-between p-spacing-md rounded-premium bg-muted/30 border border-border/50"
            >
