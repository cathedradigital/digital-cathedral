      ...
      {controls.map((control) => (
        ...
        >
          <div className="flex flex-col gap-spacing-md">
            <control.icon
              className={`w-spacing-lg h-spacing-lg ${control.active ? "text-primary-foreground" : "text-primary/40"}`}
              strokeWidth={1.5}
            />
            <div className="space-y-spacing-2xs">
              ...
              <p
                className={`text-[10px] leading-relaxed ${control.active ? "text-primary-foreground/60" : "text-muted-foreground/60"}`}
              >
                {control.description}
              </p>
            </div>
