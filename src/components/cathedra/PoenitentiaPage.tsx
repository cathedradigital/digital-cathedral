      ...
      <div className="w-full space-y-spacing-2xl pb-spacing-2xl max-w-4xl mx-auto">
          ...
          {prayer && (
            <div className="flex flex-wrap justify-center items-center gap-spacing-sm pt-spacing-xs">
              <Button
                ...
                size="sm"
                onClick={() =>
                  favs.toggle({ contentType: "prayer", contentId: prayer.id, title: prayer.title })
                }
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-spacing-md px-spacing-xs">
          {CONFESSION_STEPS.map((step, i) => (
            ...
            >
              <div
                className={`text-premium-xs font-black opacity-40 uppercase tracking-widest mb-spacing-xs ${activeStep === i ? "text-white" : "text-primary"}`}
              >
                PASSO {i + 1}
              </div>
              <div className="font-serif font-bold text-premium-lg leading-tight group-hover:text-primary transition-colors group-data-[state=active]:text-white">
                {step.title}
              </div>
              {activeStep === i && (
        ...
        <CathedraCard
          padding="lg"
          className="animate-in fade-in slide-in-from-bottom-spacing-md duration-700 relative overflow-hidden"
        >
          ...
          <div className="relative space-y-spacing-xl w-full mx-auto">
            <div className="space-y-spacing-md text-center">
              <h2 className="text-premium-3xl md:text-premium-5xl font-serif font-bold text-foreground tracking-tight">
                {CONFESSION_STEPS[activeStep].title}
              </h2>
              <p className="text-premium-xl text-muted-foreground italic font-serif leading-relaxed">
                "{CONFESSION_STEPS[activeStep].description}"
              </p>
            </div>
                ...
                <div className="grid gap-spacing-sm">
                  {CONFESSION_STEPS[activeStep].items?.map((item, i) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-spacing-lg h-spacing-lg rounded-premium flex items-center justify-center font-black text-premium-xs shrink-0 border transition-colors ${
                            checked
                        ...
                        <span className="text-premium-lg text-foreground/90 font-serif leading-relaxed">
                          {item}
                        </span>
                      </button>
                    );
            ...
            {activeStep === 0 && (
              <div className="mt-spacing-2xl p-spacing-xl bg-primary/5 rounded-[2.5rem] border border-primary/10 text-center space-y-spacing-md shadow-premium-md">
                ...
                <p className="text-premium-lg text-foreground/80 font-serif italic w-full mx-auto leading-relaxed">
                  "O exame de consciência é a confrontação sincera da nossa vida com a lei moral de
                  Deus, o Evangelho e os Seus Mandamentos."
                </p>
              </div>
            )}
              ...
              <div className="space-y-spacing-xl pt-spacing-xl">
                ...
                <div className="bg-primary text-primary-foreground p-spacing-xl md:p-spacing-2xl rounded-[3rem] border border-primary/10 shadow-premium-hover shadow-primary/20 relative">
                  ...
                  <p className="text-premium-xl md:text-premium-2xl font-serif leading-relaxed text-center italic opacity-95">
                    ...
                    firmemente não tornar a pecar e evitar as próximas ocasiões de pecado. Amém."
                  </p>
                </div>
                <div className="flex items-center justify-center gap-spacing-xs text-premium-xs font-black uppercase tracking-widest text-primary/60">
                  <Icons.Activity className="w-spacing-sm h-spacing-sm" /> Reze antes ou depois de
                  confessar
                </div>
              </div>
            )}
            ...
            <div className="flex justify-center pt-spacing-xl">
              ...
              >
                {activeStep === CONFESSION_STEPS.length - 1 ? "Reiniciar Guia" : "Próximo Passo"}{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-spacing-xl">
          <CathedraCard padding="md" className="space-y-spacing-lg">
            ...
            <p className="text-muted-foreground font-serif leading-relaxed italic">
              Ao entrar no confessionário, diga: "Abençoai-me, Padre, porque pequei. Minha última
              confissão foi há (tempo)."
            </p>
          </CathedraCard>
          <CathedraCard padding="md" className="space-y-spacing-lg">
            <div className="flex items-center gap-spacing-md">
            ...
            <p className="text-muted-foreground font-serif leading-relaxed italic">
              No final, o sacerdote dirá: "Eu te absolvo de teus pecados em nome do Pai, e do Filho,
              e do Espírito Santo." Responda: "Amém."
            </p>
          </CathedraCard>
        </div>
