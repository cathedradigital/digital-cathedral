    ...
    <div className="max-w-5xl mx-auto space-y-spacing-2xl pb-spacing-3xl">
            ...
            <Card className="h-full border-border/50 hover:border-primary/30 transition-all duration-300 bg-card  shadow-premium-md hover:shadow-premium-hover rounded-premium overflow-hidden group">
              <CardHeader className="pb-spacing-md">
                <div className="flex items-center gap-spacing-md">
                  <div
                    className={`w-spacing-2xl h-spacing-2xl rounded-premium-full ${module.bg} flex items-center justify-center ${module.color} group-hover:scale-110 transition-transform`}
                  >
                    {module.icon}
                  </div>
                  <div>
                    <CardTitle className="text-premium-xl font-bold">{module.title}</CardTitle>
                    <CardDescription className="text-premium-sm font-medium">
                      {module.description}
                    </CardDescription>
                  </div>
                </div>
              ...
              <CardContent>
                <ul className="space-y-spacing-xs">
                  {module.details.map((detail, i) => (
                    <li
                      key={i}
                      className="flex items-start gap-spacing-sm text-premium-sm text-muted-foreground leading-relaxed"
                    >
                      <div
                        className={`w-spacing-2xs h-spacing-2xs rounded-premium-full mt-spacing-2xs shrink-0 ${module.color.replace("text-", "bg-")}`}
                      />
                      {detail}
                    </li>
                  ))}
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-[2.5rem] p-spacing-xl md:p-spacing-2xl text-center space-y-spacing-lg relative overflow-hidden group">
        ...
        <div className="relative z-10 space-y-spacing-md">
          <h2 className="text-premium-2xl md:text-premium-3xl font-bold text-primary">
            Ainda tem dúvidas?
          </h2>
          <p className="text-muted-foreground max-w-spacing-2xl mx-auto">
            Nossa plataforma é viva e está em constante evolução. Se você não encontrou o que
            procurava ou tem uma sugestão, converse com nossa equipe de suporte ou partilhe na
            comunidade.
          </p>
          <div className="flex flex-wrap justify-center gap-spacing-md pt-spacing-md">
            <Badge
              variant="outline"
              className="rounded-premium-full px-spacing-md py-spacing-2xs border-primary/20 text-primary hover:bg-primary/5 transition-colors cursor-pointer"
            >
              Suporte ao Peregrino
            </Badge>
            <Badge
              variant="outline"
              className="rounded-premium-full px-spacing-md py-spacing-2xs border-primary/20 text-primary hover:bg-primary/5 transition-colors cursor-pointer"
