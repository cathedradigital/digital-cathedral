  ...
  return (
    <>
      <SEOHead
        ...
        description="Caminhadas contemplativas para aprofundamento na vida espiritual."
        path="/itineraria"
      />
      <ContemplativeLayout subtitle="Itinerarium Mentis" title="Trilhas" icon={Icons.Compass}>
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-spacing-xl">
              {[1, 2].map((i) => (
                <div
                  key={i}
                  className="h-spacing-4xl rounded-[2.5rem] bg-muted/40 animate-pulse"
                  ...
                  >
                    ...
                    <CardContent className="p-spacing-xl md:p-spacing-2xl space-y-spacing-lg relative z-10">
                      <div className="flex items-center gap-spacing-sm">
                        <Badge
                          variant="outline"
                          className="text-[9px] font-black uppercase tracking-[0.2em] px-spacing-sm py-spacing-2xs bg-primary/5 border-primary/10 text-primary"
                        >
                          {item.category}
                        </Badge>
                      ...
                      <h2 className="text-premium-3xl md:text-premium-4xl font-bold font-serif text-foreground leading-tight">
                        {item.title}
                      </h2>
                      <p className="text-muted-foreground/80 font-serif italic text-premium-lg leading-relaxed line-clamp-spacing-sm">
                        {item.description}
                      </p>
                      ...
                      <div className="pt-spacing-xl flex items-center justify-between">
                        <div className="flex items-center gap-spacing-lg">
                          <div className="flex flex-col">
                            <span className="text-premium-xl font-bold text-primary">
                              {item.steps_count}
                            </span>
