    ...
    <ContemplativeLayout>
      ...
      <div className="w-full space-y-spacing-3xl px-spacing-md">
        ...
        >
          ...
          <div className="relative space-y-spacing-lg">
            <div className="flex items-center gap-spacing-sm text-primary">
              ...
              <h2 className="text-premium-xl font-bold uppercase tracking-wider">
                Compromisso 100% Sem IA
              </h2>
            </div>
            <p className="text-foreground/80 leading-relaxed font-serif text-premium-lg">
              A Cathedra Digital assume o compromisso público de{" "}
              <strong>não utilizar Inteligência Artificial</strong> para a geração de comentários
              bíblicos, interpretações teológicas ou reflexões espirituais.
            </p>
            <p className="text-foreground/80 leading-relaxed">
              Diferente de outras plataformas, aqui nenhum algoritmo decide o que é relevante para
              sua alma. Acreditamos que a transmissão da Fé exige a mediação humana, fundamentada na
              Tradição e no Magistério Vivo da Igreja.
            </p>
          </div>
        </motion.section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-spacing-xl">
          <div className="space-y-spacing-md">
            <div className="flex items-center gap-spacing-sm text-primary">
              ...
              <h3 className="font-bold uppercase tracking-widest text-premium-xs">
                Fontes Primárias
              </h3>
            </div>
            <p className="text-premium-sm text-muted-foreground leading-relaxed">
              Todos os textos bíblicos e parágrafos do Catecismo são extraídos de edições oficiais e
              fontes de domínio público reconhecidas. Não realizamos alterações nos textos sagrados.
            </p>
          </div>
          <div className="space-y-spacing-md">
            <div className="flex items-center gap-spacing-sm text-primary">
            ...
            <p className="text-premium-sm text-muted-foreground leading-relaxed">
              Nossa equipe de curadoria revisa manualmente as conexões entre temas, santos e orações
              para garantir que a experiência digital reflita a beleza da unidade da fé católica.
            </p>
          </div>
        </div>
        ...
        <section className="space-y-spacing-xl pt-spacing-xl border-t border-border">
          <div className="text-center space-y-spacing-xs">
            ...
            <p className="text-muted-foreground text-premium-sm">
              Se você encontrar qualquer imprecisão ou desejar sugerir uma melhoria na curadoria,
              utilize os canais abaixo para uma revisão humana imediata.
            </p>
          </div>
        ...
        <div className="p-spacing-xl rounded-[2rem] border border-border text-center space-y-spacing-md">
          ...
          <h3 className="font-bold uppercase tracking-widest text-premium-xs text-foreground">
          ...
          <p className="text-premium-xs text-muted-foreground leading-relaxed max-w-spacing-md mx-auto italic">
            O site foi projetado para funcionar de forma soberana. As chamadas para provedores
            externos foram reduzidas ao mínimo essencial (Supabase para dados), garantindo que a
            plataforma opere mesmo sem conexão estável e sem depender de serviços de terceiros que
            possam comprometer a integridade do conteúdo.
          </p>
