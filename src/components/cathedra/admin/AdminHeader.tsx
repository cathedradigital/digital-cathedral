  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-spacing-md px-spacing-md sm:px-spacing-0">
      <div className="flex flex-col gap-spacing-2xs">
        <h1 className="text-premium-xl sm:text-premium-3xl font-display font-black uppercase tracking-tight text-primary">
          Painel Administrativo
        </h1>
        <p className="text-premium-xs sm:text-premium-sm text-muted-foreground font-medium uppercase tracking-wider opacity-70">
          CRM & Gestão completa da plataforma.
        </p>
      </div>
      <div className="flex gap-spacing-xs">
        <Button
          ...
          size="sm"
          onClick={() => navigate("/")}
          className="rounded-premium-full gap-spacing-xs font-bold uppercase tracking-widest text-[10px]"
        >
