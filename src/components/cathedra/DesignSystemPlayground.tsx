    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <div className="w-full py-spacing-3xl md:py-spacing-4xl stack-spacing">
        ...
        <section className="text-center space-y-spacing-xl">
          ...
          <h1 className="text-premium-5xl md:text-premium-7xl lg:text-premium-8xl tracking-tighter">
            itinerarium
          </h1>
        ...
        <section className="space-y-spacing-3xl">
          <SectionHeader
            title="Tipografia"
            subtitle="Hierarquia e ritmos para leitura contemplativa."
            align="left"
          />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-spacing-3xl">
              ...
              <div className="space-y-spacing-2xl">
                ...
                <div className="space-y-spacing-md">
                  ...
                  <p>
                    A oração é a elevação da alma a Deus ou o pedido a Deus de bens convenientes. De
                    onde deve partir a oração? Da altura do nosso orgulho e da nossa vontade
                    própria.
                  </p>
                </div>
                <div className="space-y-spacing-md">
        ...
        <section className="space-y-spacing-3xl">
          <SectionHeader
            title="Componentes"
            subtitle="Elementos modulares com feedback tátil premium."
            align="left"
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-spacing-xl">
            <div className="space-y-spacing-md">
              ...
              <CathedraButton variant="primary" className="w-full">
                Iniciar
              </CathedraButton>
            </div>
            <div className="space-y-spacing-md">
              <span className="h5 opacity-40">Secondary Button</span>
              <CathedraButton variant="secondary" className="w-full">
                Apoiar
              </CathedraButton>
            </div>
            <div className="space-y-spacing-md">
              <span className="h5 opacity-40">Outline Button</span>
              <CathedraButton variant="outline" className="w-full">
                Detalhes
              </CathedraButton>
            </div>
            <div className="space-y-spacing-md">
              <span className="h5 opacity-40">Ghost Button</span>
              <CathedraButton variant="ghost" className="w-full">
                Voltar
              </CathedraButton>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-spacing-2xl pt-spacing-2xl">
            ...
            <div className="space-y-spacing-xl flex flex-col justify-end">
              ...
              <CathedraCard
                variant="interactive"
                className="p-spacing-2xl flex flex-col items-center justify-center gap-spacing-lg"
        ...
        <section className="space-y-spacing-3xl">
          <SectionHeader
            title="Ratio et Regula"
            subtitle="Princípios para manter o silêncio visual."
            align="left"
          />
          <div className="grid grid-cols-1 md:grid-cols-3 gap-spacing-xl">
            <CathedraCard padding="sm" className="space-y-spacing-md">
              ...
              <p className="text-premium-sm opacity-60">
                Evite elementos desnecessários. O espaço em branco é um elemento de design ativo que
                convida à reflexão.
              </p>
            </CathedraCard>
            <CathedraCard padding="sm" className="space-y-spacing-md">
              ...
              <p className="text-premium-sm opacity-60">
                Utilize as classes <code className="text-secondary">stack-spacing</code> e{" "}
                <code className="text-secondary">section-spacing</code> para garantir consistência.
              </p>
            </CathedraCard>
            <CathedraCard padding="sm" className="space-y-spacing-md">
              <h5 className="text-secondary">Feedback Tátil</h5>
              <p className="text-premium-sm opacity-60">
                Toda interação deve ter uma resposta sutil e orgânica, simulando a sensação de um
                objeto real.
              </p>
            </CathedraCard>
          </div>
      ...
      <CathedraOverlay isOpen={isOverlayOpen} onClose={() => setIsOverlayOpen(false)}>
        <div className="space-y-spacing-2xl">
          <SectionHeader
            title="Santuário Digital"
            subtitle="Um espaço de oração e estudo sem distrações."
          />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-spacing-2xl">
            <p className="reader-text !mx-spacing-0 !text-premium-lg">
              Esta é uma experiência de overlay premium, projetada para focar a atenção do usuário
              no que é essencial. Utiliza desfoque de fundo (blur) e tipografia generosa.
            </p>
