      ...
      <div className="prose prose-sm dark:prose-invert max-w-none space-y-spacing-xl text-muted-foreground">
        <section>
          ...
          <p>
            ...
            endereço de e-mail e diocese (opcional). Também coletamos dados de uso como progresso de
            leitura, favoritos e anotações pessoais para personalizar sua experiência.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Sua privacidade é sagrada para nós. Implementamos medidas de segurança técnicas e
            organizacionais para proteger seus dados pessoais contra acesso não autorizado,
            alteração, divulgação ou destruição. Seus dados são armazenados em servidores seguros
            com criptografia.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            Compartilhamos dados apenas com provedores de serviço essenciais para o funcionamento da
            plataforma (como processadores de pagamento para assinaturas PRO), sempre sob acordos de
        ...
        <section>
          ...
          <p>
            Publicações nos espaços comunitários são visíveis para outros usuários autenticados. Seu
            nome e avatar são exibidos junto às suas contribuições. Você pode editar ou excluir suas
            publicações a qualquer momento.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            (claro/escuro), diocese selecionada e progresso de onboarding. Não utilizamos cookies de
            rastreamento de terceiros. Dados de sessão são gerenciados de forma segura para manter
            sua autenticação.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            informações de menores de 13 anos sem consentimento parental. Se tomarmos conhecimento
            de que coletamos dados de um menor sem consentimento, tomaremos medidas para excluir
            essas informações.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            significativas por meio da plataforma. Recomendamos revisar esta política regularmente.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            através da seção de suporte ou pelo e-mail disponibilizado na página Sobre.
          </p>
        </section>
      </div>
