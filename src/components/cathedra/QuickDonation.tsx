        ...
        {isExpanded && (
          ...
          >
            <CardContent className="p-spacing-md pt-spacing-0 space-y-spacing-md">
              <div
                className="grid grid-cols-4 gap-spacing-xs"
                role="group"
              ...
              <div className="flex gap-spacing-xs items-center">
                <span className="text-premium-xs font-bold text-muted-foreground whitespace-nowrap">
                  Outro:
                </span>
                <div className="relative flex-1">
                  <span className="absolute left-spacing-sm top-spacing-2xs/2 -translate-y-1/2 text-premium-xs font-bold text-muted-foreground">
                    R$
                  </span>
                  <Input
                    type="number"
