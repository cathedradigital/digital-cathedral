  ...
  return (
    <div
      ...
      className={cn(
        ...
        showPadding &&
          "pt-spacing-xl md:pt-[calc(var(--layout-padding)*2)] pb-[calc(var(--layout-padding)*3)] px-spacing-md md:px-[var(--layout-padding)]",
        containerClassName,
      )}
    >
      {(title || subtitle || Icon) && (
        <header
          className={cn(
            ...
            !settings.reduceAnimations &&
              "animate-in fade-in slide-in-from-top-spacing-md duration-1000 ease-out",
          )}
        >
          {Icon && (
            <div className="mb-spacing-sm md:mb-spacing-lg">
              <Icon
                className="w-spacing-md h-spacing-md md:w-spacing-xl md:h-spacing-xl text-primary/20 mx-auto transition-all duration-1000 group-hover:text-primary/40 group-hover:scale-110"
                strokeWidth={1.2}
                size={20}
                aria-hidden="true"
              />
          ...
          {subtitle && (
            <p
              aria-hidden="true"
              className="text-[8px] md:text-[10px] font-semibold uppercase text-primary/70 mb-spacing-sm md:mb-spacing-lg tracking-premium-widest md:tracking-[1.2em] transition-all duration-1000"
            >
              {subtitle}
            </p>
          )}
          {title && <h1 className="mb-spacing-md">{title}</h1>}
          {headerActions && (
