        ...
        <>
          ...
          >
            ...
            <div className="px-spacing-xl pb-spacing-lg flex items-center justify-between">
              <div>
                <h2 className="text-premium-xl font-serif font-bold tracking-tight">
                  Preferências de Leitura
                </h2>
                <p className="text-premium-xs text-muted-foreground mt-spacing-3xs">
                  Ajuste sua experiência contemplativa
                </p>
              </div>
              <Button
                variant="ghost"
                  ...
                  <div className="space-y-spacing-xl">
                    ...
                    <div className="space-y-spacing-md px-spacing-xs">
                      ...
                      <div className="flex items-center gap-spacing-md bg-muted/5 rounded-premium p-spacing-md border border-muted/20">
                        ...
                        <Slider
                          value={[fontSizes.findIndex((f) => f.id === settings.fontSize)]}
                          max={3}
                          step={1}
                          onValueChange={([val]) =>
                            updateSettings({ fontSize: fontSizes[val].id as any })
                          }
                          className="flex-1"
                        />
                ...
                <section className="space-y-spacing-lg">
                  ...
                  <div className="bg-muted/5 rounded-premium p-spacing-xs border border-muted/20">
                    ...
                    >
                      <ToggleGroupItem
                        value="soft"
                        className="flex-1 py-spacing-md rounded-premium"
                      >
                        <div className="flex flex-col items-center gap-spacing-2xs">
                  ...
                  <div className="space-y-spacing-md">
                    ...
                    <div className="flex items-center justify-between p-spacing-md rounded-premium bg-muted/5 border border-muted/20">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] text-muted-foreground">
                          Reproduzir próximo capítulo automaticamente
                        </span>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between p-spacing-md rounded-premium bg-muted/5 border border-muted/20">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] text-muted-foreground">
                          Manter painel aberto por padrão
                        </span>
                      </div>
                      <Switch
                        checked={settings.showAudioTranscriptPanel}
                        onCheckedChange={(checked) =>
                          updateSettings({ showAudioTranscriptPanel: checked })
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-spacing-sm">
                    ...
                    >
                      <div className="flex flex-col items-start text-left">
                        ...
                        <span className="text-[10px] text-muted-foreground">
                          Oculta header e sidebar na leitura
                        </span>
                      </div>
                      <div
                        className={cn(
                    ...
                    >
                      <div className="flex flex-col items-start text-left">
                        ...
                        <span className="text-[10px] text-muted-foreground">
                          Interface minimalista e sem ruído
                        </span>
                      </div>
                      <div
                        className={cn(
                    ...
                    <Button
                      ...
                      onClick={() =>
                        updateSettings({ reduceAnimations: !settings.reduceAnimations })
                      }
                    >
                      <div className="flex flex-col items-start text-left">
                        <span className="font-bold text-premium-sm">Reduzir Movimento</span>
                        <span className="text-[10px] text-muted-foreground">
                          Transições suaves e menos flutuação
                        </span>
                      </div>
                      <div
                        className={cn(
