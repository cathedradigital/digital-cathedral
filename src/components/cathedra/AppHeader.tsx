      ...
      <>
        <header
          className={cn(
            ...
            isLanding && !user
              ? "bg-transparent border-none py-spacing-lg"
              : "bg-background/20 backdrop-blur-3xl h-[var(--header-height)]",
          )}
          role="banner"
        >
          <div
            className={cn(
              "flex items-center justify-between py-0 px-spacing-sm md:px-[var(--layout-padding)] max-w-spacing-4xl mx-auto",
              !isLanding || user ? "h-full" : "",
            )}
          >
            ...
            <div className="flex items-center justify-end gap-spacing-2xs md:gap-spacing-lg">
              <div className="flex items-center gap-spacing-2xs md:gap-spacing-md lg:gap-spacing-lg">
                ...
                <div className="flex items-center gap-spacing-2xs md:gap-spacing-md">
                  <Button
                    ...
                    onClick={(e) =>
                      isLegitimateClick(e) &&
                      (window as any).dispatchEvent(new CustomEvent("open-command-center"))
                    }
              ...
              {isDashboard && (
                <nav
                  className="hidden lg:flex items-center gap-spacing-xs border-l border-primary/10 pl-spacing-xl ml-spacing-md"
                  ...
                  {headerRoutes.map((item) => (
                    ...
                    >
                      ...
                      {pathname === item.path && (
                        <motion.div
                          layoutId="nav-active"
                          className="absolute -bottom-spacing-2xs left-spacing-2xs/2 -translate-x-1/2 w-spacing-2xs h-spacing-2xs rounded-premium-full bg-primary"
                        />
                      )}
                    </Button>
                  ))}
