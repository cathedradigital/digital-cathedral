...
const SUMA_DATA: SumaSection[] = [
  {
    ...
    questions: [
      {
        id: 1,
        title: "Q. 1 — Da Sagrada Doutrina",
        articles: [
          {
            id: 1,
            title: "Art. 1 — É necessária outra doutrina além das disciplinas filosóficas?",
    ...
    questions: [
      {
        ...
        articles: [
          {
            id: 1,
            title: "Art. 1 — O que é crer?",
            body: "Respondeo: Crer é um ato do intelecto que assente à verdade divina por império da vontade movida por Deus mediante a graça. E assim esse ato está sujeito ao livre-arbítrio e ordenado a Deus; por isso o ato de fé pode ser meritório.",
          },
          {
            id: 2,
            title: "Art. 2 — O objeto da fé",
            body: "Respondeo: O objeto da fé pode ser considerado de dois modos. Por parte da coisa crida, e assim o objeto da fé é algo incomposto, a saber, a própria realidade sobre a qual versa a fé. Por parte do crente, e assim o objeto da fé é algo composto, a modo de enunciado. De ambos os modos se verifica que o objeto da fé é a Verdade Primeira.",
          },
        ],
      },
      {
        id: 23,
        title: "Q. 23 — Da Caridade",
        articles: [
          {
            id: 1,
            title: "Art. 1 — A caridade é amizade?",
            body: "Respondeo: Nem todo amor tem razão de amizade, mas somente o amor que inclui benevolência, isto é, quando amamos alguém de tal modo que lhe queremos o bem. Se não queremos o bem daquilo que amamos, mas queremos o bem dele para nós, não é amizade, mas concupiscência. Ora, a benevolência não basta para a amizade, requer-se ainda a correspondência no amor, e essa mútua benevolência se funda em alguma comunicação. Havendo, pois, uma comunicação do homem com Deus, enquanto nos comunica sua bem-aventurança, é necessário que sobre essa comunicação se funde alguma amizade — e essa amizade é a caridade.",
          },
        ],
      },
    ],
    ...
    <div className="w-full space-y-spacing-xl pb-spacing-3xl">
      <div className="text-center space-y-spacing-lg">
        <div className="space-y-spacing-sm">
          ...
          <h1 className="text-premium-4xl md:text-premium-6xl font-serif font-bold text-foreground">
            S. Tomás de Aquino
          </h1>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-spacing-md">
              {AQUINO_CONCEPTS.map((concept, idx) => (
                <div
                  key={concept.id}
                  className="group bg-card border border-border rounded-premium p-spacing-lg hover:border-primary/50 transition-all hover:shadow-premium-hover hover:shadow-primary/5"
                >
                  <div className="flex items-start justify-between mb-spacing-md">
                    <span className="text-premium-4xl font-serif text-primary/60 group-hover:text-primary/60 transition-colors">
                      0{idx + 1}
                    </span>
                  ...
                  <h3 className="text-premium-xl font-serif font-bold text-foreground mb-spacing-md">
                    {concept.title}
                  </h3>
                  <div className="space-y-spacing-md">
                    <div className="p-spacing-md bg-muted/50 rounded-premium">
                      ...
                      <p className="text-premium-sm font-serif italic text-foreground/80">
                        {concept.aquino}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-premium-lg font-serif font-medium text-foreground">
                        {concept.padh}
                      </p>
                    </div>
                    <div className="pt-spacing-md border-t border-border">
                      <p className="text-premium-sm font-serif font-bold text-primary">
                        👉 {concept.pergunta}
                      </p>
                    </div>
                  </div>
            ...
            <div className="relative overflow-hidden bg-foreground text-background rounded-[2.5rem] p-spacing-xl md:p-spacing-2xl">
              ...
              <div className="relative z-10 space-y-spacing-lg">
                ...
                <div className="space-y-spacing-xs">
                  <h2 className="text-premium-3xl md:text-premium-5xl font-serif font-bold leading-tight">
                    Clareza Interior com Aquino
                  </h2>
                  <p className="text-premium-lg text-background/70 font-serif italic">
                    A trilha completa para quem busca clareza mental e direção de vida.
                  </p>
                </div>
            ...
            <div className="bg-card border border-border rounded-premium p-spacing-xl space-y-spacing-lg">
              <div className="flex items-center gap-spacing-xs">
                ...
                <h3 className="text-premium-xl font-serif font-bold text-foreground">
                  Pílulas de Sabedoria (Viral)
                </h3>
              </div>
              <p className="text-premium-sm text-muted-foreground font-serif italic">
                Use estes ganchos para impactar sua audiência e posicionar sua autoridade.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-spacing-md">
                <div className="p-spacing-md bg-muted/50 rounded-premium border border-border hover:border-primary/30 transition-all">
                  <p className="text-premium-xs font-black uppercase tracking-widest text-primary mb-spacing-xs">
                    Exemplo 1
                  </p>
                  <p className="text-premium-sm font-serif">
                    “Você acha que precisa ver para acreditar… Mas Aquino diria: você já acredita em
                ...
                <div className="p-spacing-md bg-muted/50 rounded-premium border border-border hover:border-primary/30 transition-all">
                  ...
                  <p className="text-premium-sm font-serif">
                    “Você não está perdido… Só está tentando preencher o infinito com coisas
                    finitas.”
                  </p>
                </div>
                <div className="p-spacing-md bg-muted/50 rounded-premium border border-border hover:border-primary/30 transition-all">
                  ...
                  <p className="text-premium-sm font-serif">
                    “O problema não é falta de resposta… é ignorar o que você já sabe.”
                  </p>
                </div>
            ...
            <div className="text-center space-y-spacing-md">
              <p className="text-muted-foreground font-serif italic">
                Dúvidas sobre o domínio intelectual?
              </p>
              <Button
          ...
          >
            {SUMA_DATA.map((section) => (
              ...
              >
                <Button
                  onClick={() =>
                    setExpandedPart(expandedPart === section.part ? null : section.part)
                  }
                ...
                >
                  <div>
                    ...
                    <h3 className="text-premium-lg font-serif font-bold text-foreground">
                      {section.title}
                    </h3>
                  </div>
                  <Icons.ArrowDown
                    className={`w-spacing-md h-spacing-md text-muted-foreground transition-transform ${expandedPart === section.part ? "rotate-180" : ""}`}
                  />
                </Button>
                  ...
                  <div className="border-t border-border">
                    {section.questions.map((q) => (
                      ...
                      >
                        ...
                        >
                          <span className="font-bold text-premium-sm text-foreground">
                            {q.title}
                          </span>
                          <Icons.ArrowDown
                            className={`w-spacing-md h-spacing-md text-muted-foreground transition-transform ${expandedQuestion === q.id ? "rotate-180" : ""}`}
                          />
                        </Button>
                            ...
                            {q.articles.map((art) => {
                              ...
                              return (
                                <div key={artKey}>
                                  <Button
                                    onClick={() =>
                                      setExpandedArticle(expandedArticle === artKey ? null : artKey)
                                    }
                                    className="w-full p-spacing-sm rounded-premium-full text-left hover:bg-primary/5 transition-all"
                                  >
                                    <span className="text-premium-sm font-serif text-foreground/90">
                                      {art.title}
                                    </span>
                                  </Button>
                                  {expandedArticle === artKey && (
                                    <div className="px-spacing-sm pb-spacing-md">
                                      <p className="text-premium-base md:text-premium-lg text-foreground/80 font-serif leading-relaxed whitespace-pre-line bg-muted rounded-premium-full p-spacing-md">
                                        {art.body}
                                      </p>
                                    </div>
                                  )}
      ...
      <div className="bg-muted rounded-premium p-spacing-xl text-center space-y-spacing-md">
        ...
        <p className="text-premium-sm text-muted-foreground font-serif italic max-w-spacing-sm mx-auto">
          A Suma Teológica contém 512 questões e 2.669 artigos. O conteúdo completo está sendo
