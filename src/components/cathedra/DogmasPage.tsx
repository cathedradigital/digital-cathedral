...
const DOGMAS: Dogma[] = [
  {
    ...
    definition:
      "A existência de Deus pode ser conhecida com certeza pela luz natural da razão humana, a partir das coisas criadas.",
    source: "Concílio Vaticano I, Dei Filius",
    year: 1870,
    category: "Deus",
    refs: [
    ...
    textoBase:
      "Desde a criação do mundo, as perfeições invisíveis de Deus, o seu poder eterno e a sua divindade, tornam-se visíveis à inteligência, por meio das suas obras.",
    explicacao:
      "A Igreja ensina que não precisamos de uma revelação sobrenatural para saber que Deus existe. Apenas observando a ordem do universo, a beleza da natureza e a complexidade da vida, nossa inteligência pode concluir, com certeza, que existe um Criador.",
    interpretacaoProfunda:
      'Este dogma protege a dignidade da razão humana contra o fideísmo (que diz que só a fé importa) e contra o ateísmo materialista. Ele afirma que o mundo é um "livro" escrito por Deus, onde cada criatura é uma palavra que aponta para o seu Autor.',
    aplicacaoPratica:
      "Tente hoje olhar para uma flor, para o céu ou para a complexidade do seu próprio corpo não apenas como matéria, mas como um sinal. Deixe que a beleza do mundo te leve a um pensamento de gratidão ao Criador.",
    reflexaoFinal:
      'Se eu pudesse ver a "assinatura" de Deus em cada coisa que encontro hoje, como isso mudaria meu humor?',
    exercicio:
      'Saia de casa ou olhe pela janela por 2 minutos. Escolha um elemento da natureza e tente encontrar nele um motivo para dizer: "Obrigado, Senhor, por teres criado isso".',
  },
  {
    id: 2,
    title: "Santíssima Trindade",
    definition:
      "Há em Deus três Pessoas divinas: Pai, Filho e Espírito Santo. Cada uma das três Pessoas possui a essência divina inteira.",
    source: "Concílio de Nicéia / Constantinopla",
    year: 325,
    category: "Deus",
    refs: [
  ...
  {
    id: 3,
    title: "Criação ex nihilo",
    definition: "Deus criou todas as coisas do nada (ex nihilo), livremente e por bondade.",
    source: "Concílio Lateranense IV",
    year: 1215,
    category: "Deus",
    refs: [
  ...
  },
  {
    ...
    definition:
      "Jesus Cristo é verdadeiro Deus e verdadeiro homem, com duas naturezas — divina e humana — unidas na única Pessoa do Verbo.",
    source: "Concílio de Calcedônia",
    year: 451,
  ...
  {
    id: 5,
    title: "Encarnação do Verbo",
    definition:
      "O Verbo se fez carne e habitou entre nós. O Filho de Deus assumiu a natureza humana no seio da Virgem Maria.",
    source: "Concílio de Éfeso / Nicéia",
    year: 431,
    category: "Cristologia",
    refs: [
  ...
  {
    id: 6,
    title: "Redenção pela Cruz",
    definition:
      "Cristo morreu na cruz para a redenção de todos os homens, oferecendo-se como sacrifício ao Pai para a remissão dos pecados.",
    source: "Concílio de Trento",
    year: 1545,
    category: "Cristologia",
    refs: [
  ...
  },
  {
    ...
    definition:
      "Ao terceiro dia, Cristo ressuscitou dentre os mortos com seu próprio corpo glorificado.",
    source: "Símbolo dos Apóstolos / Nicéia",
    year: 325,
    category: "Cristologia",
    refs: [
  ...
  },
  {
    ...
    definition:
      "Quarenta dias após a Ressurreição, Cristo subiu aos Céus em corpo e alma e está sentado à direita do Pai.",
    source: "Símbolo Niceno-Constantinopolitano",
    year: 381,
    category: "Cristologia",
    refs: [
  ...
  },
  {
    ...
    definition:
      "A Virgem Maria, no primeiro instante de sua conceição, foi preservada imune de toda mancha do pecado original.",
    source: "Pio IX, Ineffabilis Deus",
    year: 1854,
    category: "Mariologia",
    refs: [
  ...
  {
    id: 10,
    title: "Virgindade Perpétua de Maria",
    definition: "Maria foi virgem antes, durante e depois do parto de Jesus Cristo.",
    source: "Concílio de Latrão (649)",
    year: 649,
    category: "Mariologia",
    refs: [
  ...
  {
    id: 11,
    title: "Maternidade Divina",
    definition:
      "Maria é verdadeiramente Mãe de Deus (Theotókos), pois gerou segundo a carne o Verbo de Deus feito carne.",
    source: "Concílio de Éfeso",
    year: 431,
    category: "Mariologia",
    refs: [
  ...
  },
  {
    ...
    definition:
      "A Virgem Maria, terminado o curso da vida terrena, foi assunta em corpo e alma à glória celestial.",
    source: "Pio XII, Munificentissimus Deus",
    year: 1950,
    category: "Mariologia",
    refs: [
  ...
  },
  {
    ...
    definition:
      "Na Eucaristia, o pão e o vinho são convertidos no Corpo e Sangue de Cristo (transubstanciação). Cristo está verdadeira, real e substancialmente presente.",
    source: "Concílio de Trento",
    year: 1551,
  ...
  {
    id: 14,
    title: "Sete Sacramentos",
    definition:
      "Os sacramentos da Nova Lei foram todos instituídos por Jesus Cristo e são sete: Batismo, Confirmação, Eucaristia, Penitência, Unção dos Enfermos, Ordem e Matrimônio.",
    source: "Concílio de Trento",
    year: 1547,
    category: "Sacramentos",
    refs: [{ type: "catechism", label: "CIC §1210-1211", target: "1210" }],
  },
  {
    id: 15,
    title: "Necessidade do Batismo",
    definition:
      "O Batismo é necessário para a salvação, ao menos em desejo (in voto), pois é a porta de entrada na Igreja e confere a graça santificante.",
    source: "Concílio de Trento",
    year: 1547,
    category: "Sacramentos",
    refs: [
  ...
  },
  {
    ...
    definition:
      "Pelo pecado de Adão, todos os homens nascem em estado de pecado original, privados da graça santificante.",
    source: "Concílio de Trento",
    year: 1546,
  ...
  },
  {
    ...
    definition:
      "A alma humana é imortal e subsiste após a morte do corpo, aguardando a ressurreição final.",
    source: "Concílio Lateranense V",
    year: 1513,
    category: "Antropologia",
    refs: [
  ...
  },
  {
    ...
    definition:
      "O homem possui livre-arbítrio, pelo qual pode cooperar ou resistir à graça divina.",
    source: "Concílio de Trento",
    year: 1547,
    category: "Antropologia",
    refs: [
  ...
  },
  {
    ...
    definition:
      "O Romano Pontífice, quando fala ex cathedra em matéria de fé e moral, goza de infalibilidade, assistido pelo Espírito Santo.",
    source: "Concílio Vaticano I, Pastor Aeternus",
    year: 1870,
  ...
  },
  {
    ...
    definition:
      "Cristo constituiu São Pedro como chefe visível de toda a Igreja, conferindo-lhe o primado de jurisdição. Este primado é transmitido aos seus sucessores, os Bispos de Roma.",
    source: "Concílio Vaticano I",
    year: 1870,
    category: "Eclesiologia",
    refs: [
      { type: "bible", label: "Mt 16,18-19", target: "Mat 16" },
  ...
  },
  {
    ...
    definition:
      "A Igreja é o Corpo Místico de Cristo, do qual Ele é a Cabeça e os fiéis são os membros.",
    source: "Pio XII, Mystici Corporis",
    year: 1943,
    category: "Eclesiologia",
    refs: [
  ...
  },
  {
    ...
    definition:
      "Existe uma comunhão espiritual entre os fiéis na terra, as almas no purgatório e os bem-aventurados no céu.",
    source: "Símbolo dos Apóstolos",
    year: 390,
    category: "Eclesiologia",
    refs: [
  ...
  {
    id: 23,
    title: "Existência do Purgatório",
    definition:
      "Existe o purgatório, onde as almas dos justos que morreram com pecados veniais ou penas temporais são purificadas antes de entrar no céu.",
    source: "Concílio de Florença / Trento",
    year: 1439,
  ...
  {
    id: 24,
    title: "Ressurreição dos Mortos",
    definition:
      "No último dia, todos os mortos ressuscitarão com seus próprios corpos para o juízo final.",
    source: "Símbolo Niceno-Constantinopolitano",
    year: 381,
    category: "Escatologia",
    refs: [
  ...
  },
  {
    ...
    title: "Juízo Final",
    definition:
      "No fim dos tempos, Cristo virá em glória para julgar os vivos e os mortos, dando a cada um segundo as suas obras.",
    source: "Símbolo Niceno / Atanasiano",
    year: 325,
    category: "Escatologia",
    refs: [
  ...
  {
    id: 26,
    title: "Existência do Inferno",
    definition:
      "O inferno existe e as almas dos que morrem em pecado mortal são condenadas às penas eternas.",
    source: "Concílio de Florença / Trento",
    year: 1439,
    category: "Escatologia",
    refs: [
  ...
  {
    id: 27,
    title: "Existência do Céu",
    definition:
      "Os bem-aventurados gozam no céu da visão beatífica de Deus, face a face, numa felicidade eterna e perfeita.",
    source: "Bento XII, Benedictus Deus",
    year: 1336,
    category: "Escatologia",
    refs: [
  ...
  {
    id: 28,
    title: "Necessidade da Graça",
    definition:
      "Sem a graça de Deus, o homem não pode realizar nenhum ato salutar nem merecer a vida eterna. A graça é absolutamente necessária para o início da fé e da justificação.",
    source: "Concílio de Trento / II de Orange",
    year: 1547,
    category: "Graça",
    refs: [
  ...
  {
    id: 29,
    title: "Graça Santificante",
    definition:
      "A graça santificante é um dom habitual, uma disposição estável e sobrenatural que aperfeiçoa a alma para torná-la capaz de viver com Deus e agir por seu amor.",
    source: "Concílio de Trento",
    year: 1547,
    category: "Graça",
    refs: [
  ...
  {
    id: 30,
    title: "Gratuidade da Graça",
    definition:
      "A graça de Deus é inteiramente gratuita; não é devida por nenhum mérito natural do homem, mas concedida livremente por Deus.",
    source: "Concílio de Trento / II de Orange",
    year: 529,
    category: "Graça",
    refs: [
  ...
  {
    id: 31,
    title: "Justificação pela Graça",
    definition:
      "A justificação é a passagem do estado de pecado ao estado de graça e de filiação divina, operada pela graça de Deus através da fé e dos sacramentos.",
    source: "Concílio de Trento",
    year: 1547,
    category: "Graça",
    refs: [
  ...
  {
    id: 32,
    title: "Mérito das Boas Obras",
    definition:
      "O justo pode verdadeiramente merecer o aumento da graça e a vida eterna pelas suas boas obras, realizadas em estado de graça e sob a moção do Espírito Santo.",
    source: "Concílio de Trento",
    year: 1547,
    category: "Graça",
    refs: [
  ...
  {
    id: 33,
    title: "Existência dos Anjos",
    definition:
      "Os anjos são seres espirituais, pessoais, dotados de inteligência e vontade, criados por Deus como seus servidores e mensageiros.",
    source: "Concílio Lateranense IV / Vaticano I",
    year: 1215,
    category: "Anjos",
    refs: [
  ...
  },
  {
    ...
    definition:
      "Deus designa a cada fiel um anjo da guarda para protegê-lo, iluminá-lo e guiá-lo durante a vida terrena.",
    source: "Tradição constante da Igreja",
    year: 0,
    category: "Anjos",
    refs: [
  ...
  {
    id: 35,
    title: "Queda dos Anjos",
    definition:
      "Alguns anjos, criados bons por Deus, tornaram-se maus por sua própria escolha livre ao rebelarem-se contra Deus. São chamados demônios ou anjos caídos.",
    source: "Concílio Lateranense IV",
    year: 1215,
    category: "Anjos",
    refs: [
  ...
  {
    id: 36,
    title: "Inspiração Divina da Escritura",
    definition:
      "Os livros da Sagrada Escritura foram escritos sob a inspiração do Espírito Santo e têm Deus como autor principal, que se serviu de autores humanos como instrumentos.",
    source: "Concílio Vaticano I, Dei Filius / Vaticano II, Dei Verbum",
    year: 1870,
    category: "Escritura",
    refs: [
  ...
  {
    id: 37,
    title: "Inerrância da Escritura",
    definition:
      "A Sagrada Escritura ensina, sem erro, as verdades que Deus quis consignar para nossa salvação.",
    source: "Concílio Vaticano II, Dei Verbum 11",
    year: 1965,
    category: "Escritura",
    refs: [
  ...
  {
    id: 38,
    title: "Cânon das Escrituras",
    definition:
      "O cânon da Bíblia compreende 46 livros do Antigo Testamento e 27 do Novo Testamento, definidos solenemente pela Igreja.",
    source: "Concílio de Trento",
    year: 1546,
    category: "Escritura",
    refs: [
  ...
  },
  {
    ...
    definition:
      "A Sagrada Escritura e a Tradição Apostólica constituem juntas o depósito sagrado da Palavra de Deus, confiado à Igreja.",
    source: "Concílio Vaticano II, Dei Verbum 9-10",
    year: 1965,
    category: "Escritura",
    refs: [
...
const REF_STYLES: Record<string, { icon: React.ReactNode; color: string }> = {
  bible: {
    icon: <Icons.Book className="w-spacing-sm h-spacing-sm" />,
    color: "bg-primary/5 text-primary border-primary/20 hover:bg-primary/10",
  },
  catechism: {
    icon: <Icons.Heart className="w-spacing-sm h-spacing-sm" />,
    color:
      "bg-rose-50 text-rose-700 border-rose-200 hover:bg-rose-100 dark:bg-rose-950/40 dark:text-rose-300 dark:border-rose-800 dark:hover:bg-rose-900/50",
  },
  magisterium: {
    icon: <Icons.Globe className="w-spacing-sm h-spacing-sm" />,
    color:
      "bg-emerald-50 text-emerald-700 border-emerald-200 hover:bg-emerald-100 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-800 dark:hover:bg-emerald-900/50",
  },
};
        ...
        <div className="space-y-spacing-xl">
          <div className="text-center space-y-spacing-sm">
            ...
            <p className="text-muted-foreground font-serif italic max-w-spacing-xl mx-auto">
              Verdades divinamente reveladas, definidas solenemente pela Igreja como parte do
              depósito da fé.
            </p>
          </div>
          ...
          <div className="flex justify-center gap-spacing-lg text-center">
            <div>
              <p className="text-premium-2xl font-serif font-bold text-foreground">
                {filtered.length}
              </p>
          ...
          <div className="space-y-spacing-sm">
            {filtered.map((dogma) => (
              ...
              >
                ...
                >
                  <span className="text-premium-2xl font-serif font-bold text-primary/60 shrink-0 w-spacing-xl">
                    {dogma.id}
                  </span>
                  <div className="flex-1 min-w-spacing-0">
                    <div className="flex items-center gap-spacing-xs mb-spacing-2xs flex-wrap">
                      <span
                        className={`px-spacing-xs py-spacing-3xs rounded-premium-full text-premium-xs font-black uppercase tracking-widest ${CATEGORY_COLORS[dogma.category] || "bg-muted text-muted-foreground"}`}
                      >
                        {dogma.category}
                      </span>
                      ...
                      {dogma.refs.length > 0 && (
                        <Badge
                          variant="outline"
                          className="text-premium-xs gap-spacing-2xs px-spacing-2xs py-spacing-0"
                        >
                          <Icons.ExternalLink className="w-spacing-xs h-spacing-xs" />{" "}
                          {dogma.refs.length} fontes
                        </Badge>
                      )}
                    </div>
                    <h3 className="text-premium-base font-bold text-foreground">{dogma.title}</h3>
                    {expandedId !== dogma.id && (
                      <p className="text-premium-sm text-muted-foreground line-clamp-spacing-2xs mt-spacing-2xs">
                        {dogma.definition}
                      </p>
                    )}
                  </div>
                  <Icons.ArrowDown
                    className={`w-spacing-md h-spacing-md text-muted-foreground shrink-0 transition-transform ${expandedId === dogma.id ? "rotate-180" : ""}`}
                  />
                </Button>
                {expandedId === dogma.id && (
                  <div className="px-spacing-lg pb-spacing-lg pl-[4.5rem] space-y-spacing-md border-t border-border pt-spacing-md">
                    ...
                    <div className="flex items-center gap-spacing-xs">
                      ...
                      <span className="text-premium-sm text-muted-foreground">
                        {dogma.source} ({dogma.year})
                      </span>
                    </div>
                          ...
                          {dogma.refs.map((ref, i) => {
                            if (ref.type === "bible") {
                              ...
                              return (
                                <BibleVersePopover
                                  ...
                                  onNavigate={(a, c) =>
                                    navigate(
                                      `${AppRoute.BIBLE}?search=${encodeURIComponent(a + " " + c)}`,
                                    )
                                  }
                                />
                              );
                            ...
                            if (ref.type === "catechism") {
                              ...
                              return (
                                <CatechismPopover
                                  ...
                                  paragraph={paragraph}
                                  onNavigate={(p) =>
                                    navigate(`${AppRoute.CATECHISM}?paragraph=${p}`)
                                  }
                                />
                              );
                            }
                            ...
                            return (
                              <MagisteriumPopover
                                ...
                                onNavigate={(search) =>
                                  navigate(
                                    `${AppRoute.MAGISTERIUM}?search=${encodeURIComponent(search)}`,
                                  )
                                }
                              />
                            );
