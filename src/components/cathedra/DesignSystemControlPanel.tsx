...
export const ThemeControlPanel: React.FC = () => {
  ...
  const [auditIssues, setAuditIssues] = useState<
    { component: string; tokens: string[]; ratio: number; level: string }[]
  >([]);
        ...
        {isOpen && (
          ...
          >
            <div className="space-y-spacing-xs">
              <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-primary/40">
                Sistemática de Temas
              </h3>
              <p className="text-premium-xs text-muted-foreground leading-relaxed">
                Alterne entre estados visuais do Cathedra.
              </p>
            </div>
            ...
            <div className="space-y-spacing-md">
              ...
              >
                ...
                <div className="flex items-center gap-spacing-xs">
                  <span className="text-premium-xl font-display font-light text-primary">
                    {contrastStats.ratio}:1
                  </span>
      ...
      <motion.button
        ...
        className={cn(
          ...
          isOpen
            ...
            : "bg-card text-primary border-primary/10 hover:border-primary/20",
          !isOpen &&
            auditIssues.length > 0 &&
