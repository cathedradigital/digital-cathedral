...
const HomeMainContent: React.FC<HomeMainContentProps> = React.memo(
  ({ user, profile, onNavigate, t }) => {
      ...
      >
        ...
        <section className="w-full grid grid-cols-1 md:grid-cols-3 gap-spacing-md">
          ...
          >
            ...
            <h2 className="text-[9px] font-black uppercase tracking-[0.3em] text-primary/40 mb-1">
              Reze Agora
            </h2>
            <span className="text-premium-xs text-muted-foreground italic font-serif">
              Sanctificatio
            </span>
          </CathedraCard>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-spacing-sm">
            {[
              ...
              >
                ...
                <h3 className="text-[8px] font-black uppercase tracking-[0.2em] text-primary/30 group-hover:text-primary/60">
                  {item.label}
                </h3>
              </button>
            ))}
