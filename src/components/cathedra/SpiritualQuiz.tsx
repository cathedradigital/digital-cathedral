...
export const PROFILES: Record<ProfileId, ProfileResult> = {
  ferido_em_busca: {
    ...
    emoji: "💔",
    message:
      "Existe um cansaço silencioso dentro de você… mas também um desejo de paz. Deus vê essa dor e já começou a curar.",
    ...
    logosPrompt:
      "Estou ansioso e ferido. Preciso encontrar paz interior. Me ajude com uma reflexão acolhedora.",
  ...
  ansioso_buscador: {
    ...
    emoji: "🌊",
    message:
      "Você carrega peso demais sozinho. Mas quem busca, encontra — e você já está buscando. Permita-se descansar n'Aquele que carrega o mundo.",
    ...
    logosPrompt:
      "Sinto culpa e peso interior. Preciso entender o perdão de Deus. Me ajude a me libertar.",
  ...
  sedento_de_sentido: {
    ...
    emoji: "🔍",
    message:
      "Algo dentro de você sabe que a vida pede mais. Essa inquietação não é fraqueza — é vocação. O sentido que você procura tem nome.",
  ...
  firme_aprofundando: {
    ...
    emoji: "📖",
    message:
      "Você já caminha com firmeza, mas sente o chamado para ir mais fundo. A santidade não é destino — é caminho diário. Continue.",
    ...
    logosPrompt:
      "Quero aprofundar minha fé e vida de oração. Me guie na contemplação e no estudo teológico.",
  ...
  ardente_missionario: {
    ...
    emoji: "🔥",
    message:
      "O fogo que arde em você não é acaso — é o Espírito Santo. Você foi chamado para incendiar o mundo com a verdade do Evangelho.",
    ...
    logosPrompt:
      "Sou missionário e quero servir melhor. Me ajude a aprofundar a missão com raízes espirituais.",
...
const QUESTIONS: QuizQuestion[] = [
  {
    ...
    options: [
      {
        label: "Pesado, cansado por dentro",
        value: "pesado",
        icon: <Icons.Heart className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 4,
          ansioso_buscador: 2,
          sedento_de_sentido: 0,
          firme_aprofundando: 0,
          ardente_missionario: 0,
        },
      },
      {
        label: "Inquieto, procurando algo",
        value: "inquieto",
        icon: <Icons.Wind className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 1,
          ansioso_buscador: 1,
          sedento_de_sentido: 4,
          firme_aprofundando: 0,
          ardente_missionario: 0,
        },
      },
      {
        label: "Estável, mas querendo mais",
        value: "estavel",
        icon: <Icons.Anchor className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
          ansioso_buscador: 0,
          sedento_de_sentido: 1,
          firme_aprofundando: 4,
          ardente_missionario: 1,
        },
      },
      {
        label: "Aceso, pronto para agir",
        value: "aceso",
        icon: <Icons.Flame className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
          ansioso_buscador: 0,
          sedento_de_sentido: 0,
          firme_aprofundando: 1,
          ardente_missionario: 4,
        },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Ansiedade ou medo do futuro",
        value: "ansiedade",
        icon: <Icons.Wind className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 4,
      ...
      {
        label: "Vazio, falta de propósito",
        value: "vazio",
        icon: <Icons.Eye className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
          ansioso_buscador: 1,
          sedento_de_sentido: 4,
      ...
      {
        label: "Desejo de fazer mais por Deus",
        value: "chamado",
        icon: <Icons.Flame className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Conheço o básico, mas quero mais",
        value: "medio",
        icon: <Icons.Brain className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
          ansioso_buscador: 1,
          sedento_de_sentido: 3,
          firme_aprofundando: 1,
          ardente_missionario: 0,
        },
      },
      {
        label: "Tenho uma boa base doutrinária",
        value: "avancado",
      ...
      {
        label: "Estudo profundamente há anos",
        value: "mestre",
    ...
    options: [
      {
        ...
        weight: {
          ferido_em_busca: 3,
          ansioso_buscador: 1,
          sedento_de_sentido: 2,
          firme_aprofundando: 0,
          ardente_missionario: 0,
        },
      },
      {
        label: "Rezo nos momentos difíceis",
        value: "crise",
        icon: <Icons.Shield className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 1,
      ...
      {
        label: "Tenho tentado criar uma rotina",
        value: "rotina",
        icon: <Icons.Sparkles className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
          ansioso_buscador: 0,
          sedento_de_sentido: 2,
          firme_aprofundando: 3,
          ardente_missionario: 0,
        },
      },
      {
        label: "Rezo diariamente com profundidade",
        value: "profunda",
        icon: <Icons.Flame className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
    ...
    options: [
      ...
      },
      {
        ...
        weight: {
          ...
          sedento_de_sentido: 1,
          firme_aprofundando: 3,
          ardente_missionario: 2,
        },
      },
      {
        label: "Vivo em constante oração",
        value: "contemplativo",
        icon: <Icons.Flame className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
  ...
  },
  {
    ...
    options: [
      {
        label: "Fui batizado mas não pratico",
        value: "batizado",
      ...
      {
        label: "Vou à Missa quando posso",
        value: "eventual",
        icon: <Icons.Church className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
      ...
      {
        label: "Missa semanal e confissão regular",
        value: "regular",
        icon: <Icons.Sparkles className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
      ...
      {
        label: "Vida sacramental intensa e diária",
        value: "intensa",
        icon: <Icons.Flame className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
  ...
  },
  {
    ...
    options: [
      {
        label: "Cansaço ou esgotamento mental",
        value: "cansaco",
        icon: <Icons.Wind className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 4,
      ...
      {
        label: "Falta de tempo e correria",
        value: "tempo",
        icon: <Icons.Clock className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
      ...
      {
        label: "Falta de foco ou preguiça",
        value: "foco",
        icon: <Icons.Brain className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
      ...
      {
        label: "Sentir-se sozinho na caminhada",
        value: "solidao",
  ...
  },
  {
    ...
    options: [
      {
        label: "Não participo de nenhum grupo",
        value: "sozinho",
        icon: <Icons.Sun className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 3,
      ...
      {
        label: "Gostaria, mas não sei como",
        value: "desejo",
        icon: <Icons.Heart className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 1,
      ...
      {
        label: "Participo de um grupo ou pastoral",
        value: "ativo",
        icon: <Icons.Users className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
      ...
      {
        label: "Lidero ou sirvo ativamente",
        value: "lider",
        icon: <Icons.Flame className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
  ...
  },
  {
    ...
    options: [
      {
        label: "Paz, silêncio interior",
        value: "paz",
        icon: <Icons.Mountain className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 4,
          ansioso_buscador: 1,
          sedento_de_sentido: 1,
  ...
  },
  {
    ...
    options: [
      {
        label: "Parar, respirar e acolher a dor",
        value: "parar",
        icon: <Icons.Mountain className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 4,
      ...
      {
        label: "Entender melhor a fé católica",
        value: "entender",
        icon: <Icons.BookOpen className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
      ...
      {
        label: "Aprofundar na vida espiritual",
        value: "aprofundar",
        icon: <Icons.Sparkles className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
      ...
      {
        label: "Evangelizar e servir na missão",
        value: "missao",
        icon: <Icons.Flame className="w-spacing-md h-spacing-md" />,
        weight: {
          ferido_em_busca: 0,
  ...
  if (done && existing && PROFILES[existing]) {
    ...
    return (
      <motion.div
        ...
        className="rounded-premium border border-border bg-card p-spacing-md space-y-spacing-sm"
      >
        <div className="flex items-center justify-between">
          <span className="text-premium-xs font-black uppercase tracking-[0.3em] text-muted-foreground">
        ...
        <div className="flex items-center gap-spacing-sm">
          ...
          <div className="flex-1 min-w-spacing-0">
            ...
            <p className="text-premium-small text-muted-foreground mt-spacing-3xs">
              💔 {painLabel} · 🔥 {dirLabel}
            </p>
          </div>
        </div>
        <div className="flex gap-spacing-xs">
          <Button
            size="sm"
            className="flex-1 rounded-premium-full text-premium-xs bg-primary text-primary-foreground"
      ...
      >
        <div className="text-center space-y-spacing-sm">
          <motion.span
            ...
            className="text-premium-5xl block"
          >
            {p.emoji}
          </motion.span>
          <p className="text-premium-xs font-black uppercase tracking-[0.3em] text-secondary">
            ✨ Seu momento atual
          </p>
          <h2 className={`text-premium-2xl font-black ${p.color}`}>{p.title}</h2>
          <p className="text-premium-sm text-foreground/80 leading-relaxed max-w-spacing-sm mx-auto italic font-serif">
            "{p.message}"
          </p>
        </div>
        ...
        <div className="space-y-spacing-xs">
          <p className="text-premium-xs font-black uppercase tracking-[0.2em] text-muted-foreground text-center">
          ...
          <div className="space-y-spacing-xs text-premium-sm">
            <div className="flex items-center gap-spacing-xs px-spacing-sm py-spacing-xs rounded-premium bg-primary/[0.04] border border-primary/10">
              ...
              <span className="text-foreground/80">
                Jornada: <strong className="text-foreground">{p.journeyName}</strong>
              </span>
            </div>
            <div className="flex items-center gap-spacing-xs px-spacing-sm py-spacing-xs rounded-premium bg-primary/[0.04] border border-primary/10">
              <Icons.BookOpen className="w-spacing-md h-spacing-md text-primary shrink-0" />
              <span className="text-foreground/80">
                Tema: <strong className="text-foreground">{p.theme}</strong>
              </span>
            </div>
            <div className="flex items-center gap-spacing-xs px-spacing-sm py-spacing-xs rounded-premium bg-secondary/[0.06] border border-secondary/10">
              ...
              <span className="text-foreground/80">
                Reflexão com <strong className="text-foreground">Logos IA</strong>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-spacing-sm">
          <Button
            onClick={() => navigate(AppRoute.JORNADAS)}
            className="rounded-premium-full h-spacing-2xl gap-spacing-xs font-bold text-premium-xs uppercase tracking-widest bg-primary text-primary-foreground"
          >
          ...
          <Button
            variant="outline"
            onClick={() => navigate(AppRoute.STUDY_MODE)}
            className="rounded-premium-full h-spacing-xl gap-spacing-xs text-premium-xs font-bold border-secondary/30 text-secondary hover:bg-secondary/5"
          >
          ...
          <Button
            ...
            className="text-premium-xs text-muted-foreground"
          >
            Continuar navegando
          </Button>
        </div>
    ...
    return (
      ...
      >
        <div className="space-y-spacing-sm">
          ...
          <h2 className="text-premium-xl font-black text-foreground leading-tight">
    ...
    >
      <div className="space-y-spacing-2xs">
        <div className="flex items-center justify-between">
          ...
          <p className="text-premium-xs font-bold text-muted-foreground">
            Pergunta {step + 1} de {QUESTIONS.length}
          </p>
        </div>
        <div className="h-spacing-2xs bg-muted rounded-premium overflow-hidden">
          <motion.div
            className="h-full bg-secondary rounded-premium"
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <p className="text-premium-xs text-muted-foreground text-center italic leading-relaxed whitespace-pre-line font-serif">
            {q.intro}
          </p>
          <h3 className="text-premium-base font-bold text-foreground text-center leading-snug">
            {q.question}
          </h3>
          <div className="space-y-spacing-xs" role="radiogroup" aria-label={q.question}>
            {q.options.map((opt) => (
              ...
              >
                <span
                  className="text-secondary/60 group-hover:text-secondary transition-colors shrink-0"
                  aria-hidden="true"
                >
                  {opt.icon}
                </span>
                <span className="text-premium-sm font-medium text-foreground/80 group-hover:text-foreground transition-colors">
                  {opt.label}
                </span>
              </motion.button>
            ))}
      ...
      {step > 0 && (
        <Button
          ...
          className="flex items-center gap-spacing-2xs text-premium-xs text-muted-foreground hover:text-foreground transition-colors"
        >
