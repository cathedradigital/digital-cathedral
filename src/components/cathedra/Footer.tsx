...
const FooterSection = React.forwardRef<HTMLElement, FooterSectionProps>(
  ({ title, id, isMobile, openId, onToggle, children }, ref) => {
    ...
    return (
      <section
        ref={ref}
        aria-labelledby={`footer-h-${id}`}
        className="border-t"
        style={{ borderColor: GOLD_HAIR }}
      >
        <button
          type="button"
          onClick={() => onToggle(id)}
        ...
        >
          <span id={`footer-h-${id}`} style={EYEBROW_STYLE}>
            {title}
          </span>
          <Icons.ArrowDown
...
const Footer: React.FC = React.memo(() => {
  ...
  const [selectedDiocese, setSelectedDiocese] = useState(
    () => localStorage.getItem("cathedra_diocese") || "",
  );
  ...
  const vaticanLinks = [
    ...
    {
      title: lang === "pt" ? "Catecismo Oficial" : "Official Catechism",
      url: EXTERNAL_URLS.CATECHISM_OFFICIAL,
    },
    { title: "Vatican News", url: EXTERNAL_URLS.VATICAN_NEWS },
    {
      title: lang === "pt" ? "Dicastérios" : "Dicasteries",
      url: `${EXTERNAL_URLS.VATICAN}/content/romancuria/pt.html`,
    },
  ];
  ...
  const cnbbLinks = [
    ...
    {
      title: lang === "pt" ? "Liturgia Diária CNBB" : "CNBB Daily Liturgy",
      url: `${EXTERNAL_URLS.CNBB}/liturgia`,
    },
    {
      title: lang === "pt" ? "Documentos e Publicações" : "Documents & Publications",
      url: `${EXTERNAL_URLS.CNBB}/category/publicacoes`,
    },
  ];
    ...
    >
      <div className="mx-auto w-full max-w-[1280px] px-spacing-xl md:px-spacing-2xl lg:px-spacing-3xl pt-spacing-3xl md:pt-spacing-4xl pb-spacing-2xl">
          ...
          <div className="flex flex-col gap-spacing-lg">
            <div className="flex flex-col gap-2">
              <div className="flex items-baseline gap-2">
                <span aria-hidden="true" style={{ color: GOLD_TEXT, fontSize: 10 }}>
                  ●
                </span>
                <span
                  style={{
          ...
          >
            <div className="flex flex-col gap-spacing-xl">
              <div>
                ...
                >
                  <option value="">
                    {lang === "pt" ? "Selecione sua Diocese" : "Select your Diocese"}
                  </option>
                  {DIOCESES_BR.map((d) => (
              ...
              <div>
                ...
                <form onSubmit={handleSubscribe} className="flex items-stretch gap-2">
                  ...
                  <button
                    ...
                    aria-label={
                      lang === "pt" ? "Inscrever no boletim informativo" : "Subscribe to newsletter"
                    }
        ...
        <div
          ...
          style={{
            background: `linear-gradient(90deg, transparent, ${GOLD_HAIR} 20%, ${GOLD_HAIR} 80%, transparent)`,
          }}
          aria-hidden="true"
        />
        ...
        <div className="flex flex-col gap-spacing-lg md:flex-row md:items-center md:justify-between">
          <div className="flex flex-col gap-2">
            ...
            >
              © {new Date().getFullYear()} <span style={{ color: GOLD_TEXT }}>●</span> Cathedra{" "}
              <span style={{ color: GOLD_TEXT }}>·</span> Omnia ad maiorem Dei gloriam
            </p>
            <p
          ...
          <div className="flex flex-wrap items-center gap-x-1 gap-y-2">
            ...
            >
                  ...
                  <React.Fragment key={link.label}>
                    ...
                    {index < visible.length - 1 && (
                      <span
                        ...
                        style={{ color: GOLD_TEXT, opacity: 0.45 }}
                      >
                        ·
                      </span>
                    )}
              ...
              {isMobile &&
                PUBLIC_FOOTER_LINKS.length <
                  PUBLIC_FOOTER_LINKS.length +
                    EXTERNAL_FOOTER_LINKS.length +
                    CONDITIONAL_FOOTER_LINKS.filter((l) => !l.adminOnly || isAdmin).length && (
                  <button
                    type="button"
                    ...
                    aria-label={
                      mobileNavExpanded
                        ? lang === "pt"
                          ? "Ocultar links adicionais do rodapé"
                          : "Hide additional footer links"
                        : lang === "pt"
                          ? "Mostrar links adicionais do rodapé"
