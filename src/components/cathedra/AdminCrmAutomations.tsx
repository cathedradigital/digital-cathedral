  ...
  const handleSendManual = async () => {
    ...
    try {
      const { data: profiles, error } = await supabase
        .from("profiles")
        .select("id, is_premium, last_visit");
    ...
    <div className="space-y-spacing-lg">
              ...
              <div className="flex items-center justify-between gap-spacing-md">
                ...
                <div className="flex items-center gap-spacing-sm shrink-0">
                  <div className="text-right hidden sm:block">
                    ...
                    {auto.edgeFunction && (
                      <p className="text-premium-xs font-mono text-muted-foreground/70">
                        {auto.edgeFunction}
                      </p>
                    )}
                  </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Dispare uma notificação diretamente para um segmento de usuários.
          </CardDescription>
        </CardHeader>
