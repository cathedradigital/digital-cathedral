...
const A11ySettingsPanel: React.FC<A11ySettingsPanelProps> = ({ isOpen, onClose }) => {
          ...
          >
            <div className="flex items-center justify-between mb-spacing-xl">
              <div className="flex items-center gap-spacing-sm">
                ...
                <h2 id="a11y-title" className="text-premium-xl font-serif font-bold text-primary">
                  Acessibilidade
                </h2>
              </div>
              <Button
            ...
            <div className="space-y-spacing-xl overflow-y-auto pr-spacing-xs custom-scrollbar flex-1">
              <section className="space-y-spacing-lg">
                <h3 className="text-premium-xs font-bold uppercase tracking-[0.4em] text-primary/60 border-b border-border/10 pb-spacing-xs">
                  Aparência e Leitura
                </h3>
                ...
                <div className="space-y-spacing-md">
                  <div className="flex items-center justify-between group">
                    <div className="space-y-spacing-2xs">
                      <label
                        ...
                        className="text-premium-sm font-bold text-primary cursor-pointer"
                      >
                        Modo Escuro
                      </label>
                  ...
                  <div className="flex items-center justify-between group pt-spacing-md">
                    <div className="space-y-spacing-2xs">
                      ...
                      <p className="text-[11px] text-muted-foreground leading-relaxed max-w-[200px]">
                        Aumenta a distinção entre elementos para facilitar a leitura.
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between group pt-spacing-md">
                    <div className="space-y-spacing-2xs">
                      <label
                        htmlFor="reduce-animations-toggle"
                        className="text-premium-sm font-bold text-primary cursor-pointer"
                      >
                        Reduzir Animações
                      </label>
                      <p className="text-[11px] text-muted-foreground leading-relaxed max-w-[200px]">
                        Desativa movimentos excessivos para uma experiência mais estática e rápida.
                      </p>
                    </div>
                    <Switch
                ...
                <div className="flex items-center justify-between group pt-spacing-md">
                  <div className="space-y-spacing-2xs">
                    <label
                      htmlFor="visible-focus-toggle"
                      className="text-premium-sm font-bold text-primary cursor-pointer"
                    >
                      Foco Visível
                    </label>
                    <p className="text-[11px] text-muted-foreground leading-relaxed max-w-[200px]">
                      Adiciona uma borda de alto destaque em elementos selecionados.
                    </p>
                  </div>
                  <Switch
                ...
                <div className="space-y-spacing-md pt-spacing-lg">
                  <div className="flex items-center justify-between">
                    <label className="text-premium-sm font-bold text-primary">
                      Tamanho da Fonte
                    </label>
              ...
              <section className="space-y-spacing-lg pt-spacing-md">
                <div className="flex items-center justify-between mb-spacing-xs">
                  <h3 className="text-premium-xs font-bold uppercase tracking-[0.4em] text-primary/60">
                    Histórico Logos IA
                  </h3>
                  <span className="text-premium-xs font-bold text-primary">
                    {settings.logosHistoryLimit} itens
                  </span>
                </div>
              ...
              <section className="space-y-spacing-md pt-spacing-md">
                ...
                <div className="p-spacing-md rounded-premium bg-primary/5 border border-primary/10 space-y-spacing-sm">
                  ...
                  <p className="text-[11px] text-primary/60 leading-relaxed italic">
                    A plataforma utiliza semântica WCAG 2.1 para garantir que a navegação via
                    teclado e leitores de tela seja fluida e contínua.
                  </p>
                </div>
              </section>
              ...
              <section className="space-y-spacing-lg pt-spacing-xl border-t border-border/10">
                <div className="flex items-center justify-between">
                  ...
                  {auditResult && (
                    <span
                      className={`text-[10px] font-black uppercase tracking-widest ${auditResult.status === "premium" ? "text-green-500" : "text-amber-500"}`}
                    >
                    ...
                    <div className="p-spacing-md rounded-premium bg-amber-500/5 border border-amber-500/10 space-y-spacing-sm">
                      ...
                      <ul className="space-y-spacing-xs">
                        {auditResult.contrastIssues.slice(0, 5).map((issue, idx) => (
                          <li
                            key={idx}
                            className="text-[9px] text-amber-600/70 leading-relaxed italic border-b border-amber-500/5 pb-spacing-xs last:border-0"
                          >
                            <div className="flex justify-between items-start gap-spacing-xs">
                              <span>
                                Elemento: <span className="font-bold">{issue.element}</span>
                              </span>
                              <span className="font-black text-[8px] bg-amber-500/10 px-spacing-2xs rounded">
                                Ratio: {issue.ratio}
                              </span>
                            </div>
                            ...
                            <a
                              href={`/design-system?search=contrast`}
                              className="text-[7px] uppercase tracking-tighter underline text-amber-700/40 hover:text-amber-700 block mt-spacing-2xs"
                            >
                              Ver Token
                            </a>
                          </li>
                        ...
                        {auditResult.contrastIssues.length > 5 && (
                          <li className="text-[8px] text-amber-600/40 uppercase font-bold tracking-widest pt-spacing-xs text-center">
                            + {auditResult.contrastIssues.length - 5} problemas adicionais (veja
                            relatório completo)
                          </li>
                        )}
                      </ul>
                      <p className="text-[8px] text-primary/40 leading-relaxed pt-spacing-xs">
                        Consulte o{" "}
                        <a href="/design-system" className="underline hover:text-primary">
                          Design System
                        </a>{" "}
                        para tokens oficiais.
                      </p>
                    </div>
                  )}
                </div>
            ...
            <div className="pt-spacing-xl border-t border-border/10">
              <Button
                className="w-full rounded-premium-full h-spacing-2xl text-[10px] font-bold uppercase tracking-[0.3em] shadow-premium btn-premium-primary"
                onClick={onClose}
              >
                Concluído
              </Button>
