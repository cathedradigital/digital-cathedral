...
const LITANIES: Litany[] = [
  {
    ...
    invocations: [
      ...
      {
        call: "Coração de Jesus, formado pelo Espírito Santo no seio da Virgem Mãe",
        response: "tende piedade de nós.",
      },
      {
        call: "Coração de Jesus, unido substancialmente ao Verbo de Deus",
        response: "tende piedade de nós.",
      },
      ...
      {
        call: "Coração de Jesus, santuário da justiça e do amor",
        response: "tende piedade de nós.",
      },
      ...
      {
        call: "Coração de Jesus, Rei e centro de todos os corações",
        response: "tende piedade de nós.",
      },
      {
        call: "Coração de Jesus, em quem estão todos os tesouros da sabedoria e da ciência",
        response: "tende piedade de nós.",
      },
      {
        call: "Coração de Jesus, em quem habita toda a plenitude da divindade",
        response: "tende piedade de nós.",
      },
      {
        call: "Coração de Jesus, em quem o Pai pôs todas as suas complacências",
        response: "tende piedade de nós.",
      },
      {
        call: "Coração de Jesus, de cuja plenitude todos nós recebemos",
        response: "tende piedade de nós.",
      },
      { call: "Coração de Jesus, desejado das colinas eternas", response: "tende piedade de nós." },
      {
        call: "Coração de Jesus, paciente e cheio de misericórdia",
        response: "tende piedade de nós.",
      },
      {
        call: "Coração de Jesus, liberal para todos os que Vos invocam",
        response: "tende piedade de nós.",
      },
      { call: "Coração de Jesus, fonte de vida e de santidade", response: "tende piedade de nós." },
      {
        call: "Coração de Jesus, propiciação pelos nossos pecados",
        response: "tende piedade de nós.",
      },
      { call: "Coração de Jesus, saturado de opróbrios", response: "tende piedade de nós." },
      {
        call: "Coração de Jesus, esmagado por causa dos nossos pecados",
        response: "tende piedade de nós.",
      },
      ...
      {
        call: "Coração de Jesus, salvação dos que em Vós esperam",
        response: "tende piedade de nós.",
      },
      {
        call: "Coração de Jesus, esperança dos que em Vós morrem",
        response: "tende piedade de nós.",
      },
        ...
        ? [
            {
              ...
              label: "Abertura",
              hint: "Kyrie",
              onSelect: () => scrollTo(openingRef.current),
            },
          ]
        : []),
      {
        ...
        ? [
            {
              ...
              label: "Encerramento",
              hint: "Agnus Dei",
              onSelect: () => scrollTo(closingRef.current),
            },
          ]
        : []),
    ];
      ...
      <div className="w-full space-y-spacing-xl pb-spacing-2xl animate-in fade-in duration-700">
        <div className="flex flex-col md:flex-row md:items-center gap-spacing-lg">
          <Button
            ...
            className="p-spacing-sm rounded-premium-full bg-card border border-border hover:bg-primary/5 transition-all active:scale-95 shadow-premium-md self-start md:self-center"
          >
            <Icons.ArrowLeft className="w-spacing-lg h-spacing-lg text-foreground" />
          </Button>
          <div className="space-y-spacing-2xs">
            <span
              className={`inline-flex px-spacing-sm py-spacing-2xs rounded-premium-full text-premium-xs font-black uppercase tracking-widest border ${CATEGORY_COLORS[litany.category] || "bg-muted text-muted-foreground border-border"}`}
            >
              {litany.category}
            </span>
            <h1 className="text-premium-3xl md:text-premium-4xl font-serif font-bold text-foreground leading-tight">
              {litany.title}
            </h1>
            {litany.latin && (
              <p className="text-premium-base font-serif italic text-muted-foreground opacity-70">
                {litany.latin}
              </p>
            )}
          </div>
        ...
        <div className="premium-card p-spacing-xl md:p-spacing-3xl space-y-spacing-xl">
          ...
          {litany.opening && (
            <div
              ref={openingRef}
              id="litany-opening"
              className="text-center pb-spacing-xl border-b border-border/50 scroll-mt-24"
            >
              <p className="font-serif text-premium-lg text-foreground/80 leading-relaxed whitespace-pre-line italic">
                {litany.opening}
              </p>
            </div>
          )}
          ...
          <div
            ref={invocationsRef}
            id="litany-invocations"
            className="space-y-spacing-2xs w-full scroll-mt-24"
          >
            {litany.invocations.map((inv, i) => (
              <div
                key={i}
                className="flex flex-col md:flex-row md:items-baseline gap-spacing-2xs md:gap-spacing-md py-spacing-sm border-b border-border/30 last:border-0 group"
              >
                <p className="flex-1 font-serif text-premium-lg text-foreground/90 group-hover:text-primary transition-colors">
                  {inv.call},
                </p>
                <p className="font-serif italic text-primary font-bold text-premium-base shrink-0 opacity-80">
                  {inv.response}
                </p>
              </div>
            ))}
          ...
          {litany.closing && (
            <div
              ref={closingRef}
              id="litany-closing"
              className="text-center pt-spacing-xl border-t border-border/50 scroll-mt-24"
            >
              <p className="font-serif text-premium-lg text-foreground/80 leading-relaxed whitespace-pre-line italic">
                {litany.closing}
              </p>
