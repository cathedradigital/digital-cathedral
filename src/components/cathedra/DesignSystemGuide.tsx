...
const DesignSystemGuide: React.FC = () => {
  const tokens = {
    ...
    typography: [
      { name: "Display (Cinzel)", class: "font-display", desc: "Títulos majestosos e sagrados" },
      {
        ...
        class: "font-serif",
        desc: "Subtítulos e citações clássicas",
      },
      {
        name: "Reader (Merriweather)",
        class: "font-reader",
        desc: "Texto de leitura prolongada (Kindle-like)",
      },
  ...
  return (
    <div className="min-h-screen bg-background py-spacing-3xl md:py-spacing-4xl px-spacing-lg transition-colors duration-1000">
      <SEOHead
        title="Design System Documentation | Cathedra"
        description="Tokens, regras e componentes do ecossistema visual Cathedra Digital."
        path="/design-system"
      />
      ...
      <div className="w-full space-y-spacing-4xl">
        ...
        <header className="space-y-spacing-2xl text-center py-spacing-3xl">
          ...
          >
            ...
            <span className="text-[11px] font-bold uppercase tracking-[0.5em] text-primary/40">
              Sistemática Visual v4.0
            </span>
          </motion.div>
          <div className="space-y-spacing-lg">
            ...
            <p className="font-serif italic text-muted-foreground/60 text-premium-xl leading-relaxed">
              "A beleza é o esplendor da ordem." — Documentação oficial dos tokens e componentes
              premium.
            </p>
          </div>
        </header>
        ...
        <section className="space-y-spacing-3xl">
          <div className="flex items-center gap-spacing-xl">
            <h2 className="text-premium-sm font-bold uppercase tracking-[0.4em] text-primary/30 shrink-0">
              01. Chroma & Contrast
            </h2>
              ...
              >
                <div className="space-y-spacing-lg">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-mono text-muted-foreground uppercase tracking-widest mb-spacing-sm">
                      var({color.variable})
                    </p>
        ...
        <section className="space-y-spacing-3xl">
          ...
          <div className="space-y-spacing-2xl">
            {tokens.typography.map((font) => (
              <div
                key={font.name}
                className="group border-b border-primary/5 pb-spacing-2xl last:border-0"
              >
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-spacing-2xl items-baseline">
                  <div>
                    <h4 className="font-ui font-bold text-secondary mb-spacing-xs uppercase tracking-[0.2em] text-[10px]">
                      {font.name}
                    </h4>
                  ...
                  <div className="lg:col-span-2">
                    <p
                      className={`${font.class} text-premium-4xl md:text-premium-6xl text-primary leading-tight`}
                    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-spacing-2xl">
            <CathedraCard padding="lg" className="space-y-spacing-xl">
              ...
              <div className="space-y-spacing-lg">
                {tokens.spacing.map((s) => (
                  <div key={s.name} className="flex items-center gap-spacing-xl">
                    <div className="w-spacing-2xl text-[10px] font-bold text-primary/40">
                      {s.name}
                    </div>
              ...
              <p className="text-[10px] text-muted-foreground/60 leading-relaxed italic">
                O Cathedra utiliza um sistema de espaçamento baseado em 8px para garantir ritmo
                vertical e horizontal consistente.
              </p>
            </CathedraCard>

            <div className="space-y-spacing-xl">
              <CathedraCard padding="md" className="space-y-spacing-md">
                <h5 className="text-secondary uppercase tracking-widest text-[9px] font-bold">
                  Layout Margins
                </h5>
              ...
              <CathedraCard padding="md" className="space-y-spacing-md">
                ...
                <div className="space-y-spacing-md">
                  ...
                  <p className="text-[10px] text-center text-muted-foreground font-mono pt-spacing-xs">
                    .stack-spacing (space-y-spacing-3xl)
                  </p>
                </div>
              </CathedraCard>
            </div>
        ...
        <section className="space-y-spacing-3xl pb-spacing-3xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-spacing-3xl">
            ...
            <CathedraCard
              padding="xl"
              variant="interactive"
              className="flex flex-col items-center justify-center text-center space-y-spacing-xl bg-secondary/[0.02]"
            >
              ...
              <div className="space-y-spacing-sm">
                ...
                <p className="text-premium-sm text-muted-foreground leading-relaxed">
                  Passe o mouse sobre este card para sentir o feedback premium: elevação sutil,
                  sombreamento profundo e blur dinâmico.
                </p>
              </div>
            </CathedraCard>
          </div>
