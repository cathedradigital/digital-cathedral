...
export const DIOCESES_POR_ESTADO: Record<string, string[]> = {
  ...
  AM: [
    ...
    "Diocese de Coari",
    "Prelazia de Tefé",
    "Prelazia de São Gabriel da Cachoeira",
  ...
  RJ: [
    ...
    "Diocese de Volta Redonda-Barra Mansa",
