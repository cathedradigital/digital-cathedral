...
export const MAGISTERIUM_URLS: Record<string, string> = {
  ...
  "Ineffabilis Deus":
    "https://www.vatican.va/content/pius-ix/pt/documents/18541208-costituzione-apostolica-ineffabilis-deus.html",
  ...
  "Mystici Corporis":
    "https://www.vatican.va/content/pius-xii/pt/encyclicals/documents/hf_p-xii_enc_29061943_mystici-corporis-christi.html",
  "Benedictus Deus":
    "https://www.vatican.va/content/benedict-xii/la/documents/constitutio-dogmatica-benedictus-deus-29-ian-1336.html",
  "Credo Niceno":
  ...
  "misericordia-et-misera":
    "https://www.vatican.va/content/francesco/pt/apost_letters/documents/papa-francesco-lettera-ap_20161120_misericordia-et-misera.html",
  "rosarium-virginis-mariae":
    "https://www.vatican.va/content/john-paul-ii/pt/apost_letters/2002/documents/hf_jp-ii_apl_20021016_rosarium-virginis-mariae.html",
  "dies-domini":
    "https://www.vatican.va/content/john-paul-ii/pt/apost_letters/1998/documents/hf_jp-ii_apl_05071998_dies-domini.html",
  "mulieris-dignitatem":
    "https://www.vatican.va/content/john-paul-ii/pt/apost_letters/1988/documents/hf_jp-ii_apl_15081988_mulieris-dignitatem.html",
  "dominus-iesus":
    "https://www.vatican.va/roman_curia/congregations/cfaith/documents/rc_con_cfaith_doc_20000806_dominus-iesus_po.html",
  "compendio-doutrina-social":
    ...
    documents: [
      {
        ...
        abbr: "DF",
        type: "Constituição",
        category: "Concílios Ecumênicos",
        author: "Concílio Vaticano I",
        pontificate: "Pio IX",
        year: 1870,
        date: "1870-04-24",
        themes: ["Fé", "Revelação", "Razão"],
        url: MAGISTERIUM_URLS["dfil"],
        summary: "Constituição dogmática sobre a fé católica.",
      },
      {
        id: "paet",
        ...
        year: 1870,
        date: "1870-07-18",
        themes: ["Papado", "Infalibilidade", "Eclesiologia"],
        url: MAGISTERIUM_URLS["paet"],
        summary: "Constituição dogmática sobre a Igreja de Cristo e o primado romano.",
      },
      {
        id: "sc",
        ...
        pontificate: "Paulo VI",
        year: 1963,
        date: "1963-12-04",
        themes: ["Liturgia", "Sacramentos"],
        url: MAGISTERIUM_URLS["sc"],
        summary: "Constituição sobre a Sagrada Liturgia.",
      },
      {
        id: "lg",
        title: "Lumen Gentium",
        ...
        year: 1964,
        date: "1964-11-21",
        themes: ["Eclesiologia", "Povo de Deus"],
        url: MAGISTERIUM_URLS["lg"],
        summary: "Constituição dogmática sobre a Igreja.",
      },
      {
        id: "dv",
        title: "Dei Verbum",
        ...
        year: 1965,
        date: "1965-11-18",
        themes: ["Revelação", "Bíblia", "Tradição"],
        url: MAGISTERIUM_URLS["dv"],
        summary: "Constituição dogmática sobre a Revelação divina.",
      },
      {
        id: "gs",
        ...
        year: 1965,
        date: "1965-12-07",
        themes: ["Social", "Mundo", "Antropologia"],
        url: MAGISTERIUM_URLS["gs"],
        summary: "Constituição pastoral sobre a Igreja no mundo contemporâneo.",
      },
    ],
  },
  {
    ...
    documents: [
      {
        ...
        type: "Constituição",
        category: "Constituições Apostólicas",
        author: "Bento XII",
        pontificate: "Bento XII",
        year: 1336,
        date: "1336-01-29",
        themes: ["Escatologia", "Visão Beatífica"],
        url: MAGISTERIUM_URLS["bdeus"],
        summary: "Definição dogmática sobre a visão beatífica após a morte.",
      },
      {
        id: "ideus",
        ...
        year: 1854,
        date: "1854-12-08",
        themes: ["Maria", "Imaculada Conceição"],
        url: MAGISTERIUM_URLS["ideus"],
        summary: "Definição dogmática da Imaculada Conceição de Maria.",
      },
      {
        id: "mdeus",
        ...
        year: 1950,
        date: "1950-11-01",
        themes: ["Maria", "Assunção"],
        url: MAGISTERIUM_URLS["mdeus"],
        summary: "Definição dogmática da Assunção de Maria.",
      },
    ],
  },
  {
    ...
    documents: [
      {
        ...
        category: "Encíclicas",
        author: "Leão XIII",
        pontificate: "Leão XIII",
        year: 1891,
        date: "1891-05-15",
        themes: ["Social", "Trabalho"],
        url: MAGISTERIUM_URLS["rn"],
        summary: "Sobre a condição dos operários e a questão social.",
      },
      {
        id: "mcorp",
        ...
        year: 1943,
        date: "1943-06-29",
        themes: ["Eclesiologia", "Cristologia"],
        url: MAGISTERIUM_URLS["mcorp"],
        summary: "Sobre o Corpo Místico de Cristo.",
      },
      {
        id: "hv",
        title: "Humanae Vitae",
        ...
        year: 1968,
        date: "1968-07-25",
        themes: ["Vida", "Família", "Moral"],
        url: MAGISTERIUM_URLS["hv"],
        summary: "Sobre a regulação da natalidade e o amor conjugal.",
      },
      {
        id: "rh",
        ...
        pontificate: "João Paulo II",
        year: 1979,
        date: "1979-03-04",
        themes: ["Cristologia", "Antropologia"],
        url: MAGISTERIUM_URLS["rh"],
        summary: "O Redentor do homem, centro do cosmos e da história.",
      },
      {
        id: "vs",
        ...
        year: 1993,
        date: "1993-08-06",
        themes: ["Moral", "Verdade"],
        url: MAGISTERIUM_URLS["vs"],
        summary: "Sobre questões fundamentais do ensinamento moral da Igreja.",
      },
      {
        id: "ev",
        ...
        year: 1995,
        date: "1995-03-25",
        themes: ["Vida", "Bioética"],
        url: MAGISTERIUM_URLS["ev"],
        summary: "Sobre o valor e a inviolabilidade da vida humana.",
      },
      {
        id: "fr",
        ...
        year: 1998,
        date: "1998-09-14",
        themes: ["Fé", "Razão", "Filosofia"],
        url: MAGISTERIUM_URLS["fr"],
        summary: "Sobre as relações entre fé e razão.",
      },
      {
        id: "dce",
        ...
        category: "Encíclicas",
        author: "Bento XVI",
        pontificate: "Bento XVI",
        year: 2005,
        date: "2005-12-25",
        themes: ["Amor", "Caridade"],
        url: MAGISTERIUM_URLS["dce"],
        summary: "Sobre o amor cristão.",
      },
      {
        id: "ss",
        title: "Spe Salvi",
        ...
        year: 2007,
        date: "2007-11-30",
        themes: ["Esperança", "Escatologia"],
        url: MAGISTERIUM_URLS["ss"],
        summary: "Sobre a esperança cristã.",
      },
      {
        id: "civ",
        ...
        year: 2009,
        date: "2009-06-29",
        themes: ["Social", "Desenvolvimento"],
        url: MAGISTERIUM_URLS["civ"],
        summary: "Sobre o desenvolvimento humano integral na caridade e na verdade.",
      },
      {
        id: "lf",
        title: "Lumen Fidei",
        ...
        category: "Encíclicas",
        author: "Francisco",
        pontificate: "Francisco",
        year: 2013,
        date: "2013-06-29",
        themes: ["Fé"],
        url: MAGISTERIUM_URLS["lf"],
        summary: "Sobre a luz da fé.",
      },
      {
        id: "ls",
        title: "Laudato Si'",
        ...
        year: 2015,
        date: "2015-05-24",
        themes: ["Ecologia", "Criação"],
        url: MAGISTERIUM_URLS["ls"],
        summary: "Sobre o cuidado da casa comum.",
      },
      {
        id: "ft",
        ...
        year: 2020,
        date: "2020-10-03",
        themes: ["Fraternidade", "Social"],
        url: MAGISTERIUM_URLS["ft"],
        summary: "Sobre a fraternidade e a amizade social.",
      },
    ],
  },
  {
    ...
    documents: [
      {
        ...
        abbr: "AL",
        type: "Exortação Apostólica",
        category: "Exortações Apostólicas",
        author: "Francisco",
        pontificate: "Francisco",
        year: 2016,
        date: "2016-03-19",
        themes: ["Família", "Amor"],
        url: MAGISTERIUM_URLS["al"],
        summary: "Sobre o amor na família.",
      },
      {
        id: "ge",
        ...
        date: "2018-03-19",
        themes: ["Santidade"],
        url: MAGISTERIUM_URLS["ge"],
        summary: "Sobre o chamado à santidade no mundo atual.",
      },
      {
        id: "cv",
        ...
        year: 2019,
        date: "2019-03-25",
        themes: ["Jovens", "Vocação"],
        url: MAGISTERIUM_URLS["cv"],
        summary: "Exortação aos jovens e a todo o Povo de Deus.",
      },
    ],
  },
  {
    ...
    documents: [
      {
        ...
        date: "1984-02-11",
        themes: ["Sofrimento"],
        url: MAGISTERIUM_URLS["sd"],
        summary: "Sobre o sentido cristão do sofrimento humano.",
      },
      {
        id: "md",
        ...
        year: 1988,
        date: "1988-08-15",
        themes: ["Mulher", "Dignidade"],
        url: MAGISTERIUM_URLS["md"],
        summary: "Sobre a dignidade e a vocação da mulher.",
      },
      {
        id: "dd",
        title: "Dies Domini",
        ...
        year: 1998,
        date: "1998-07-05",
        themes: ["Domingo", "Eucaristia"],
        url: MAGISTERIUM_URLS["dd"],
        summary: "Sobre a santificação do domingo.",
      },
      {
        id: "rvm",
        ...
        year: 2002,
        date: "2002-10-16",
        themes: ["Maria", "Rosário"],
        url: MAGISTERIUM_URLS["rvm"],
        summary: "Sobre o Santo Rosário.",
      },
      {
        id: "mm",
        ...
        date: "2016-11-20",
        themes: ["Misericórdia"],
        url: MAGISTERIUM_URLS["mm"],
        summary: "No termo do Jubileu Extraordinário da Misericórdia.",
      },
      {
        id: "pc",
        title: "Patris Corde",
        ...
        year: 2020,
        date: "2020-12-08",
        themes: ["São José", "Paternidade"],
        url: MAGISTERIUM_URLS["pc"],
        summary:
          "Com coração de pai: no 150º aniversário da declaração de São José como Padroeiro da Igreja Universal.",
      },
    ],
  },
  {
    ...
    documents: [
      {
        id: "di",
        title: "Dominus Iesus",
        type: "Documento Doutrinal",
        category: "Documentos Doutrinais",
        author: "Congregação para a Doutrina da Fé",
        pontificate: "João Paulo II",
        year: 2000,
        date: "2000-08-06",
        themes: ["Ecumenismo", "Salvação", "Cristologia"],
        url: MAGISTERIUM_URLS["di"],
        summary: "Sobre a unicidade e a universalidade salvífica de Jesus Cristo e da Igreja.",
      },
    ],
  },
  {
    ...
    documents: [
      {
        ...
        abbr: "CIC",
        type: "Compêndio",
        category: "Compêndios e Códigos",
        author: "João Paulo II",
        pontificate: "João Paulo II",
        year: 1992,
        date: "1992-10-11",
        themes: ["Doutrina", "Fé"],
        url: MAGISTERIUM_URLS["cic"],
        summary: "Exposição sistemática da fé e da doutrina católica.",
      },
      {
        id: "cdsi",
        title: "Compêndio da Doutrina Social",
        abbr: "CDSI",
        type: "Compêndio",
        category: "Compêndios e Códigos",
        ...
        date: "2004-06-29",
        themes: ["Social", "Moral"],
        url: MAGISTERIUM_URLS["cdsi"],
        summary: "Apresentação orgânica do ensinamento social da Igreja.",
      },
      {
        id: "cdc",
        ...
        year: 1983,
        date: "1983-01-25",
        themes: ["Direito", "Disciplina"],
        url: MAGISTERIUM_URLS["cdc"],
        summary: "Corpo legislativo fundamental para a Igreja latina.",
      },
    ],
  },
];
...
export const MAGISTERIUM_DOCUMENTS: MagisteriumDocument[] = MAGISTERIUM_CATEGORIES.slice()
