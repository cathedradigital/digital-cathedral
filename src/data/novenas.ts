...
export const NOVENAS: Novena[] = [
    ...
    days: [
      {
        ...
        intention:
          "Peço o dom da Sabedoria — para saborear as coisas de Deus antes das coisas dos homens.",
      },
      {
        day: 2,
        ...
        intention:
          "Peço o dom do Entendimento — para penetrar as verdades reveladas com luz interior.",
      },
      {
        day: 3,
      ...
      },
      {
        ...
        intention:
          "Peço o dom da Ciência — para reconhecer a mão do Criador em todas as coisas criadas.",
      },
      {
        day: 6,
        ...
        intention:
          "Peço o dom da Piedade — para amar a Deus como Pai e servir aos irmãos como filhos seus.",
      },
      {
        day: 7,
        ...
        intention:
          "Peço o dom do Temor de Deus — para nunca me apartar de Vós por afeto ao pecado.",
      },
      {
        day: 8,
  ...
  },
  {
    ...
    days: Array.from({ length: 9 }, (_, i) => {
      const themes = [
        {
          title: "Mãe da confiança",
          text: "Confio em Vós como filho no colo materno — nada me falta se Vós me guardais.",
        },
        {
          title: "Mãe da misericórdia",
          text: "Vossa misericórdia é maior que a minha miséria. Alcançai-me o perdão que peço.",
        },
        {
          title: "Mãe do bom conselho",
          text: "Iluminai as decisões que preciso tomar; dai-me a prudência que me falta.",
        },
        {
          title: "Mãe consoladora dos aflitos",
          text: "Enxugai as lágrimas de todo coração ferido — em especial deste que hoje Vos suplica.",
        },
        {
          title: "Saúde dos enfermos",
          text: "Alcançai a cura àqueles que sofrem no corpo e na alma, se conforme à vontade de Deus.",
        },
        {
          title: "Refúgio dos pecadores",
          text: "Sob vosso manto se abrigam os fracos: acolhei-me na hora da tentação.",
        },
        {
          title: "Auxílio dos cristãos",
          text: "Fortalecei minha fé nas horas de dúvida e nas provações da vida presente.",
        },
        {
          title: "Rainha da família",
          text: "Guardai meus familiares, meus amigos e todos que estão sob minha responsabilidade.",
        },
        {
          title: "Mãe do perpétuo socorro",
          text: "Não me abandoneis nunca — em vida, na hora da morte, e no dia do juízo.",
        },
      ];
      return {
        day: i + 1,
        ...
        intention:
          "Apresento a Maria a intenção secreta desta novena, confiando no seu poderoso socorro.",
      };
    }),
  },
  {
    ...
    days: Array.from({ length: 9 }, (_, i) => {
      const themes = [
        {
          title: "José, homem justo",
          text: "A Escritura vos chama justo. Ensinai-me a viver com retidão simples, sem alarde.",
        },
        {
          title: "José, esposo de Maria",
          text: "Guardastes a Virgem com fidelidade e ternura. Sede modelo de todo esposo cristão.",
        },
        {
          title: "José, pai adotivo de Jesus",
          text: "A Palavra encarnada Vos chamou pai. Alcançai-me a graça da paternidade espiritual.",
        },
        {
          title: "José, chefe da Sagrada Família",
          text: "Vossa casa foi santuário do silêncio e do trabalho. Santificai as casas de todos os que Vos invocam.",
        },
        {
          title: "José, mestre dos operários",
          text: "Ensinastes Jesus a serrar e a plainar. Dignificai o trabalho humano que hoje ofereço.",
        },
        {
          title: "José, protetor da Igreja",
          text: "Guardai a Igreja peregrina, como guardastes o Menino nas fugas do Egito.",
        },
        {
          title: "José, terror dos demônios",
          text: "Vossa presença põe em fuga o inimigo. Defendei-me nas tentações e nos combates.",
        },
        {
          title: "José, padroeiro dos moribundos",
          text: "Morrestes nos braços de Jesus e Maria. Alcançai-me a graça de uma boa morte.",
        },
        {
          title: "José, esperança dos enfermos",
          text: "Rogai pelos que sofrem no corpo e no espírito, e obtende-lhes consolação.",
        },
      ];
      return {
        day: i + 1,
  ...
  },
  {
    ...
    days: Array.from({ length: 9 }, (_, i) => {
      const themes = [
        {
          title: "Coração de Jesus, fonte de vida",
          text: "De vosso lado aberto brotou o sangue e a água — sacramentos da Igreja.",
        },
        {
          title: "Coração de Jesus, santuário da justiça",
          text: "Ali habita a plenitude da divindade: dai-me sede de retidão.",
        },
        {
          title: "Coração de Jesus, cheio de bondade",
          text: "Bondade que não se cansa de perdoar: acolhei este pecador que a Vós recorre.",
        },
        {
          title: "Coração de Jesus, abismo de virtudes",
          text: "Modelai meu coração conforme o Vosso — manso e humilde.",
        },
        {
          title: "Coração de Jesus, paciente e misericordioso",
          text: "Suportai minhas quedas e me reergueis sempre que caio.",
        },
        {
          title: "Coração de Jesus, propiciação pelos nossos pecados",
          text: "Vossa Paixão é o preço da minha salvação. Não seja em vão em mim.",
        },
        {
          title: "Coração de Jesus, nossa paz e reconciliação",
          text: "Reconciliai-me com Deus, comigo mesmo e com meus irmãos.",
        },
        {
          title: "Coração de Jesus, salvação dos que em Vós esperam",
          text: "Firmai minha esperança nas provações e na hora da morte.",
        },
        {
          title: "Coração de Jesus, delícia de todos os santos",
          text: "Concedei-me participar um dia da alegria eterna dos vossos amigos.",
        },
      ];
      return {
        day: i + 1,
