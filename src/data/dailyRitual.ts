...
export const DAILY_RITUALS: DailyRitual[] = [
  {
    ...
    catechism: {
      text: "A misericórdia de Deus é a sua onipotência manifestada na paciência e no perdão.",
      number: "210",
    },
    prayer:
      "Pai de Bondade, que eu saiba olhar para os meus irmãos com os vossos olhos de misericórdia. Amém.",
  },
  {
    ...
    catechism: {
      text: "Jesus Cristo é o Mediador e a plenitude de toda a Revelação.",
      number: "65",
    },
    prayer:
      "Senhor Jesus, guiai meus passos no caminho da verdade para que eu nunca me perca de Vós. Amém.",
  },
  {
    verse: {
      text: "Vinde a mim todos vós que estais cansados e eu vos aliviarei.",
      ref: "Mt 11,28",
    },
    reflection:
    ...
    prayer:
      "Doce Jesus, descanso da minha alma, em Vós deposito minhas fadigas e encontro renovação. Amém.",
  },
  {
    ...
    catechism: {
      text: "Pela fé, o homem submete completamente a sua inteligência e a sua vontade a Deus.",
      number: "143",
    },
    prayer:
      "Senhor, aumentai a minha fé para que nenhum medo terreno possa abalar minha confiança em Vós. Amém.",
  },
  {
    ...
    catechism: {
      text: "O amor de Deus é a fonte de onde brota o amor ao próximo.",
      number: "1822",
    },
    prayer:
      "Espírito Santo, inflamai meu coração com o fogo do Vosso amor para que eu ame como Jesus amou. Amém.",
  },
];
