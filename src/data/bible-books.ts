...
export const BIBLE_DATA: Record<string, BibleCategory[]> = {
      ...
      books: [
        {
          ...
          context:
            "Gênesis estabelece os fundamentos da fé: a criação por Deus, a entrada do pecado no mundo e o início do plano de redenção através de Abraão.",
        },
        {
          name: "Êxodo",
          abbr: "Ex",
          ...
          category: "Pentateuco",
          author: "Moisés (Tradição)",
          description: "A Libertação do Egito e a Aliança do Sinai.",
        },
        {
          name: "Levítico",
          abbr: "Lv",
          ...
          category: "Pentateuco",
          author: "Moisés (Tradição)",
          description: "As Leis do Culto e a Santidade do Povo.",
        },
        {
          name: "Números",
          abbr: "Nm",
          ...
          category: "Pentateuco",
          author: "Moisés (Tradição)",
          description: "A Caminhada no Deserto rumo à Terra Prometida.",
        },
        {
          name: "Deuteronômio",
          abbr: "Dt",
          ...
          category: "Pentateuco",
          author: "Moisés (Tradição)",
          description: "O Segundo Anúncio da Lei.",
        },
      ],
    },
    {
      ...
      books: [
        ...
        { name: "Neemias", abbr: "Ne", chapters: 13, category: "Histórico" },
        {
          ...
          context:
            "Tobias narra a história de uma família piedosa no exílio assírio. É um livro deuterocanônico que destaca a importância das boas obras e da confiança em Deus.",
        },
        {
          name: "Judite",
          abbr: "Jdt",
          ...
          context:
            "Judite é uma viúva piedosa que, com inteligência e fé, derrota o general Holofernes, salvando a cidade de Betúlia e todo o Israel.",
        },
        { name: "Ester", abbr: "Est", chapters: 16, category: "Histórico" },
        {
          ...
          context:
            "Relata a revolta dos Macabeus contra Antíoco IV Epífanes, que tentou suprimir a religião judaica e helenizar o povo.",
        },
        {
          name: "2 Macabeus",
          abbr: "2 Mc",
          ...
          context:
            "Não é uma continuação do primeiro livro, mas um relato paralelo focado no Templo de Jerusalém e na teologia do martírio.",
        },
      ],
    },
    {
      ...
      books: [
        { name: "Jó", abbr: "Jó", chapters: 42, category: "Sapiencial" },
        {
          ...
          context:
            "O saltério é o coração da oração da Igreja, reunindo todas as emoções humanas diante de Deus.",
          chapterTitles: {
            23: "O Bom Pastor",
        ...
        { name: "Cântico dos Cânticos", abbr: "Ct", chapters: 8, category: "Poético" },
        {
          ...
          context:
            "Escrito em grego para os judeus de Alexandria, apresenta a Sabedoria como um atributo divino que guia o justo e garante a vida eterna.",
        },
        {
          name: "Eclesiástico",
          abbr: "Eclo",
          ...
          context:
            "Também conhecido como Sirácida, é uma vasta coleção de preceitos morais e religiosos fundamentados na tradição de Israel.",
        },
      ],
    },
    {
      ...
      books: [
        ...
        { name: "Lamentações", abbr: "Lm", chapters: 5, category: "Profético" },
        {
          ...
          context:
            "Baruc consola os exilados em Babilônia, exortando-os a reconhecer seus pecados e a buscar a Deus, que é a fonte da Sabedoria.",
        },
    ...
    },
    {
      ...
      books: [
        ...
        { name: "Amós", abbr: "Am", chapters: 9, category: "Profético" },
        {
          ...
          context:
            "O menor livro do Antigo Testamento, foca na justiça divina contra os que oprimem o povo de Deus.",
          chapterTitles: {
  ...
  "Novo Testamento": [
      ...
      books: [
        {
          ...
          chapters: 28,
          category: "Evangelho",
          description: "O Evangelho do Reino e o Cumprimento das Promessas.",
        },
        {
          name: "Marcos",
          abbr: "Mc",
          chapters: 16,
          category: "Evangelho",
          description: "O Caminho do Filho de Deus e o Segredo Messiânico.",
        },
        {
          name: "Lucas",
          abbr: "Lc",
          chapters: 24,
          category: "Evangelho",
          description: "O Evangelho da Misericórdia e a Salvação Universal.",
        },
        {
          name: "João",
          abbr: "Jo",
          ...
          context:
            'O Evangelho de João é único entre os quatro Evangelhos. Foca na divindade de Cristo ("O Verbo") e utiliza uma linguagem altamente simbólica e teológica.',
          chapterTitles: {
            1: "O Verbo Encarnado",
            2: "As Bodas de Caná",
            3: "Jesus e Nicodemos",
    ...
    {
      name: "Histórico",
      books: [{ name: "Atos dos Apóstolos", abbr: "At", chapters: 28, category: "Histórico" }],
    },
    {
    ...
    {
      name: "Profético",
      books: [{ name: "Apocalipse", abbr: "Ap", chapters: 22, category: "Profético" }],
    },
  ],
};
