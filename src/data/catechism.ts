...
export const CATECHISM_LOCAL_DATA: Record<number, CatechismData> = {
  ...
  211: {
    ...
    conteudo:
      "Ao revelar o seu nome misterioso de YHWH, «Eu Sou Aquele que Sou», ou «Eu Sou Aquele que É», ou ainda «Eu Sou Quem Eu Sou», Deus diz quem Ele é e por que nome se deve chamá-Lo.",
  ...
  422: {
    ...
    titulo: "Jesus Cristo",
    conteudo:
      "«Mas, quando veio a plenitude dos tempos, Deus enviou o seu Filho, nascido de uma mulher, nascido sob a Lei, para resgatar os que estavam sob a Lei, a fim de recebermos a adoção de filhos» (Gl 4, 4-5).",
  ...
  683: {
    ...
    conteudo:
      "«Ninguém pode dizer: 'Jesus é o Senhor', a não ser sob a ação do Espírito Santo» (1 Cor 12, 3). «Deus enviou aos nossos corações o Espírito do seu Filho, que clama: Abba, Pai!» (Gl 4, 6).",
  ...
  2559: {
    ...
    titulo: "A oração",
    conteudo:
      "«A oração é a elevação da alma a Deus ou o pedido a Deus dos bens convenientes». Donde falamos nós, ao rezar? Da altura do nosso orgulho e vontade própria, ou das «profundezas» (Sl 130, 1) dum coração humilde e contrito? Aquele que se humilha será exaltado. A humildade é o fundamento da oração.",
    tags: ["oracao", "deus"],
  },
  2565: {
    id: "cat_2565",
