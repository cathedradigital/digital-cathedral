...
const InfrastructureDiagnostics = lazy(() =>
  import("./legacy-routes/index").then((m) => ({ default: m.InfrastructureDiagnostics })),
);
const PreviewFallback = lazy(() =>
  import("./components/cathedra/PreviewFallback").then((m) => ({ default: m.PreviewFallback })),
);
...
const NexusMetricsOverlay = lazy(() =>
  import("@/components/nexus/NexusMetricsOverlay").then((m) => ({
    default: m.NexusMetricsOverlay,
  })),
);
...
const BibleSkeleton = (props: any) => (
  <Suspense fallback={null}>
    <RouteSkeletons {...props} Component="BibleSkeleton" />
  </Suspense>
);
const CatechismSkeleton = (props: any) => (
  <Suspense fallback={null}>
    <RouteSkeletons {...props} Component="CatechismSkeleton" />
  </Suspense>
);
const LogosSkeleton = (props: any) => (
  <Suspense fallback={null}>
    <RouteSkeletons {...props} Component="LogosSkeleton" />
  </Suspense>
);
...
const PWAInstallPrompt = lazy(() =>
  import("./components/cathedra/PWAInstallPrompt").then((m) => ({ default: m.PWAInstallPrompt })),
);
const A11ySettingsPanel = lazy(() => import("./components/cathedra/A11ySettingsPanel"));
const ReadingPreferencesPanel = lazy(() =>
  import("./components/cathedra/ReadingPreferencesPanel").then((m) => ({
    default: m.ReadingPreferencesPanel,
  })),
);

const OfflineIndicator = lazy(() => import("./components/cathedra/OfflineIndicator"));
const PausedBanner = lazy(() =>
  import("./components/cathedra/PausedBanner").then((m) => ({ default: m.PausedBanner })),
);
const SplashScreen = lazy(() => import("./components/cathedra/SplashScreen"));
const GlobalLogosAI = lazy(() =>
  import("./components/cathedra/GlobalLogosAI").then((m) => ({ default: m.GlobalLogosAI })),
);
...
const SaintAutoPageRoute = lazy(
  () => import("./features/saints/editorialEngine/SaintAutoPageRoute"),
);
const BibliotecaEscritosPage = lazy(() => import("./pages/biblioteca/BibliotecaEscritosPage"));
const BibliotecaInteligentePage = lazy(
  () => import("./pages/biblioteca/BibliotecaInteligentePage"),
);
...
const BibliotecaCatolicaAcervoPage = lazy(
  () => import("./pages/biblioteca/BibliotecaCatolicaAcervoPage"),
);
...
const BibleCacheTimeseriesDashboard = lazy(
  () => import("./components/cathedra/BibleCacheTimeseriesDashboard"),
);
...
const InfrastructureDiagnosticsPage = lazy(
  () => import("./pages/admin/InfrastructureDiagnosticsPage"),
);
// ProductionReadyDashboard movido para o topo para evitar duplicidade

const PrayerAdmin = lazy(() => import("./pages/admin/PrayerAdmin"));
const LiturgyMeditationFallbackPanel = lazy(
  () => import("./pages/admin/LiturgyMeditationFallbackPanel"),
);
...
const NavigationErrorInspector = lazy(
  () => import("./components/cathedra/NavigationErrorInspector"),
);
...
const CollectionCertificatePage = lazy(
  () => import("./pages/collections/CollectionCertificatePage"),
);
...
const AtriumPageV2 = lazy(() =>
  import("./modules/atrium").then((m) => ({ default: m.AtriumPage })),
);

const SkeletonBar = React.forwardRef<
  HTMLDivElement,
  { w?: string; h?: string; className?: string }
>(({ w = "w-full", h = "h-spacing-md", className = "" }, ref) => (
  <div
    ref={ref}
    className={`${w} ${h} rounded-premium-full bg-muted/60 animate-pulse ${className}`}
  />
));
...
const AppLayout: React.FC = () => {
  ...
  const toggleDark = useCallback(() => {
    updateSettings({
      theme: settings.theme === "dark" || settings.theme === "night" ? "paper" : "dark",
    });
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("open-reading-preferences", handleOpenReadingPreferences);
  ...
  return (
    <MotionConfig reducedMotion={settings.reduceAnimations ? "always" : "never"}>
      ...
      <div className="min-h-screen bg-background text-foreground transition-colors duration-500">
        ...
        <Suspense fallback={null}>
          <AppErrorBoundary>
            {(!settings.immersiveMode || !location.pathname.startsWith("/bible")) &&
              !location.pathname.startsWith("/prototype-2.0") &&
              location.pathname !== "/" &&
                ...
                >
                  <Routes location={location} key={location.pathname}>
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <AtriumMagisteriumViewer />
                        </Suspense>
                      }
                    />
                    <Route
                      path="/magisterium-legacy/:id"
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <MagisteriumViewer />
                        </Suspense>
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <Auth onSuccess={() => navigate(resolveAuthHome(), { replace: true })} />
                        </Suspense>
                      }
                    />
                    <Route
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <AtriumBibliotecaPage />
                        </Suspense>
                      }
                    />
                    <Route
                      path="/biblioteca-legacy"
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <BibliotecaPage />
                        </Suspense>
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <ItinerariumDetailPage />
                        </Suspense>
                      }
                    />
                    <Route
                      path="/itineraria/:id/step"
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <AuthGuard>
                            <ItinerariumStepPage />
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <DevocionalMobileShell title="Liturgia">
                            <LiturgiaPage />
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <DevocionalMobileShell title="Dia Litúrgico" kicker="Cathedra · Liturgia">
                            <DiaLiturgicoPage />
                          </DevocionalMobileShell>
                        </Suspense>
                      }
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <DevocionalMobileShell title="Missal" kicker="Cathedra · Missal">
                            <MissalPage />
                          </DevocionalMobileShell>
                        </Suspense>
                      }
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <DevocionalMobileShell
                            title="Breviário"
                            kicker="Cathedra · Liturgia das Horas"
                          >
                            <BreviaryPage />
                          </DevocionalMobileShell>
                        </Suspense>
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <DevocionalMobileShell title="Rosário" kicker="Cathedra · Rosário">
                            <Rosary />
                          </DevocionalMobileShell>
                        </Suspense>
                      }
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <DevocionalMobileShell title="Via Crucis" kicker="Cathedra · Via Crucis">
                            <ViaCrucis />
                          </DevocionalMobileShell>
                        </Suspense>
                      }
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <DevocionalMobileShell title="Ladainhas" kicker="Cathedra · Ladainhas">
                            <LitaniesPage />
                          </DevocionalMobileShell>
                        </Suspense>
                      }
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <DevocionalMobileShell title="Novenas" kicker="Cathedra · Novenas">
                            <NovenasPage />
                          </DevocionalMobileShell>
                        </Suspense>
                      }
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <DevocionalMobileShell title="Novena" kicker="Cathedra · Novena">
                            <NovenaDetailPage />
                          </DevocionalMobileShell>
                        </Suspense>
                      }
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <DevocionalMobileShell title="Oração" kicker="Cathedra · Orações">
                            <PrayerDetailPage />
                          </DevocionalMobileShell>
                        </Suspense>
                      }
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <DevocionalMobileShell
                            title="Oração"
                            kicker="Cathedra · Orações (legado)"
                          >
                            <PrayerPage />
                          </DevocionalMobileShell>
                        </Suspense>
                    ...
                    <Route
                      path="/confession"
                      element={<Navigate to="/oracao/exame-de-consciencia" replace />}
                    />
                    <Route
                      path="/confissao"
                      element={<Navigate to="/oracao/exame-de-consciencia" replace />}
                    ...
                    />
                    <Route
                      path="/colecoes/:slug/certificado"
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <CollectionCertificatePage />
                        </Suspense>
                      }
                    />
                    ...
                    <Route
                      path="/biblioteca/acervo/:slug"
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <BibliotecaAcervoPage />
                        </Suspense>
                      }
                    />
                    {/* Sprint E1 — Biblioteca Patrística */}
                    <Route
                      path="/biblioteca/escritos"
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <BibliotecaEscritosPage />
                        </Suspense>
                      }
                    />
                    <Route
                      path="/biblioteca/escritos/busca"
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <BibliotecaInteligentePage />
                        </Suspense>
                      }
                    />
                    <Route
                      path="/biblioteca/inteligente"
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <BibliotecaInteligentePage />
                        </Suspense>
                    ...
                    />
                    <Route
                      path="/biblioteca/escritos/:autor/:obra"
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <SaintWorkOverviewPage />
                        </Suspense>
                      }
                    />
                    <Route
                      path="/biblioteca/escritos/:autor/:obra/capitulo/:ordem"
                      element={
                        <Suspense fallback={<LoadingFallback />}>
                          <SaintWorkReaderPage />
                        </Suspense>
                    ...
                    <Route
                      ...
                      element={<Navigate to="/acervo" replace />}
                    />
                    <Route
                      path="/biblioteca/catolica/acervo"
                      element={<Navigate to="/acervo/lista" replace />}
                    />
                          ...
                          <AdminGuard>
                            <Routes>
                              ...
                              <Route
                                ...
                                element={<ProductionReadyDashboard />}
                              />
                              <Route path="/security" element={<SecurityDashboard />} />
                              <Route
                                path="/cid-compliance"
                                element={<CidComplianceDashboardPage />}
                              />
                              ...
                              <Route
                                ...
                                element={<BibleAbbrValidatePage />}
                              />
                              <Route path="/bible-perf" element={<BiblePerfDashboard />} />
                              <Route
                                path="/admin/bible-cache-timeseries"
                                element={<BibleCacheTimeseriesDashboard />}
                              />
                              <Route
                                path="/bible-perf-breakdown"
                                element={<BiblePerfBreakdown />}
                              />
                              <Route
                                path="/admin/bible-perf-breakdown"
                                element={<BiblePerfBreakdown />}
                              />
                              <Route path="/bible-sources" element={<BibleSourcesAudit />} />
                              <Route path="/admin/bible-sources" element={<BibleSourcesAudit />} />
                              <Route
                                path="/admin/bible-diagnostic-runs"
                                element={<BibleDiagnosticRuns />}
                              />
                              <Route path="/admin/bible-import" element={<BibleImportAdmin />} />
                              <Route path="/bible-import" element={<BibleImportAdmin />} />
                              <Route
                                path="/admin/bible-import-missing"
                                element={<BibleImportMissing />}
                              />
                              <Route
                                path="/admin/bible-import-jobs"
                                element={<BibleImportJobs />}
                              />
                              <Route
                                path="/admin/bible-import-jobs/:id"
                                element={<BibleImportJobDetail />}
                              />
                              <Route
                                path="/admin/bible-gate-pendencies"
                                element={<BibleGatePendencies />}
                              />
                              ...
                              <Route
                                ...
                                element={<IntegrationsStatusPage />}
                              />
                              <Route
                                path="/admin/bible-translations-readiness"
                                element={<BibleTranslationsReadiness />}
                              />
                              <Route path="/admin/saints" element={<SaintsAdmin />} />
                              <Route
                                path="/admin/pg-stat-statements"
                              ...
                              <Route
                                path="/admin/editorial-integrity"
                                element={<EditorialIntegrityPage />}
                              />
                              <Route
                                path="/admin/editorial-audit"
                                element={<EditorialAuditPage />}
                              />
                              <Route
                                path="/admin/catechism-queue"
                                element={<CatechismImportQueuePage />}
                              />
                              ...
                              <Route
                                path="/admin/liturgia-meditation-fallback"
                                element={<LiturgyMeditationFallbackPanel />}
                              />
                              <Route path="/admin/collections" element={<CollectionsAdmin />} />
                              <Route
                                path="/admin/collections/metrics"
                                element={
                                  <Suspense fallback={<LoadingFallback />}>
                                    <CollectionsMetricsPage />
                                  </Suspense>
                                }
                              />
                              <Route path="/admin/collections/:id" element={<CollectionEditor />} />
                              <Route
                                path="/admin/biblioteca-patristica"
                                element={<BibliotecaPatristicaAdmin />}
                              />
                              <Route path="/admin/bible-phases" element={<BiblePhasesAdmin />} />
                              <Route
                                path="/admin/editorial-closure-validator"
                                element={<EditorialClosureValidator />}
                              />
                              <Route
                                path="/admin/editorial-closure-runs"
                                element={<EditorialClosureRuns />}
                              />
                              <Route
                                path="/admin/instagram-gallery"
                                element={
                                  <Suspense fallback={<LoadingFallback />}>
                              ...
                              <Route
                                ...
                                element={<InfrastructureDiagnosticsPage />}
                              />
                              <Route
                                path="/admin/security-docs"
                    ...
                    {!import.meta.env.PROD && (
                      <Route
                        path="/__test/theological-text"
                        element={
                          <Suspense fallback={<LoadingFallback />}>
                            <TheologicalTextFixture />
                          </Suspense>
                        }
                      />
                    )}
                    ...
                    />
                    <Route
                      path="/prototype-2.0/estudar/tema/:slug"
                      element={
                        <Suspense fallback={<PreviewSkeleton />}>
                          <PrototypeEstudoComposto />
                        </Suspense>
                      }
                    />
                    <Route
                      path="/prototype-2.0/leitor"
                      element={
                        <Suspense fallback={<PreviewSkeleton />}>
                          <PrototypeLeitor />
                        </Suspense>
                    ...
                    />
                    <Route
                      path="/prototype-2.0/minha-jornada"
                      element={
                        <Suspense fallback={<PreviewSkeleton />}>
                          <PrototypeMinhaJornada />
                        </Suspense>
                      }
                    />
                    {/* Preview isolado do Ambiente Átrio (Sprint 2.0.1). Rota / continua no 1.x até 2.0.6. */}
                    <Route
                      path="/prototype-2.0/atrium-v2"
                      element={
                        <Suspense fallback={<PreviewSkeleton />}>
                          <AtriumPageV2 />
                        </Suspense>
        ...
        <Suspense fallback={null}>
          <A11ySettingsPanel isOpen={showA11ySettings} onClose={handleCloseA11y} />
  ...
  return (
    <HelmetProvider>
      <Sentry.ErrorBoundary
        fallback={
          <Suspense fallback={null}>
            <AppErrorBoundary children={<LoadingFallback />} />
          </Suspense>
        }
      >
