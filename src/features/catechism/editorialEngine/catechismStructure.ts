...
const A = (article: string, theme: string, from: number, to: number): CatechismArticle => ({
  article,
  theme,
  range: [from, to],
});
        ...
        chapters: [
          {
            ...
            articles: [A("Prólogo", "O desígnio de Deus e a transmissão da fé", 1, 25)],
          },
        ],
      },
    ],
        ...
        chapters: [
          {
            ...
            articles: [A("Capítulo 1", "O desejo de Deus inscrito no coração humano", 26, 49)],
          },
          {
            ...
            articles: [
              ...
              A(
                "Artigo 2 — A transmissão da Revelação",
        ...
        chapters: [
          {
            ...
            articles: [
              ...
              A(
                ...
                "O Deus único que se revela como Pai",
                198,
                278,
              ),
          ...
          },
          {
            ...
            articles: [
              A(
                "Artigo 2 — Jesus Cristo, Filho único de Deus",
                "O Nome, o Cristo, o Filho, o Senhor",
                422,
                455,
              ),
              A(
                "Artigo 3 — Concebido pelo poder do Espírito Santo",
                "A Encarnação e os mistérios da vida de Cristo",
                456,
                570,
              ),
              A(
                "Artigo 4 — Padeceu sob Pôncio Pilatos",
                "Paixão, cruz e sepultura por nossa salvação",
                571,
                630,
              ),
              A(
                "Artigo 5 — Desceu à mansão dos mortos, ressuscitou",
          ...
          },
          {
            ...
            articles: [
              A(
                ...
                "O Espírito que vivifica e conduz a Igreja",
                683,
                747,
              ),
              A(
                "Artigo 9 — Creio na santa Igreja católica",
                "Mistério, comunhão e missão da Igreja",
                748,
                975,
              ),
              A(
                "Artigo 10 — Creio na remissão dos pecados",
                "O perdão confiado à Igreja",
                976,
                987,
              ),
              A(
                "Artigo 11 — Creio na ressurreição da carne",
                "O destino do corpo e a morte cristã",
                988,
                1019,
              ),
              A(
                "Artigo 12 — Creio na vida eterna",
                "Juízo, céu, purificação, inferno e Amém",
                1020,
                1065,
              ),
            ],
        ...
        chapters: [
          {
            ...
            articles: [
              A(
                ...
                "O Pai fonte, o Filho sacramento, o Espírito artífice",
                1066,
                1112,
              ),
              A(
                "Artigo 2 — O mistério pascal nos sacramentos",
          ...
          },
          {
            ...
            articles: [
              A(
                ...
                "Quem, como, quando e onde se celebra",
                1135,
                1199,
              ),
              A(
                "Artigo 2 — Diversidade litúrgica e unidade do mistério",
                "Ritos diversos, único mistério pascal",
                1200,
                1209,
              ),
            ],
        ...
        chapters: [
          ...
          },
          {
            ...
            articles: [
              A(
                ...
                "A conversão do batizado e o perdão",
                1420,
                1498,
              ),
          ...
          },
          {
            ...
            articles: [
              ...
              A(
                ...
                "A aliança conjugal elevada a sacramento",
                1601,
                1666,
              ),
            ],
          },
          {
            ...
            articles: [
              ...
              A(
                "Artigo 2 — As exéquias cristãs",
                "A Páscoa do cristão diante da morte",
                1680,
                1690,
              ),
            ],
        ...
        chapters: [
          {
            ...
            articles: [
              ...
              A(
                "Artigo 2 — A nossa vocação à bem-aventurança",
                "As bem-aventuranças e o desejo de felicidade",
                1716,
                1729,
              ),
              A(
                "Artigo 3 — A liberdade do homem",
                "Liberdade, responsabilidade e graça",
                1730,
                1748,
              ),
              A(
                "Artigo 4 — A moralidade dos atos humanos",
                "Objeto, intenção e circunstâncias",
                1749,
                1761,
              ),
          ...
          },
          {
            ...
            articles: [
              A(
                ...
                "Vocação comunitária e conversão social",
                1877,
                1896,
              ),
              A(
                "Artigo 2 — A participação na vida social",
                "Autoridade, bem comum e responsabilidade",
                1897,
                1927,
              ),
              A(
                "Artigo 3 — A justiça social",
                "Igualdade, solidariedade e respeito à pessoa",
                1928,
                1948,
              ),
            ],
          },
          {
            ...
            articles: [
              ...
              A(
                ...
                "Ser feito justo pela graça de Cristo",
                1987,
                2029,
              ),
              A(
                "Artigo 3 — A Igreja, mãe e educadora",
                "Preceitos da Igreja e vida moral",
                2030,
                2051,
              ),
            ],
        ...
        chapters: [
          {
            ...
            articles: [
              ...
              A(
                "Artigo 1 — Primeiro mandamento",
                "Adorar a Deus e a Ele somente servir",
                2083,
                2141,
              ),
          ...
          },
          {
            ...
            articles: [
              ...
              A(
                "Artigo 10 — Décimo mandamento",
                "Desprendimento e pobreza de espírito",
                2534,
                2557,
              ),
            ],
        ...
        chapters: [
          {
            ...
            articles: [
              ...
              A(
                "Artigo 2 — Na plenitude dos tempos",
                "Jesus ora, ensina a orar e escuta",
                2598,
                2622,
              ),
              A(
                "Artigo 3 — No tempo da Igreja",
                "Bênção, adoração, súplica, ação de graças",
                2623,
                2649,
              ),
            ],
          },
          {
            ...
            articles: [
              A(
                ...
                "Palavra, liturgia, virtudes e o hoje",
                2650,
                2662,
              ),
              A(
                "Artigo 2 — O caminho da oração",
                "Orar ao Pai, por Cristo, no Espírito",
                2663,
                2682,
              ),
              A(
                "Artigo 3 — Guias para a oração",
                "Santos, ministros e comunidade orante",
                2683,
                2696,
              ),
            ],
          },
          {
            ...
            articles: [
              A(
                ...
                "Vocal, meditação e oração contemplativa",
                2697,
                2724,
              ),
              A(
                "Artigo 2 — O combate da oração",
                "Distração, secura, perseverança e confiança",
                2725,
                2758,
              ),
            ],
        ...
        chapters: [
          {
            ...
            articles: [
              A(
                ...
                "O Pai Nosso no coração das Escrituras",
                2759,
                2776,
              ),
              A(
                "Artigo 2 — Pai nosso que estais nos céus",
                "Ousar aproximar-se e chamar Pai",
                2777,
                2802,
              ),
              A(
                "Artigo 3 — As sete petições",
                "Do Nome santificado à libertação do mal",
                2803,
                2854,
              ),
  ...
  for (const part of CIC_STRUCTURE) {
    ...
    for (const section of part.sections) {
      ...
      for (const chapter of section.chapters) {
        ...
        const article = chapter.articles.find((a) => inRange(p, a.range)) ?? chapter.articles[0];
        return {
          paragraph: p,
          part: part.part,
