...
export interface CatechismFurtherReading {
  ...
  kind:
    "bible_verse" | "saint" | "patristic" | "magisterium_doc" | "prayer" | "glossary" | "liturgy";
  ref: string;
  label: string;
  note?: string;
}
...
const EDITORIAL: Record<string, EditorialSeed> = {
  prologo: {
    ...
    furtherReading: [
      { kind: "bible_verse", ref: "jo/17/3", label: "Jo 17,3 — A vida eterna é conhecer-Te" },
      {
        ...
        note: "Inquieto está o nosso coração",
      },
    ],
  },
  ...
  revelacao: {
    introduction: "Deus não é conclusão de um raciocínio: é Alguém que sai ao encontro e fala.",
    historicalContext:
    ...
    application: "Abrir a Escritura como palavra dirigida hoje, e não como documento do passado.",
    reflection: "Escuto a Palavra ou apenas leio sobre ela?",
    prayer: "Falai, Senhor, que o vosso servo escuta.\nAbri-me os ouvidos do coração.\nAmém.",
    furtherReading: [
      { kind: "bible_verse", ref: "hb/1/1", label: "Hb 1,1-2 — Deus falou-nos pelo Filho" },
      {
        kind: "magisterium_doc",
        ref: "dei-verbum",
        label: "Dei Verbum",
        note: "Concílio Vaticano II",
      },
  ...
  "resposta-da-fe": {
    ...
    application: "Rezar o Credo devagar uma vez ao dia, como resposta e não como fórmula.",
    reflection: "Minha fé é minha e, ao mesmo tempo, é da Igreja?",
    prayer: "Creio, Senhor; vinde em auxílio da minha pouca fé.\nAmém.",
    furtherReading: [
      {
        kind: "bible_verse",
        ref: "mc/9/24",
        label: "Mc 9,24 — Vem em auxílio da minha falta de fé",
      },
  ...
  "creio-em-deus-pai": {
    ...
    furtherReading: [
      ...
      { kind: "bible_verse", ref: "ex/3/14", label: "Ex 3,14 — Eu sou Aquele que sou" },
      {
        kind: "patristic",
        ref: "atanasio",
        label: "Santo Atanásio",
        note: "A encarnação do Verbo",
      },
    ],
  },

  "creio-em-jesus-cristo": {
    introduction: "O coração do Credo: Deus não enviou uma mensagem, enviou o Filho.",
    historicalContext:
  ...
  "creio-no-espirito-santo": {
    ...
    application: "Invocar o Espírito antes de decidir, e não apenas depois de errar.",
  ...
  "economia-sacramental": {
    ...
    prayer: "Senhor, que o que celebro com os lábios\neu creia no coração e viva nas obras.\nAmém.",
    furtherReading: [
  ...
  "celebracao-sacramental": {
    introduction: "Quem celebra, como, quando e onde: a liturgia tem carne, gesto, tempo e lugar.",
    historicalContext:
    ...
    application: "Reconhecer no canto, no silêncio e no gesto uma linguagem que também ensina.",
  ...
  "iniciacao-crista": {
    ...
    application: "Recordar a data do próprio Batismo e agradecê-la como aniversário de vida.",
    reflection: "Vivo como quem foi mergulhado na morte e na ressurreição de Cristo?",
    prayer: "Senhor, que a graça recebida no Batismo\nnão fique adormecida em mim.\nAmém.",
    furtherReading: [
  ...
  "sacramentos-de-cura": {
    ...
    application: "Marcar a próxima confissão antes de sair desta leitura.",
  ...
  "sacramentos-comunhao": {
    introduction: "Ordem e Matrimônio consagram pessoas para a salvação dos outros.",
    historicalContext:
    ...
    application: "Rezar hoje, nominalmente, por um sacerdote e por um casal.",
  ...
  sacramentais: {
    ...
    application: "Abençoar a própria casa e a mesa, retomando um gesto simples e antigo.",
    reflection: "Que parte da minha vida cotidiana ainda não entreguei a Deus?",
    prayer: "Abençoai, Senhor, esta casa e os que nela vivem.\nAmém.",
    furtherReading: [{ kind: "liturgy", ref: "hoje", label: "Liturgia de hoje" }],
  },
  ...
  "comunidade-humana": {
    introduction: "Ninguém se salva sozinho — e ninguém peca sozinho.",
    historicalContext:
    ...
    application: "Identificar uma estrutura concreta da própria rotina que fere alguém, e mudá-la.",
    reflection: "Minha conversão pessoal alcança a vida em comum?",
    prayer: "Senhor, que eu não separe o amor a Vós\ndo cuidado com quem está ao meu lado.\nAmém.",
    furtherReading: [
  ...
  "lei-e-graca": {
    introduction: "A lei mostra o caminho; só a graça dá as forças para percorrê-lo.",
    historicalContext:
  ...
  "primeira-tabua": {
    ...
    prayer: "Senhor, sede o primeiro no meu tempo,\ne não apenas no que dele sobra.\nAmém.",
    furtherReading: [
  ...
  "segunda-tabua": {
    ...
    prayer: "Senhor, dai-me amar de modo concreto,\ncomo Vós me amais.\nAmém.",
    furtherReading: [
  ...
  "revelacao-da-oracao": {
    ...
    doctrinalContext: "Orar é responder — é sempre Deus quem chama primeiro.",
    application: "Rezar hoje um salmo inteiro, sem pressa, como quem aprende.",
    reflection: "Minha oração nasce de necessidade ou de aliança?",
    prayer: "Senhor, ensinai-nos a orar.\nAmém.",
    furtherReading: [
  ...
  "tradicao-da-oracao": {
    introduction: "Ninguém reza do zero: recebe-se um caminho, fontes e mestres.",
    historicalContext:
      "As grandes escolas de espiritualidade — monástica, carmelitana, inaciana — são variações de uma mesma tradição orante.",
    doctrinalContext: "Reza-se ao Pai, por Cristo, no Espírito Santo, na comunhão dos santos.",
    application: "Escolher um mestre de oração e permanecer com ele por um mês.",
    reflection: "Quem me ensina a rezar?",
    prayer: "Pai, por Cristo, no Espírito,\nrecebei a oração pobre que sei fazer.\nAmém.",
    furtherReading: [
  ...
  "vida-de-oracao": {
    ...
    application: "Fixar uma hora do dia e mantê-la, mesmo sem sentir nada.",
    reflection: "Abandono a oração quando ela deixa de consolar?",
    prayer: "Senhor, quando eu nada sentir,\ndai-me a fidelidade de permanecer.\nAmém.",
    furtherReading: [
  ...
  "pai-nosso": {
    introduction: "O Catecismo termina onde a fé respira: na oração que o próprio Senhor ensinou.",
    historicalContext:
    ...
    application: "Rezar o Pai Nosso uma vez ao dia petição por petição, detendo-se em cada uma.",
    reflection: "Ouso realmente chamar Deus de Pai?",
    prayer: "Pai nosso que estais nos céus,\nsantificado seja o vosso nome.\nAmém.",
    furtherReading: [
