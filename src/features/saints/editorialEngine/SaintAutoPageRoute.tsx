      ...
      <>
        ...
        >
          <div className="text-center space-y-spacing-lg py-spacing-2xl">
            <Icons.Cross
              className="w-spacing-2xl h-spacing-2xl text-secondary/60 mx-auto"
              aria-hidden
            />
            <p className="font-serif italic text-muted-foreground">
              Não localizamos este verbete no Sanctorum. Ele pode ter sido movido ou ainda não foi
              publicado.
            </p>
  ...
  return (
    <>
      <SEOHead
        ...
        description={
          saint.bio?.slice(0, 155) ||
          `${saint.name}: vida, virtudes e escritos no Sanctorum do Cathedra.`
        }
