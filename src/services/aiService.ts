...
export type AIFallbackReason =
  "credits_exhausted" | "rate_limited" | "daily_limit" | "auth" | "network";
...
export const callColloquium = async (
  ...
  return {
    error:
      "O uso de IA foi desativado nesta plataforma para garantir a integridade doutrinária e o funcionamento offline.",
    content:
      "O Logos IA não está mais disponível. Todo o conteúdo da Cathedra agora é gerado e revisado manualmente.",
  };
};
