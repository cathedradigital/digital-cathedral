    ...
    items: [
      {
        ...
        description: "Batimento cardíaco: ICE global, módulos plugados.",
        href: "/admin/mission-control",
      },
      {
        icon: ClipboardList,
        title: "Editorial Audit",
        description: "Auditoria de qualidade, gate e certificação.",
        href: "/admin/editorial-audit",
      },
      {
        icon: Network,
        title: "Nexus Audit",
        description: "Monitoramento do grafo teológico.",
        href: "/admin/nexus-audit",
      },
    ],
  },
  {
    ...
    items: [
      {
        icon: Library,
        title: "Glossário",
        description: "Verbetes, permissões e publicação.",
        href: "/admin/glossario",
      },
      {
        icon: Sparkles,
        title: "Coleções",
        description: "Curadoria e ordenação editorial.",
        href: "/admin/collections",
      },
      {
        icon: GraduationCap,
        title: "Santos",
        description: "Reimportação e curadoria hagiográfica.",
        href: "/admin/saints",
      },
      {
        icon: Compass,
        title: "Jornadas",
        description: "Programas de formação estruturada.",
        href: "/admin/jornadas",
      },
    ],
  },
    ...
    items: [
      {
        icon: Activity,
        title: "Site Health",
        description: "Saúde da plataforma, atividade e auditoria.",
        href: "/admin/site-health",
      },
      {
        icon: Users,
        title: "Usuários",
        description: "Papéis, permissões e vínculos.",
        href: "/admin/users",
      },
      {
        icon: ShieldCheck,
        title: "Segurança e SEO",
        description: "Diagnóstico, telemetria, alertas.",
        href: "/admin",
      },
    ],
  },
