...
export function AccountSidebar() {
  ...
  const userItems: Item[] = [
    {
      title: "Perfil",
      description: "Identidade, plano e estatísticas",
      url: "/conta/perfil",
      icon: UserCircle,
    },
    {
      title: "Minha Jornada",
      description: "Leituras, orações, coleções, jornadas",
      url: "/conta/jornada",
      icon: Compass,
      count:
        (c?.readingsMarks ?? 0) +
    ...
    {
      title: "Favoritos",
      description: "Bíblia, Catecismo, Glossário, Santos",
      url: "/conta/favoritos",
      icon: BookmarkCheck,
      count: c?.favorites ?? 0,
    },
    {
      title: "Diário",
      description: "Entradas espirituais e reflexões",
      url: "/conta/diario",
      icon: NotebookPen,
      count: c?.journalEntries ?? 0,
    },
    {
      title: "Configurações",
      description: "Aparência, áudio, notificações",
  ...
  const adminItems: Item[] = [
    {
      ...
      description: "Batimento cardíaco da plataforma",
      url: "/admin/mission-control",
      icon: Target,
    },
    {
      title: "Editorial Audit",
      description: "ICE, gate, freeze",
      url: "/admin/editorial-audit",
      icon: ClipboardList,
    },
    {
      title: "Nexus Audit",
      description: "Grafo teológico",
      url: "/admin/nexus-audit",
      icon: Network,
    },
    {
      title: "Glossário",
      description: "Verbetes e curadoria",
      url: "/admin/glossario",
      icon: Library,
    },
    {
    ...
    {
      title: "Santos",
      description: "Reimportação e curadoria",
      url: "/admin/saints",
      icon: GraduationCap,
    },
    {
    ...
    {
      title: "Sistema",
      description: "Segurança, SEO, telemetria",
      url: "/admin",
      icon: ShieldCheck,
    },
  ];
