    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <EditorialHero align="center" density="minimal" className="bg-primary/5">
        ...
        <EditorialHero.Subtitle>
          Explore o patrimônio da Igreja através do tempo e do espaço.
        </EditorialHero.Subtitle>
      </EditorialHero>
        ...
        <div className="aspect-video bg-card border border-primary/10 rounded-premium flex flex-col items-center justify-center space-y-4 shadow-premium-sm overflow-hidden relative">
          ...
          <div className="text-center space-y-2 z-10">
            ...
            <p className="text-muted-foreground text-sm max-w-md mx-auto">
              Em breve: Um mapa interativo conectando aparições, santos, concílios e basílicas ao
              Nexus teológico.
            </p>
            <Badge
              variant="outline"
              className="mt-4 border-gold/30 text-gold uppercase tracking-[0.2em] font-bold"
            >
              Fase 10.1
            </Badge>
          </div>
