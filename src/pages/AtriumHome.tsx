...
const HERO_SUBTITLE = "Leia, reze, estude e descubra a riqueza da fé católica.";
...
const AtriumHome: React.FC = () => {
  ...
  const saintOfDay = liturgy?.saintOfDay?.name ?? "Natividade de São João Batista";
                ...
                <article className="group relative flex h-96 flex-col justify-between overflow-hidden border border-gold-text/25 bg-accentest p-8 transition-all hover:bg-accent md:col-span-8">
                  ...
                  <div className="relative z-10 flex justify-end">
                    <Link
                      ...
                      style={{
                        boxShadow: "0 0 25px -5px hsl(var(--secondary) / 0.4)",
                      }}
                    >
                  ...
                  >
                    <div className="mb-4 flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <h4 className="text-xs text-muted-foreground">{item.kind}</h4>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-tighter text-muted-foreground/95">
                      <span>{pct}%</span>
                      <span className="transition-colors group-hover:text-primary">Retomar</span>
                    </div>
                  </Link>
                );
              })}
          ...
          <section className="mt-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="p-6 border border-border/20 bg-accent rounded-premium text-center">
                <span className="text-[10px] font-black uppercase tracking-widest text-gold-text block mb-2">
                  SANTO DO DIA
                </span>
