      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <CardHeader className="py-2">
            <CardTitle className="text-xs">Validado</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="py-2">
            <CardTitle className="text-xs text-green-600">Sucesso</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="py-2">
            <CardTitle className="text-xs text-red-600">Discrepâncias</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="py-2">
            <CardTitle className="text-xs text-amber-600">Ausentes</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              {reports.map((report) => (
                <TableRow key={report.id}>
                  ...
                  <TableCell className="text-xs font-mono">
                    {report.calculated_hash.substring(0, 16)}...
                  </TableCell>
                  <TableCell className="text-[10px] opacity-70">
