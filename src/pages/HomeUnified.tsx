...
const ENV_ICONS: Record<
  string,
  React.ComponentType<{ className?: string; style?: React.CSSProperties; "aria-hidden"?: boolean }>
> = {
  BookOpen,
  HandHeart,
  GraduationCap,
  ...
  return (
    <div className="cathedra-noir min-h-screen w-full selection:bg-gold/30 selection:text-noir-bg">
      <Helmet>
        ...
        <meta
          name="description"
          content="Sanctuarium Digital: o ecossistema espiritual vivo para sua caminhada cristã."
        />

        <meta property="og:title" content="Cathedra — Ecossistema Espiritual Vivo" />
        <meta
          property="og:description"
          content="Mais que um aplicativo, um mosteiro digital onde cada leitura conduz a uma nova descoberta espiritual."
        />
      ...
      <section className="relative flex min-h-[95vh] w-full flex-col items-center justify-center px-6 py-16 md:px-12">
        ...
        <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "conic-gradient(from 0deg at 50% 50%, transparent, var(--gold), transparent)",
              filter: "blur(100px)",
        ...
        <div className="relative z-10 flex w-full max-w-6xl flex-col items-center text-center">
          ...
          <motion.div
            ...
            animate="show"
            custom={3}
            className="mt-16 w-full max-w-3xl md:mt-24"
          >
            <div
            ...
            >
              <SearchIcon
                className="h-6 w-6 shrink-0 transition-transform group-focus-within:scale-110"
      ...
      <section
        className="relative w-full border-t px-6 py-20 md:px-12 md:py-32"
        style={{ borderColor: "var(--noir-line)" }}
      >
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 flex flex-col items-center text-center">
            <Eyebrow className="mb-4">Sua caminhada</Eyebrow>
            <h2 className="text-3xl md:text-5xl font-display text-noir-text">
              Sua Caminhada Espiritual
            </h2>
            <p className="mt-4 text-noir-text-muted font-serif italic">
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <h3 className="text-lg font-medium text-noir-text group-hover:text-gold-light transition-colors">
                          {step.label}
                        </h3>
                        <p className="mt-1 text-xs text-noir-text-muted leading-relaxed">
                          {step.description}
                        </p>
                      </div>
                    </div>
              ...
              <div className="rounded-premium bg-gold/5 border border-gold/10 p-8 flex gap-6 items-center">
                ...
                <div>
                  ...
                  <p className="text-sm italic font-serif leading-relaxed text-noir-text-muted">
                    "Este trecho aparece porque São João Paulo II cita diretamente Santo Agostinho
                    em sua encíclica sobre a fé. A ligação entre eles explica a profundidade do
                    parágrafo do Catecismo que você leu ontem."
                  </p>
                </div>
              </div>
            </div>
            ...
            <aside className="lg:col-span-4 space-y-8">
              {lastRead ? (
                <div className="border border-gold/10 rounded-premium bg-noir-surface p-6 shadow-premium">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[9px] font-bold text-noir-text-faint uppercase tracking-widest">
                        Vovê parou em:
                      </p>
                      <h3 className="text-base font-medium text-noir-text truncate">
                        {lastRead.label || "Última leitura"}
                      </h3>
                    </div>
                  </div>
                  <Link
                ...
                <div className="border border-primary/5 rounded-premium bg-card/40 p-6 text-center">
                  ...
                  <p className="text-xs text-noir-text-muted">
                    Inicie uma nova leitura para que possamos guardar seu progresso.
                  </p>
                </div>
              )}
              ...
              <div className="p-6 border border-primary/5 rounded-premium bg-card/40">
                ...
                <div className="text-center">
                  <p className="text-5xl font-display font-medium text-noir-text">
                    {profile?.streak || 0}
                  </p>
              ...
              <div className="p-6 border border-gold/10 rounded-premium bg-noir-surface">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-noir-text">
                    Destaque Monástico
                  </span>
                </div>
                ...
                <Link
                  to="/itineraria"
                  className="mt-4 block text-[10px] uppercase tracking-widest text-noir-text-faint hover:text-gold transition-colors"
                >
      ...
      <section
        className="relative w-full border-t px-0 py-24 md:py-32"
        style={{ borderColor: "var(--noir-line)" }}
      >
        ...
        <div
          ...
          style={{
            borderTop: "1px solid var(--noir-line)",
              ...
              <div className="mt-10 flex flex-wrap justify-center gap-3">
                {themes.slice(1, 6).map((t) => (
                  <Link
                    ...
                    onMouseLeave={(e) => {
                      e.currentTarget.style.borderColor = "var(--noir-line)";
                      e.currentTarget.style.color = "var(--noir-text-muted)";
                    }}
                  >
                    {t.label}
                  </Link>
      ...
      {resume.length > 0 && (
        <section
          className="w-full border-t px-6 py-24 md:px-12 md:py-32"
          style={{ borderColor: "var(--noir-line)" }}
        >
                      ...
                      <div>
                        ...
                        >
                          ...
                          {typeof item.progressPct === "number" && (
                            <span style={{ color: "var(--noir-text-faint)" }}>
                              {" "}
                              · {item.progressPct}%
                            </span>
                          )}
      ...
      {/* ══════ FOOTER ══════ */}
      <footer
        className="w-full border-t px-6 py-12 md:px-12"
        style={{ borderColor: "var(--noir-line)" }}
      >
        <div
          className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 text-[10px] uppercase tracking-[0.32em] md:flex-row"
          style={{ color: "var(--noir-text-faint)", fontFamily: "var(--font-body)" }}
        >
