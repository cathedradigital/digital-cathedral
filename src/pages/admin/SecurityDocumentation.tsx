...
const AUDIT_HISTORY = [
  ...
  },
  {
    id: 2,
    date: "19/08/2026",
    event: "Remediação de Write Policies",
    commit: "e5f6g7h",
    type: "FIXED",
    status: "Resolved",
  },
  {
    id: 3,
    date: "18/08/2026",
    event: "Scan de Leak de Segredos",
    commit: "i9j0k1l",
    type: "CERTIFIED",
    status: "Passed",
  },
  {
    id: 4,
    date: "17/08/2026",
    event: "Auditoria de Acessibilidade (Axe)",
    commit: "m2n3o4p",
    type: "WARNING",
      ...
      hero={
        <EditorialHero density="balanced">
          ...
          <EditorialHero.Subtitle>
            Auditoria de Políticas e Permissões Supabase
          </EditorialHero.Subtitle>
      ...
      <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <section className="space-y-4">
          ...
          <div className="p-6 bg-accentest border border-gold-text/10 rounded-premium font-reader text-base leading-relaxed text-primary/80">
            A plataforma utiliza um sistema de Role-Based Access Control (RBAC) centralizado na
            tabela <code className="bg-primary/5 px-1 rounded text-primary">public.user_roles</code>
            . A função de segurança{" "}
            <code className="bg-primary/5 px-1 rounded text-primary">public.has_role</code> é
            definida com <code className="font-bold">SECURITY DEFINER</code> para garantir que
            verificações de privilégios não causem recursão infinita em políticas RLS.
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 border border-gold-text/10 rounded-premium bg-white/50 space-y-3">
              ...
              <p className="text-sm text-muted-foreground font-reader leading-relaxed">
                Apenas o dono da conta pode editar seu perfil. Campos sensíveis (role, is_premium)
                são protegidos por gatilhos de banco de dados que impedem alteração manual via API
                cliente.
              </p>
            </div>
            <div className="p-6 border border-gold-text/10 rounded-premium bg-white/50 space-y-3">
              ...
              <p className="text-sm text-muted-foreground font-reader leading-relaxed">
                Implementado sistema de moderação automática. Edições em posts existentes por
                usuários não-admin forçam o retorno do status para{" "}
                <span className="font-mono text-xs bg-amber-100 text-amber-800 px-1 rounded">
                  'pending'
                </span>
                .
              </p>
        ...
        <section className="space-y-4">
          ...
          <div className="p-6 border border-dashed border-gold-text/30 rounded-premium bg-accentest/30 space-y-4">
            <p className="text-sm text-primary/70 font-reader">
              O fluxo de automação em{" "}
              <code className="text-xs bg-primary/5 px-1">
        ...
        <div className="mt-12 p-8 border-t border-gold-text/10 italic text-sm text-muted-foreground text-center font-reader">
          Relatório gerado automaticamente via Church Context Engine. Consulte o Mission Control
          para métricas de integridade em tempo real.
        </div>
      </div>
    </ReaderShell>
  );
