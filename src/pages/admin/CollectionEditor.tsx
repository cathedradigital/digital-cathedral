...
import { ArrowLeft, Loader2, Save, Send, Eye, EyeOff, Archive, ExternalLink } from "lucide-react";
    ...
    <div className="container mx-auto py-8 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6">
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="Ex.: Coleção fundamental"
                />
              </div>
              <div>
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-xs text-muted-foreground">
                Preencha e revise antes de publicar. Todos os campos aparecem na página pública da
                trilha.
              </p>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      setForm({
                        ...form,
                        difficulty_level: v === "none" ? "" : (v as typeof form.difficulty_level),
                      })
                    }
                  >
                    <SelectTrigger>
              ...
              <div className="flex items-center gap-2 pt-2 border-t border-border">
                ...
                <Label htmlFor="certificate_eligible" className="cursor-pointer">
                  Trilha certificável — libera{" "}
                  <code className="text-xs">/colecoes/{form.slug || ":slug"}/certificado</code>
                </Label>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Itens da coleção ({data.items.length})</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <CollectionItemsList
                items={data.items}
        ...
        <aside className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Nexus da coleção</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3 text-sm">
              ...
              <p className="pt-2 border-t border-border text-xs text-muted-foreground">
                Mesma linguagem de{" "}
                <Link to="/admin/nexus-audit" className="underline">
                  /admin/nexus-audit
                </Link>
                .
              </p>
