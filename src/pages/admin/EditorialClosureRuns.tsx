...
function groupRuns(rows: LogRow[]): RunSummary[] {
  ...
  return Array.from(map.values()).sort((a, b) => b.started_at.localeCompare(a.started_at));
}
...
const EditorialClosureRuns: React.FC = () => {
  ...
  const warnFilter: WarnFilter = (["all", "none", "any", "high"] as const).includes(
    ...
    ? (searchParams.get("warn") as WarnFilter)
    : "all";
    ...
    arr.sort((a, b) => {
      ...
      switch (sortKey) {
        ...
        case "total_rows":
          ...
          break;
        case "warnings":
          cmp = a.warnings - b.warnings;
          break;
        case "dry_run":
          cmp = Number(a.dry_run) - Number(b.dry_run);
          break;
      }
  ...
  async function doRollback() {
    ...
    setRollingBack(true);
    const { data, error } = await supabase.rpc("rollback_editorial_closure_migration", {
      ...
      <header className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Histórico de execuções de <code>migrate_editorial_closure_legacy</code>, diff
            antes/depois e rollback por <code>run_id</code>.
          </p>
        </div>
        <div className="flex flex-col items-end gap-2">
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              title="Força um refresh imediato e limpa o badge de novas runs"
            >
          ...
          <div className="flex items-center gap-3 text-xs text-muted-foreground">
            ...
            <span
              ...
              title={
                realtimeConnected
                  ? "Recebendo novas runs em tempo real"
                  : "Realtime offline — usando polling como fallback"
              }
            >
      ...
      <Card>
        <CardHeader className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            <Select value={modeFilter} onValueChange={(v) => updateParams({ mode: v, page: 1 })}>
              <SelectTrigger>
            ...
            <Select value={warnFilter} onValueChange={(v) => updateParams({ warn: v, page: 1 })}>
              <SelectTrigger>
                  ...
                  {pagedRuns.map((r) => (
                    <TableRow key={r.run_id}>
                      ...
                      <TableCell className="text-right space-x-2">
                        <Button size="sm" variant="outline" onClick={() => setOpenRunId(r.run_id)}>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {Object.keys(rollbackTarget?.entities ?? {}).length} entidade(s). Conflitos (registros
              já modificados após a run) são registrados na auditoria.
            </DialogDescription>
          </DialogHeader>
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Armazena ordenação, tamanho de página e todos os filtros ativos (modo, strategy,
              warnings, busca). Presets ficam no seu navegador.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-2">
