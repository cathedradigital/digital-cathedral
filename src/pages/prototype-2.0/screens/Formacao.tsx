          ...
          <section>
            ...
            <div className="mt-5 border border-border rounded-md p-4">
              ...
              <ul className="text-sm space-y-1.5">
                <li>
                  •{" "}
                  <Link to={`${BASE}/leitor?ref=jo15`} className="text-primary hover:underline">
                    Ler Jo 1,1-18
                  </Link>
                </li>
                <li>
                  •{" "}
                  <Link to={`${BASE}/leitor?ref=cic1234`} className="text-primary hover:underline">
                    CIC §§ 456-478
                  </Link>
                </li>
                ...
                <li>
                  •{" "}
                  <Link to={`${BASE}/minha-jornada`} className="text-primary hover:underline">
                    Anotar no Diário
                  </Link>
                </li>
              </ul>
