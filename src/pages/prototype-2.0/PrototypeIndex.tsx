...
const SCREENS = [
  ...
  {
    to: `${BASE}/estudar`,
    label: "Biblioteca (Estudar)",
    desc: "Por Tema · Por Fonte · Testemunhos",
  },
  {
    to: `${BASE}/leitor?ref=jo15`,
    label: "Leitor Universal",
    desc: "Bíblia · CIC · Padres — mesma casca",
  },
...
const JOURNEYS = [
  { id: "J1", name: "Primeiro acesso", path: "Átrio (anônimo) → Ritual do Dia → Leitor" },
  {
    ...
    path: 'Átrio → Estudar → Tema "Perdão" → Estudo Composto → Leitor',
  },
    ...
    <div className="min-h-dvh bg-background text-foreground font-sans max-w-3xl mx-auto px-6 py-10">
      <header className="mb-8">
        ...
        <p className="text-sm text-muted-foreground max-w-lg">
          Baixa fidelidade, propositalmente cru. O objetivo é validar estrutura, fluxos e
          nomenclatura — não estética final. Todas as jornadas J1–J6 são clicáveis. Nenhum backend é
          chamado.
        </p>
      </header>
      ...
      <section className="mb-10">
        ...
        <ul className="text-sm space-y-1 list-disc list-inside text-muted-foreground">
          ...
          <li>
            Toque em cartões de tema, versículo âncora (°) ou item de Formação para seguir o fluxo.
          </li>
