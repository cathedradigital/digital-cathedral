        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-spacing-2xl md:gap-spacing-3xl">
          ...
          >
            <div className="inline-flex items-center gap-spacing-xs px-spacing-sm py-spacing-2xs bg-primary/5 rounded-premium">
              <span className="text-premium-xs font-bold uppercase tracking-[0.3em] text-primary/60 italic">
                O Fundador
              </span>
            </div>
            ...
            <div className="space-y-spacing-md text-muted-foreground text-premium-lg leading-relaxed">
              <p>
                Idealizador do Cathedra, buscador da Verdade e entusiasta da tecnologia. Minha
                missão é construir pontes entre o sagrado e o digital, permitindo que a profundidade
                da tradição católica floresça no mundo contemporâneo.
              </p>
              <p className="font-serif text-foreground/80">
                Acreditamos que a tecnologia, quando a serviço da fé, pode ser um instrumento
                poderoso de santificação e estudo.
              </p>
            </div>
