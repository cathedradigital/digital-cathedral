...
const testimonials = [
  {
    name: "Maria Fernanda",
    role: "Catequista",
    text: "O Cathedra transformou minha preparação para as aulas de catequese. Ter tudo num só lugar é uma bênção.",
    avatar: "MF",
    stars: 5,
  },
  {
    name: "Pe. Ricardo",
    role: "Pároco",
    text: "Recomendo aos meus paroquianos. A ferramenta de Lectio Divina e o Logos IA são excepcionais.",
    avatar: "PR",
    stars: 5,
  },
  {
    name: "João Paulo",
    role: "Seminarista",
    text: "Uso diariamente para estudar os documentos do Magistério. A busca inteligente economiza muito tempo.",
    avatar: "JP",
    stars: 5,
  },
  {
    ...
    text: "A profundidade do conteúdo é impressionante. É como ter uma biblioteca patrística inteira no bolso.",
    avatar: "AC",
    stars: 5,
  },
  {
    ...
    text: "O Breviário e o Missal integrados facilitaram muito minha preparação para as celebrações litúrgicas.",
    avatar: "DM",
    stars: 5,
  },
  {
    name: "Teresa de Jesus",
    role: "Leiga Consagrada",
    text: "A Via Sacra e o Rosário guiados me ajudam a manter a vida de oração mesmo nos dias mais corridos.",
    avatar: "TJ",
    stars: 5,
  },
];
    ...
    <section className="w-full section-spacing relative overflow-hidden bg-background">
      <div className="app-container space-y-spacing-3xl relative z-10">
        <div className="text-center space-y-spacing-lg">
          <span className="text-premium-xs font-bold uppercase tracking-[0.4em] text-primary/60 italic">
            Comunidade
          </span>
          <h2 className="text-premium-4xl md:text-premium-5xl font-display font-bold">
            Vozes da Comunidade
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-spacing-xl md:gap-spacing-xl">
          {testimonials.slice(0, 3).map((t) => (
            <CathedraCard key={t.name} className="p-spacing-xl space-y-spacing-xl flex flex-col">
