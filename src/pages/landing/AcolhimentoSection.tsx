      ...
      <div className="max-w-7xl mx-auto space-y-spacing-3xl">
        ...
        >
          ...
          <h2 className="text-premium-4xl md:text-premium-5xl font-display font-bold">
            Um Espaço Feito por Fiéis para Fiéis
          </h2>
          <p className="text-premium-lg text-muted-foreground max-w-spacing-2xl mx-auto font-serif italic">
            "Não sois mais estrangeiros, nem hóspedes, mas sois concidadãos dos santos e membros da
        ...
        <div className="grid md:grid-cols-3 gap-spacing-xl">
          {[
            ...
            >
              <div
                className="w-spacing-xl h-spacing-xl bg-primary/10 rounded-premium flex items-center justify-center text-primary"
                aria-hidden="true"
              >
                {item.icon}
              </div>
              <h3 className="text-premium-xl font-bold font-serif">{item.title}</h3>
              <p className="text-muted-foreground text-premium-sm leading-relaxed">{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
