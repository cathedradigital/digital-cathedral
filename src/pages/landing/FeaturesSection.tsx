...
const features = [
  {
    title: "Logos IA",
    description:
      "Um mentor espiritual para os tempos modernos, treinado com o Magistério da Igreja.",
    icon: <Icons.Sparkles />,
...
const FeatureCard = ({
  ...
  return (
    ...
    >
      <div
        className="w-spacing-2xl h-spacing-2xl rounded-premium bg-primary/5 flex items-center justify-center text-primary group-hover:bg-primary/10 transition-colors"
        aria-hidden="true"
      >
        {feature.icon}
      </div>
      <div className="space-y-spacing-xs w-full">
        ...
        <p className="text-premium-sm text-muted-foreground leading-relaxed text-center">
          {feature.description}
        </p>
      </div>
    </CathedraCard>
    ...
    <section ref={sectionRef} className="w-full section-spacing relative overflow-hidden">
      <div className="app-container relative z-10">
        <div className="text-center space-y-spacing-lg max-w-spacing-3xl mx-auto mb-spacing-3xl md:mb-spacing-4xl">
          ...
          <p className="text-muted-foreground/90 font-serif text-premium-lg md:text-premium-xl mx-auto">
            A luz de Cristo ilumina o coração.
          </p>
        </div>
