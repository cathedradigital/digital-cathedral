...
const CATEGORY_PALETTE: Record<string, { primary: string; accent: string; depth: string }> = {
...
export function resolveColors(liturgicalColor?: string, dominantColor?: string, category?: string) {
