...
const BY_SLUG: Record<string, ResolvedPortalTheme> = {
  ...
  rosario: {
    theme: "church",
    accentIcon: Sparkles,
    quote: { text: "Permanecei em mim, e eu em vós.", ref: "Jo 15,4" },
  },
  "via-sacra": {
    theme: "passion",
    accentIcon: Cross,
    quote: { text: "Se alguém quer vir após mim, tome a sua cruz.", ref: "Mt 16,24" },
  },
  viacrucis: {
    theme: "passion",
    accentIcon: Cross,
  ...
  "pai-nosso": {
    theme: "church",
    accentIcon: Sparkles,
    quote: { text: "Vós, portanto, orai assim.", ref: "Mt 6,9" },
  },
  "ave-maria": {
    theme: "church",
    accentIcon: Sparkles,
    quote: { text: "Ave, cheia de graça, o Senhor é contigo.", ref: "Lc 1,28" },
  },
  "gloria-ao-pai": {
    theme: "church",
    accentIcon: Sparkles,
    quote: { text: "Glória ao Pai, ao Filho e ao Espírito Santo.", ref: "Doxologia" },
  },
  credo: {
    theme: "church",
    accentIcon: Church,
    quote: { text: "Creio em um só Deus, Pai todo-poderoso.", ref: "Symbolum" },
  },
  "salve-rainha": {
    theme: "church",
    accentIcon: Sparkles,
    quote: { text: "A vós bradamos, os degredados filhos de Eva.", ref: "Antífona" },
  },
  angelus: {
    theme: "noon",
    accentIcon: Sun,
    quote: { text: "O Anjo do Senhor anunciou a Maria.", ref: "Lc 1,26-38" },
  },
  "regina-caeli": {
    theme: "dawn",
    accentIcon: Sunrise,
    quote: { text: "Rainha do céu, alegrai-vos, aleluia!", ref: "Antífona pascal" },
  },
  magnificat: {
    theme: "sunset",
    accentIcon: Sunset,
    quote: { text: "A minha alma engrandece o Senhor.", ref: "Lc 1,46" },
  },
  "te-deum": {
    theme: "church",
    accentIcon: Flame,
    quote: { text: "A vós, ó Deus, louvamos.", ref: "Te Deum" },
  },
  "veni-creator": {
    theme: "church",
    accentIcon: Flame,
    quote: { text: "Vinde, Espírito Criador.", ref: "Hymnarium Romanum" },
  },
  ...
  "oracao-pela-sabedoria": {
    theme: "church",
    accentIcon: Sparkles,
    quote: { text: "Enviai-a dos vossos santos céus, para que trabalhe comigo.", ref: "Sb 9,10" },
  },
  ...
  "missa-ordinario": {
    theme: "church",
    accentIcon: Church,
    quote: { text: "Fazei isto em memória de mim.", ref: "Lc 22,19" },
  },
  missal: {
    theme: "church",
    accentIcon: Church,
  ...
  lectio: {
    theme: "dawn",
    accentIcon: BookOpen,
    quote: { text: "Fala, Senhor, que teu servo escuta.", ref: "1Sm 3,10" },
  },
};
