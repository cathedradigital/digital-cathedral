...
export const LIBRARY_ACERVOS: AcervoMeta[] = [
  {
    ...
    shortDescription: "Antigo e Novo Testamento, com anotações e Nexus contextual.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription: "A doutrina da Igreja organizada e interconectada.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription: "Documentos pontifícios que definem o dogma através dos séculos.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription: "Testemunhos e obras dos Padres e Doutores da Igreja.",
    longDescription:
