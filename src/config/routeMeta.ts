...
export const ROUTE_META: Record<string, RouteMeta> = {
  ...
  "/docs/:slug": {
    ...
    description:
      "Guia da documentação Cathedra com passo a passo para aproveitar o acervo e as ferramentas de estudo.",
  },
  "/audit-logs": {
  ...
  "/acervo": {
    ...
    description:
      "Biblioteca Católica unificada: Bíblia, Catecismo, Patrística, Magistério e Aparições Marianas em um hub inteligente.",
  },
  ...
  "/santos/:id": {
    ...
    description:
      "Conheça a história, milagres e o legado espiritual deste santo da Igreja Católica.",
  },
  "/papas": {
  ...
  "/auth": {
    title: "Entrar — Cathedra",
    description: "Acesse sua conta na Cathedra Digital.",
    noindex: true,
  },
  "/reset-password": {
    title: "Redefinir senha — Cathedra",
    description: "Redefina sua senha.",
    noindex: true,
  },
  "/onboarding": {
    title: "Boas-vindas — Cathedra",
    description: "Configure seu perfil espiritual.",
    noindex: true,
  },
  "/profile": {
    title: "Meu perfil — Cathedra",
    description: "Sua caminhada e preferências.",
    noindex: true,
  },
  "/profile/favorites": {
    title: "Favoritos — Cathedra",
    description: "Seus conteúdos favoritos.",
    noindex: true,
  },
  "/spiritual-profile": {
    title: "Perfil espiritual — Cathedra",
    description: "Sua caminhada espiritual.",
    noindex: true,
  },
  "/diario": {
    title: "Diário espiritual — Cathedra",
    description: "Registre sua vida interior.",
    noindex: true,
  },
  "/favorites": {
    title: "Favoritos — Cathedra",
  ...
  "/achievements": {
    title: "Conquistas — Cathedra",
    description: "Suas conquistas na caminhada.",
    noindex: true,
  },
  "/checkout": {
    title: "Checkout — Cathedra",
    description: "Finalize sua assinatura.",
    noindex: true,
  },
  "/checkout/result": {
    title: "Checkout — Resultado",
    description: "Resultado do pagamento.",
    noindex: true,
  },
  "/transactions": {
    title: "Minhas transações — Cathedra",
  ...
  "/home": {
    ...
    description: "Alias para a página inicial.",
    noindex: true,
    canonicalPath: "/",
  },
  "/sobre": {
    title: "Sobre — Cathedra",
    description: "Alias para /about.",
    noindex: true,
    canonicalPath: "/about",
  },
  "/biblia": {
    title: "Ler — Sagrada Escritura",
    description: "Alias para /bible.",
    noindex: true,
    canonicalPath: "/bible",
  },
  "/catecismo": {
    title: "Catecismo — Cathedra",
    description: "Alias para /catechism.",
    noindex: true,
    canonicalPath: "/catechism",
  },
  "/magisterio": {
    title: "Magistério — Cathedra",
    description: "Alias para /magisterium.",
    noindex: true,
    canonicalPath: "/magisterium",
  },
  "/search": {
    title: "Buscar — Cathedra",
    description: "Alias para /buscar.",
    noindex: true,
    canonicalPath: "/buscar",
  },
  "/planos": {
    title: "Planos — Cathedra",
    description: "Alias para /pricing.",
    noindex: true,
    canonicalPath: "/pricing",
  },
  "/chat": {
    title: "Logos — Cathedra",
    description: "Alias para /logos.",
    noindex: true,
    canonicalPath: "/logos",
  },
  "/login": {
    title: "Entrar — Cathedra",
    description: "Alias para /auth.",
    noindex: true,
    canonicalPath: "/auth",
  },
  "/dashboard": {
    title: "Hoje — Cathedra",
    description: "Alias para /hoje.",
    noindex: true,
    canonicalPath: "/hoje",
  },
  "/glossary": {
    title: "Glossário — Cathedra",
    description: "Alias para /glossario.",
    noindex: true,
  ...
  "/rosary": {
    title: "Rosário — Cathedra",
    description: "Alias para /oracao/rosario.",
    noindex: true,
    canonicalPath: "/oracao/rosario",
  },
  "/prayers": {
    title: "Orações — Cathedra",
    description: "Alias para /oracao.",
    noindex: true,
    canonicalPath: "/oracao",
  },
  "/rosario": {
    title: "Rosário — Cathedra",
    description: "Alias para /oracao/rosario.",
  ...
  "/ladainhas": {
    title: "Ladainhas — Cathedra",
    description: "Alias para /litanies.",
    noindex: true,
    canonicalPath: "/litanies",
  },
  "/contemplacao": {
    title: "Contemplação — Cathedra",
    description: "Alias para /contemplatio.",
    noindex: true,
    canonicalPath: "/contemplatio",
  },
  "/confession": {
    title: "Exame de consciência — Cathedra",
    description: "Alias para /oracao/exame-de-consciencia.",
    noindex: true,
    canonicalPath: "/oracao/exame-de-consciencia",
  },
  "/confissao": {
    title: "Exame de consciência — Cathedra",
    description: "Alias para /oracao/exame-de-consciencia.",
  ...
  "/bible-legacy": {
    title: "Bíblia (legado)",
    description: "Versão anterior do leitor bíblico.",
    noindex: true,
    canonicalPath: "/bible",
  },
  "/catechism-legacy": {
    title: "Catecismo (legado)",
  ...
  "/oracao-legacy": {
    title: "Orações (legado)",
    description: "Versão anterior.",
    noindex: true,
    canonicalPath: "/oracao",
  },
  "/biblioteca-legacy": {
    title: "Biblioteca (legado)",
    description: "Versão anterior.",
    noindex: true,
    canonicalPath: "/biblioteca",
  },
  "/rosary-legacy": {
    title: "Rosário (legado)",
    description: "Versão anterior.",
    noindex: true,
    canonicalPath: "/oracao/rosario",
  },
...
const DYNAMIC_PATTERNS: Array<{ test: RegExp; meta: RouteMeta }> = [
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Definição, história, Escritura, Magistério e conexões cruzadas do verbete teológico.",
    },
  },
  {
    test: /^\/oracao\/[^/]+$/,
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Novena completa em 9 dias com meditações, oração vocal e acompanhamento de progresso.",
    },
  },
  {
    test: /^\/santos\/[^/]+$/,
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Coleção editorial da Cathedra: percurso curado por sacramentos, santos e temas da fé católica.",
    },
  },
  {
    ...
    meta: {
      ...
      description:
        "Trilha de formação do Acervo Cathedra: leituras, orações e reflexões conectadas em uma coleção editorial.",
    },
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Jornadas guiadas de 7 a 14 dias com leitura, oração e contemplação para aprofundar a fé passo a passo.",
    },
  },
  {
    test: /^\/jornadas\/[^/]+$/,
    meta: {
      ...
      description:
        "Jornada guiada com leitura, oração e contemplação para aprofundar a fé passo a passo.",
    },
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Publicação da comunidade Cathedra com discussão sobre fé, doutrina e vida espiritual.",
    },
  },
  {
    test: /^\/community\/user\/[^/]+$/,
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Redirecionamento para o verbete/biografia do Padre da Igreja na Biblioteca Cathedra.",
      noindex: true,
    },
  },
  {
    ...
    meta: {
      ...
      description:
        "Coleção editorial da Biblioteca Cathedra com temas, filtros e itens paginados por nível de formação.",
    },
  },
  {
    ...
    meta: {
      ...
      description:
        "Escritos dos Santos, Padres, Doutores, Clássicos e Magistério da Igreja em um só átrio, com ficha editorial e Nexus Theologicus.",
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Explore o acervo unificado: busque por título, autor ou tema em toda a Tradição — Escritos, Padres, Doutores, Clássicos e Magistério.",
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "O centro do conhecimento católico: Escritos dos Santos, Padres, Doutores, Magistério, Patrística, Liturgia e Clássicos em um só átrio.",
      canonicalPath: "/acervo",
    },
  },
  {
    ...
    meta: {
      ...
      description:
        "Busque no acervo unificado do Cathedra por título, autor ou tema — Escritos, Padres, Doutores, Clássicos e Magistério.",
      canonicalPath: "/acervo/lista",
    },
  },
  {
    ...
    meta: {
      ...
      description:
        "Obras dos Padres, Doutores e místicos da Igreja: Confissões, Suma Teológica, Imitação de Cristo e mais — leitor premium com anotações.",
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Busca full-text nos escritos dos Padres, Doutores e místicos: pesquise por autor, obra ou palavras exatas dentro dos capítulos.",
      noindex: true,
    },
  },
  {
    ...
    meta: {
      ...
      description:
        "Sumário da obra patrística com abstract, licença editorial, capítulos e leitor contínuo integrado ao Nexus Theologicus.",
    },
  },
  {
    ...
    meta: {
      ...
      description:
        "Leitor premium de capítulo patrístico com notas editoriais, referências bíblicas e conexões teológicas.",
    },
  },
  {
    test: /^\/magisterio\/[^/]+$/,
