...
export type SearchResultKind =
  "bible" | "theme" | "magisterium" | "father" | "saint" | "catechism" | "council" | "canon";
...
const CORPUS: SearchResult[] = [
  ...
  {
    id: "c1",
    label: "CIC §§ 1996-2005 (Graça)",
    hint: KIND_LABEL.catechism,
    kind: "catechism",
    action: "open-document",
