...
export type EnvironmentKey = "estudar" | "rezar" | "formar-se" | "pesquisar" | "minha-jornada";

/** Fontes de conhecimento dentro do ambiente Estudar (§ Taxonomia 2.0). */
export type StudySource =
  "bible" | "catechism" | "magisterium" | "canon" | "fathers" | "councils" | "saints";
...
export type NavAction =
  "open-reader" | "open-composed-study" | "open-document" | "open-profile" | "open-environment";
