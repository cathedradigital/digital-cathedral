...
export const SEED_NODES: KnowledgeNode[] = [
  // Temas
  {
    ...
    kind: "theme",
    label: "Esperança",
    summary: "Virtude teologal",
    route: "study.composed",
    routeParams: { slug: "esperanca" },
  },
  {
    id: "theme:eucaristia",
    kind: "theme",
    label: "Eucaristia",
    summary: "Fonte e cume",
    route: "study.composed",
    routeParams: { slug: "eucaristia" },
  },
  {
    id: "theme:graca",
    kind: "theme",
    label: "Graça",
    summary: "Dom sobrenatural",
    route: "study.composed",
    routeParams: { slug: "graca" },
  },
  ...
  // Bíblia
  {
    ...
    kind: "bible",
    label: "Rm 8",
    summary: "A esperança que aguarda",
    route: "study.bible",
    routeParams: { book: "romanos", chapter: 8 },
  },
  {
    id: "bible:joao:6",
    kind: "bible",
    label: "Jo 6",
    summary: "Discurso do Pão da Vida",
    route: "study.bible",
    routeParams: { book: "joao", chapter: 6 },
  },
  {
    id: "bible:efesios:2",
    kind: "bible",
    label: "Ef 2",
    summary: "Salvos pela graça",
    route: "study.bible",
    routeParams: { book: "efesios", chapter: 2 },
  },
  ...
  // Catecismo
  {
    ...
    kind: "catechism",
    label: "CIC §§ 1817-1821",
    summary: "A virtude da esperança",
    route: "study.catechism",
    routeParams: { paragraph: 1817 },
  },
  {
    id: "catechism:1322",
    kind: "catechism",
    label: "CIC §§ 1322-1419",
    summary: "O sacramento da Eucaristia",
    route: "study.catechism",
    routeParams: { paragraph: 1322 },
  },
  {
    id: "catechism:1996",
    kind: "catechism",
    ...
    summary: "A graça",
    route: "study.catechism",
    routeParams: { paragraph: 1996 },
  },

  // Magistério
  {
    id: "magisterium:spe-salvi",
    kind: "magisterium",
    label: "Spe Salvi",
    summary: "Bento XVI",
    route: "study.magisterium",
    routeParams: { doc: "spe-salvi" },
  },
  {
    id: "magisterium:ecclesia-de-eucharistia",
    kind: "magisterium",
    label: "Ecclesia de Eucharistia",
    summary: "João Paulo II",
    route: "study.magisterium",
    routeParams: { doc: "ecclesia-de-eucharistia" },
  },
  {
    id: "magisterium:trento-justificacao",
    kind: "magisterium",
    label: "Trento — Decreto sobre a Justificação",
    route: "study.magisterium",
    routeParams: { doc: "trento-justificacao" },
  },

  // Padres
  {
    id: "father:santo-agostinho",
    kind: "father",
    label: "Santo Agostinho",
    route: "study.father",
    routeParams: { slug: "santo-agostinho" },
  },
  {
    id: "father:sao-joao-crisostomo",
    kind: "father",
    label: "São João Crisóstomo",
    route: "study.father",
    routeParams: { slug: "sao-joao-crisostomo" },
  },

  // Santos
  {
    id: "saint:santa-teresa-de-avila",
    kind: "saint",
    label: "Santa Teresa de Ávila",
    route: "study.saint",
    routeParams: { slug: "santa-teresa-de-avila" },
  },
  {
    id: "saint:santo-tomas-de-aquino",
    kind: "saint",
    label: "Santo Tomás de Aquino",
    route: "study.saint",
    routeParams: { slug: "santo-tomas-de-aquino" },
  },
  {
    id: "saint:santa-teresinha",
    kind: "saint",
    label: "Santa Teresinha do Menino Jesus",
    route: "study.saint",
    routeParams: { slug: "santa-teresinha" },
  },
  ...
  {
    id: "application:sacramentos-graca",
    kind: "application",
    label: "Sacramentos e vida de graça",
  },

  {
    id: "prayer:lectio-rm-8",
    kind: "prayer",
    label: "Lectio: Rm 8, 24-25",
    route: "pray.lectio",
    routeParams: { slug: "rm-8-24-25" },
  },
  {
    id: "prayer:adoracao",
    kind: "prayer",
    ...
    route: "pray.lectio",
    routeParams: { slug: "adoracao-eucaristica" },
  },
  {
    id: "prayer:oracao-graca",
    kind: "prayer",
    label: "Oração de agradecimento pela graça",
    route: "pray.lectio",
    routeParams: { slug: "oracao-graca" },
  },
];
...
export const SEED_RELATIONS: KnowledgeRelation[] = [
  ...
  {
    from: "theme:esperanca",
    to: "application:esperanca-provacao",
    kind: "applies-to",
    weight: 0.8,
  },
  ...
  {
    from: "theme:eucaristia",
    to: "magisterium:ecclesia-de-eucharistia",
    kind: "develops",
    weight: 0.9,
  },
  {
    from: "theme:eucaristia",
    to: "father:sao-joao-crisostomo",
    kind: "commented-by",
    weight: 0.75,
  },
  {
    from: "theme:eucaristia",
    to: "saint:santo-tomas-de-aquino",
    kind: "commented-by",
    weight: 0.8,
  },
  {
    from: "theme:eucaristia",
    to: "application:missa-participacao",
    kind: "applies-to",
    weight: 0.8,
  },
