...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      bible_phase_status: "pending" | "importing" | "imported" | "certified" | "rejected";
      ...
      editorial_status_enum:
        ...
        | "published"
        | "archived";
      library_kind: "saint_work" | "patristic" | "doctor" | "classic" | "magisterium";
      prayer_category:
        | "fundamentais"
        | "marianas"
        | "espirito_santo"
      ...
      saint_work_access_type: "internal" | "official_external" | "public_domain" | "licensed";
      saint_work_category:
        | "patristica"
        | "escolastica"
        | "mistica"
